...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:form action="ApplicationLogdementInBulkInput.do?method=ApplicationLogdementInBulkInput"
			...
			<TABLE width="100%" border="1" align="left" cellpadding="0"
				...
				<TR>
					...
					<tr>	
						...
						<%if(unsuccess_cnt>0){%>
						<td><a href="ApplicationLogdementInBulkProcess.do?method=ExportToFile&&fileType=XLSType&FlowLevel=UnSuccessDataList"><%=unsuccess_cnt%></a></td>
						<%}else{ %>
						<td>0</td>
						<%}%>
					</tr>					 
					<tr>	
						...
						<td>Error</td>
						<%if(all_eror_cnt>0){%>
						<td><a href="ApplicationLogdementInBulkProcess.do?method=ExportToFile&&fileType=XLSType&FlowLevel=Allerrors"><%=all_eror_cnt%></a></td>
						<%}else{ %>
						<td>0</td>
						<%}%>
					</tr>
