...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<TR align="left">
	 ...
	 %>
		...
		<TD align="left" valign="top" class="ColumnBackground" width="25%">
			<html:hidden property="mliRefNo" name="appForm" /> <font
 ...
 %>
	...
	<TR align="left">
		<TD align="left" valign="top" class="TableData" colspan="2"><b><bean:message
					key="branchState" /></b></td>
		<td style="background: #C4DEE6;">
			<%
						if ((appCommonFlag.equals("1")) || (appCommonFlag.equals("11"))
								|| (appCommonFlag.equals("12"))
								|| (appCommonFlag.equals("13"))) {
					%> <%-- <bean:write name="appForm" property="gstState"/> --%> <html:select
				property="gstState" styleId="stateCode" disabled="true"
 ...
 %>
	...
	<TR align="left">
		<TD align="left" valign="top" class="ColumnBackground" colspan="2"
			width="25%"><bean:message key="hybridSecurityLbl" /></TD>
		...
		<td class="ColumnBackground" valign="top" width="25%"><font
			color="#FF0000" size="2">*</font>&nbsp;Third Party Guarante</td>
		<td align="left" valign="middle" class="TableData" width="25%">
			<%
				if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
						|| appCommonFlag.equals("13")) {
 ...
 %>
	...
	<TR align="left">
		<TD align="left" valign="top" class="ColumnBackground" colspan="3"
			width="25%">Credit facility is covered / Propsed to be covered
			under NCGTC Mudra Guarantee Programme:</TD>
		<TD align="left" valign="top" class="ColumnBackground" width="25%"
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="2"
			width="25%">&nbsp; Unit is engaged in
			Education/Training/Agriculture and Constitution is SHG/JLG/CIG:</TD>
		<TD align="left" valign="top" class="ColumnBackground" width="25%"
...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
	...
	<TR align="left">
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="2">Whether
			Unit assisted is a Greenfield (New) Unit:</TD>
...
<!--						<bean:write property="assistedByBank" name="appForm"/>--> <html:radio
		...
		<TD colspan="9">
			<TABLE width="100%" border="0" cellpadding="1" cellspacing="1">
				<TR align="left">
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%"
						style="display: none"><html:radio name="appForm" value="none"
							property="none" disabled="false" style="display:none">
							<%-- <bean:message key="none" /> --%>
						</html:radio></TD>
					<TD align="left" valign="top" class="ColumnBackground"
						style="display: none"><html:radio name="appForm"
							value="cgbid" property="none" disabled="false"
							style="display:none">
							<%-- 	<bean:message key="cgbid" /> --%>
						</html:radio></TD>
					<TD align="left" valign="top" class="ColumnBackground" width="25%"><html:radio
 ...
 %> <%-- <html:text property="constitutionOther" size="15"
		...
		<input	type="radio" name="enterprise" value="N" checked="checked">No</TD>-->
						...
						<html:radio property="enterprise" name="appForm" value="Y"
							styleId="enterpriseY">Yes</html:radio> <html:radio
							property="enterprise" name="appForm" value="N"
							styleId="enterpriseN">No</html:radio>
					</TD>
 ...
 %>
						<div align="right">
							<html:textarea property="address" cols="40" alt="address"
								name="appForm" rows="3" />
						</div>
						<%
 	}
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%">
						&nbsp;<font color="#FF0000" size="2">*</font>
					<bean:message key="firmItpan" /><font color="#FF0000" size="1"><br />(In
							respect of Individuals ITPAN of borrower is to be filled)</font>
					</td>
 ...
 %> <html:text property="ssiITPan" styleId="ssiITPan" size="20"
							...
							onkeyup="getCGTItpanGuaranteeAmt();" /> <%-- <html:text property="ssiITPan" styleId="ssiITPan" size="20" alt="ssiITPan"	name="appForm" maxlength="10" /> --%>
						<%
 	}
 %>
					</td>
 ...
 %>
				...
				<TR align="left">
					<TD align="left" valign="top" class="ColumnBackground"
						width="16.5%"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message
							key="industryNature" /></TD>
	 ...
	 %> <%-- <html:select property="industryNature" name="appForm"
							...
							</html:select>  --%> <%-- 	onchange="enableActivityType()">  --%>
					...
					<TD align="left" valign="top" class="TableData" width="16.5%">
						...
						<%
							...
							%> <%-- <html:select property="industryNature" name="appForm"
								...
								<html:option value="">Select</html:option>
								<html:options name="appForm" property="industryNatureList"></html:options>
							</html:select>  --%> <bean:write name="appForm"
							property="industryNature" /> <%
						 	} else {
						 %> <html:select property="industryNature" name="appForm"
							styleId="industryNature"
							onchange="javascript:submitForm('afterTcMli.do?method=getIndustrySector');">
							<html:option value="">Select</html:option>
							<html:options name="appForm" property="industryNatureList"></html:options>
						</html:select> <%-- <html:select property="activityType" name="appForm"
					...
					<TD align="left" valign="top" class="ColumnBackground"
						width="16.5%" colspan="4"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message
 ...
 %>
					...
					<TD align="left" valign="top" class="TableData" width="15%"
						...
						%> <html:text property="projectedExports" size="7"
							styleId="projectedExports" alt="exports" name="appForm"
							maxlength="16" onkeypress="return decimalOnly(this, event,13)"
							onkeyup="isValidDecimal(this)" /> <%
 	}
 %>
					</td>
 ...
 %>
	...
	<TR align="left">
		...
		<TD align="left" valign="top" class="ColumnBackground" width="25%">
			<font color="#FF0000" size="2">*</font>&nbsp;<bean:message
				key="lastName" /><br />
		<font color="#FF0000" size="1">(If No Last Name, Please mention
				First Name)</font>
		</TD>
	</TR>
 ...
 %> <html:text property="cpDOB" alt="dob" styleId="cpDobId"
				name="appForm" maxlength="10" styleClass="dkr_datepicker"
				style="width:70%" onblur="checkAgeMinority();" /> <!--  <IMG src="images/CalendarIcon.gif"
 ...
 %>
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="2">
			...
			id="womenOperatedY" onclick="changeGendarFlag();">Yes
			<input type="radio" name="womenOperated" value="N" checked="checked"
...
<TR align="left">
		<TD align="left" valign="top" class="ColumnBackground" width="15%"> &nbsp; <bean:message
				key="promoterAdharNo" /></TD>
		<TD align="left" valign="top" class="TableData">
			<html:text property="adhar" size="12" name="appForm" maxlength="12"
				onkeypress="return numbersOnly(this, event)"
				onkeyup="isValidNumber(this)" />
		</TD>
 ...
 %> <html:text property="firstDOB" size="10" alt="firstDOB"
									styleClass="dkr_datepicker" name="appForm" maxlength="10" /> <!-- <IMG
 ...
 %> <html:text property="secondDOB" size="10"
									styleClass="dkr_datepicker" alt="secondDOB" name="appForm"
									maxlength="10" /> <!-- <IMG
								src="images/CalendarIcon.gif" width="20"
...
<% } %> 
		...
		<td class="ColumnBackground" colspan="6" align="center">
			...
			<tr>					
								...
								<td class="ColumnBackground" align="left" valign="top" width="20%"><font color="#FF0000" size="2">*</font>(a.) Enhance <bean:message
										key="wcFundBased" /></td>
								<td class="ColumnBackground" align="left" valign="top" width="20%"	id="wcFBsanctioned">
									<%
									if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
											|| appCommonFlag.equals("13") || appCommonFlag.equals("2")) {
								...
								%> 								
								Enhance:&nbsp;&nbsp;&nbsp;<html:text property="wcEnhanceLimitSanctioned" styleId="wcEnhanceLimitSanctioned" size="20"
										alt="wcEnhanceLimitSanctioned" name="appForm" maxlength="16"
										onchange="calltotalAmt()"
										onblur="javascript:calProjectOutlay()"
										onkeypress="return decimalOnly(this, event,13)"
										onkeyup="isValidDecimal(this)" /></br>
										<font color="#FF0000">Existing:&nbsp;&nbsp;&nbsp;<bean:write property="wcFundBasedSanctioned"	name="appForm" /></font>
								  <% } %> <bean:message key="inRs" />
								</td>
							<!-- </tr>
			...
			name="appForm" /> <%
								...
								%> <html:text property="wcNonFundBasedSanctioned" styleId="wcNonFundBasedSanctioned" disabled="true" style="color: red; background: #C4DEE6" 
			...
			<tr>	
					...
					<td class="TableData" width="20%" align="left" valign="top"
						...
						<%
							if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
									|| appCommonFlag.equals("13")|| appCommonFlag.equals("1")) {
