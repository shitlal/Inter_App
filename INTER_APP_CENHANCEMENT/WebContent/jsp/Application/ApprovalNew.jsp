...
<TD colspan="7" class="Heading"><IMG src="images/Clear.gif" width="8" height="5"></TD>
                ...
                System.out.println("ApprovalNew-count"+count);
							%>
							<tr>
              ...
              <%
								int r=0;
							  System.out.println("apForm.getEligibleNonDupRsfApps().size()"+apForm.getEligibleNonDupRsfApps().size());
                 ...
                 <bean:define type="java.util.Map" id="clearRsfRemarksMap" name="apForm" property="clearRemarks"/>
						...
						<%}%>
							...
							<!--Eligible Non Duplicate Applications (Clear Applications)-->
							 <%
								int k=0;
							  System.out.println("apForm.getEligibleNonDupApps().size()"+apForm.getEligibleNonDupApps().size());
