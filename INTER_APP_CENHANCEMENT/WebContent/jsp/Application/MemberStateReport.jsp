...
<%
	session.setAttribute("CurrentPage","memberStateReportInput.do?method=memberStateReportInput");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="memberStateReportInput.do?method=memberStateReportInput"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
							   ...
							   <TR>
									  ...
									  <bean:message key="memberId" /> 
										...
										<div align="left">
										  <html:text property="memberId" size="20" alt="Select Member" name="regForm" maxlength="12" />
										</div>
									 </td>
									  </TR>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('memberStateGSTReport.do?method=memberStateGSTReport')">
					<IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>
					<A href="javascript:document.regForm.reset()"> <IMG
