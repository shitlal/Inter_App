...
<% session.setAttribute("CurrentPage","modifyApp.do?method=getModifyInfo");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="afterModifyApp.do?method=showCgpanList" method="POST" focus="<%=focusField%>">
		<TR> 
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" colspan="6">
							<DIV align="center">
								<A href="javascript:submitForm('afterModifyApp.do?method=showCgpanList&flag=2')"><IMG src="images/OK.gif" alt="Save" width="49" height="37" border="0"></A>	
