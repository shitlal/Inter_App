...
<html:form action="addRSF2BothApp.do?method=submitRsf2App" method="POST" focus="<%=focusField%>">
...
Click Here</A> to see Terms 'n' Conditions:
					...
					<TR >
						<TD align="center" valign="baseline" colspan="7">
							<DIV align="center">
								<A href="javascript:submitForm1('addRSF2BothApp.do?method=submitRsf2App')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>	
