...
<%@ taglib uri="/WEB-INF/TLD/struts-bean.tld" prefix="bean"%>
 <script src = "js/jquery.min.1.12.4.js"></script>
	...
	$( document ).ready(function() {
		if(document.getElementById("wcFundBasedSanctioned")!=null &&
				document.getElementById("wcFundBasedSanctioned").value!= "" && document.getElementById("wcFundBasedSanctioned").value!="0.0"){
		var creditGuaranteedVal = parseFloat(document.getElementById("wcFundBasedSanctioned").value);
		document.getElementById("wcFundBasedSanctioned").value=creditGuaranteedVal;
		}
		
		if(document.getElementById("wcNonFundBasedSanctioned")!=null &&
				document.getElementById("wcNonFundBasedSanctioned").value!= "" && document.getElementById("wcNonFundBasedSanctioned").value!="0.0"){
		var creditGuaranteedVal = parseFloat(document.getElementById("wcNonFundBasedSanctioned").value);
		document.getElementById("wcNonFundBasedSanctioned").value=creditGuaranteedVal;
		}
		...
		var creditGuaranteedVal = parseFloat(document.getElementById("termCreditSanctioned").value);
		document.getElementById("termCreditSanctioned").value=creditGuaranteedVal;
		}
		
		if(document.getElementById("creditFundBased")!=null &&
				document.getElementById("creditFundBased").value!= "" && document.getElementById("creditFundBased").value!="0.0"){
		var creditGuaranteedVal = parseFloat(document.getElementById("creditFundBased").value);
		document.getElementById("creditFundBased").value=creditGuaranteedVal;
		}
		...
		var creditGuaranteedVal = parseFloat(document.getElementById("creditNonFundBased").value);
		document.getElementById("creditNonFundBased").value=creditGuaranteedVal;
		}
		
		if(null!=document.getElementById("salesRevenue") &&	document.getElementById("salesRevenue").value!= "" && document.getElementById("salesRevenue").value!="0.0"){
		    var projectOutlayIdVal = parseFloat(document.getElementById("salesRevenue").value);
	     	document.getElementById("salesRevenue").value=projectOutlayIdVal;
		}
	});
...
{
	var sanctionedamt=0.0;
	var fundbasedamt=0.0;
	var nonfundbasedamt=0.0;
	if(null!=document.getElementById('termCreditSanctioned'))
	 sanctionedamt=document.getElementById('termCreditSanctioned');
	if(null!=document.getElementById('wcFundBasedSanctioned'))
	 fundbasedamt=document.getElementById('wcFundBasedSanctioned');
	if(null!=document.getElementById('wcNonFundBasedSanctioned'))
	 nonfundbasedamt=document.getElementById('wcNonFundBasedSanctioned');
...
function calSecurityAvail(flag)
{
		if(flag == 'N')
		{
			alert('The scheme envisages creation of Primary Security out of the loan / credit provided to the borrower.');
			 ...
			 document.getElementById("pSecurityN").checked=false;
		}	
}
...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<TR align="left">
	 ...
	 %> 
		...
		<html:hidden property="mliRefNo" name="appForm" />
			<font
			color="#FF0000" size="2">*</font>&nbsp;<bean:message key="branchName" />
		</TD>
		<TD align="left" valign="top" class="ColumnBackground" width="25%">
			<%
				if ((appCommonFlag.equals("1")) || (appCommonFlag.equals("11"))
 ...
 %>
		...
		<p class="toolDkrShow"><b><bean:message key="branchState" /></b></p>
            <span class="hideDkrTooltip"><bean:message key="branchGstTooltip" /></span>
					</td><td style="background: #C4DEE6;">
 ...
 %>
	...
	<%
		...
		%>
	<TR align="left">					
			<TD align="left" valign="top" class="ColumnBackground" colspan="2" width="25%">
			<p class="toolDkrShow"><bean:message key="hybridSecurityLbl" /></p>
             <span class="hideDkrTooltip"><bean:message key="hybridTooltip" /></span>
			</TD>
		<TD align="left" valign="top" class="TableData" >
			<html:radio	name="appForm" value="Y" property="hybridSecurity" styleId="hybridSecurityY" onclick="enableHybridSecurity()"></html:radio> 
			<bean:message key="yes" />&nbsp;&nbsp; <html:radio name="appForm" value="N" property="hybridSecurity" styleId="hybridSecurityN" onclick="enableHybridSecurity()"></html:radio>
			<bean:message key="no" />
		</TD>
	...
	<%
		...
		<td  class="ColumnBackground" valign="top" width="25%">
			<p class="toolDkrShow"><font color="#FF0000" size="2">*</font><bean:message key="collateralSec" /></p>
               <span class="hideDkrTooltip"><bean:message key="collateralSecHint" /></span>
		...
		<td align="left" valign="middle" class="TableData" width="25%">
			...
			%> <html:radio name="appForm" value="Y"
				property="collateralSecurityTaken" styleId="collateralSecurityTakenY" onclick="updateHybridSecurity();">
			</html:radio> Yes <html:radio name="appForm" value="N"
				property="collateralSecurityTaken" styleId="collateralSecurityTakenN"  onclick="updateHybridSecurity();"></html:radio> No <%
				}
			%>

		</td>
		<td class="ColumnBackground"  valign="top" width="25%"> 
			 <p class="toolDkrShow"><font color="#FF0000" size="1">*</font><bean:message key="thirdPartyTaken" /></p>
                <span class="hideDkrTooltip"><bean:message key="thirdPartyTooltipTxt" /></span>	
		</td>
		<td align="left" valign="middle" class="TableData" width="25%">
			<%
				if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
 ...
 %> <html:radio name="appForm" value="Y"
				property="thirdPartyGuaranteeTaken" styleId="thirdPartyGuaranteeTakenY" onclick="thirdPartyGuaranteeTakenForApp()">
				Yes
			</html:radio> <html:radio name="appForm" value="N"
				property="thirdPartyGuaranteeTaken"  styleId="thirdPartyGuaranteeTakenN" onclick="thirdPartyGuaranteeTakenForApp()">
 ...
 %>
		...
		<TR align="left">
			...
			<TD align="left" valign="top" class="ColumnBackground" width="25%" colspan="1">
				<font color="#FF0000" size="2">*</font>&nbsp;
				<html:radio property="pmmymudra"  name="appForm" value="Y" onclick="pmudra('Y');" styleId="pmmymudraY">Yes</html:radio>
				<html:radio property="pmmymudra"  name="appForm" value="N" onclick="pmudra('N');" styleId="pmmymudraN" >No</html:radio>
			</TD>
		<TD align="left" valign="top" class="ColumnBackground"   colspan="2" 
				width="25%">&nbsp; Unit is engaged in Education/Training/Agriculture and Constitution is SHG/JLG/CIG: </TD>
			<TD align="left" valign="top" class="ColumnBackground" width="25%" colspan="2">
				<input type="radio" name="activityConfirm" id="activityConfirmY" value="Y" onclick="shgJLgValidationForApp();">Yes
				<input type="radio" name="activityConfirm" id="activityConfirmN" value="N" checked="checked" onclick="shgJLgValidationForApp();">No
			</TD>		
	</TR>
...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
  ...
  <TR align="left">
		...
		<TD align="left" valign="top" class="ColumnBackground" >
			<input type="radio" name="unitAssisted" id="unitAssistedY" value="Y" onclick="unitAssistCGTPreviouslyValidate();">Yes<input
			type="radio" name="unitAssisted" value="N" id="unitAssistedN" checked="checked" onclick="unitAssistCGTPreviouslyValidate();">No
		</TD>	
		...
		<TD align="left" class="TableData" colspan="1">
			...
			%> <html:radio name="appForm" value="Y"	property="previouslyCovered" disabled="true"></html:radio> <bean:message
				key="yes" />&nbsp;&nbsp; <html:radio name="appForm" value="N" property="previouslyCovered" disabled="true"></html:radio> <bean:message
				key="no" /> <%
 	} else {
 %> <html:radio name="appForm" value="Y"
				property="previouslyCovered" styleId="previouslyCoveredY" onclick="enableNone(),unitAssistCGTPreviouslyValidate();"></html:radio> <bean:message
				key="yes" />&nbsp;&nbsp; <html:radio name="appForm" value="N"
				property="previouslyCovered" styleId="previouslyCoveredN" onclick="enableNone(),unitAssistCGTPreviouslyValidate();"></html:radio> <bean:message
				key="no" /> <%
 	}
 %>
			...
			<TABLE width="100%" border="0" cellpadding="1" cellspacing="1">
				<TR align="left">
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%"><html:radio
							name="appForm" value="none" property="none" disabled="true" style="display:none">
							<%-- <bean:message key="none" /> --%>
						</html:radio></TD>
					<TD align="left" valign="top" class="ColumnBackground"><html:radio
							name="appForm" value="cgbid" property="none" disabled="true" style="display:none">
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%"  style="display:none"><html:radio
							name="appForm" value="none" property="none" disabled="false" style="display:none">
							<%-- <bean:message key="none" /> --%>
						</html:radio></TD>
 ...
 %>
					<TD align="left" valign="top" class="ColumnBackground" width="25%" >
						...
						%> <script>
											 ...
											 <html:text property="unitValue" size="15" alt="Value"
...
<TD align="left" valign="top" class="ColumnBackground">&nbsp;<bean:message
 ...
 %> <%-- <html:text property="constitutionOther" size="15"
          ...
          <TR>
		<TD align="left" valign="top" class="ColumnBackground" >Unit Assisted is an MSE as per the MSMED Act </TD>
		<TD align="left" valign="top" class="ColumnBackground" ><html:radio
				name="appForm" value="Y" property="mSE" styleId="mseY" onclick="mseMsmedValidation()">Yes
												</html:radio>
			<html:radio name="appForm" value="N" property="mSE" styleId="mseN" onclick="mseMsmedValidation()">No</html:radio></TD>
	
		<TD align="left" valign="top" class="ColumnBackground">Unit Assisted is a Micro Enterprise </TD>
 ...
 %> <%-- <html:select property="ssiType" name="appForm" style="width:15%">
	   ...
	   <html:hidden property="ssiType" name="appForm" value="M/s"/> 
<%
 	} if ((appCommonFlag.equals("0")) || (appCommonFlag.equals("1"))
 			|| (appCommonFlag.equals("2"))
 			|| (appCommonFlag.equals("3"))
 ...
 %> <html:text property="ssiName"  name="appForm" maxlength="100" size="500" alt="unitName" style="width:35%;"/> 
													<%
 														}
 													%>
					</td>
 ...
 %><div align="right"> <html:textarea property="address" cols="40" alt="address" 
 ...
 %>
       ...
       <TR align="left">
									<TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font><bean:message key="state" /></TD>
									<TD align="left" valign="top" class="ColumnBackground">
										<%
														if ((appCommonFlag.equals("0")) || (appCommonFlag.equals("1"))
																|| (appCommonFlag.equals("2"))
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%">
				 						&nbsp;<font color="#FF0000" size="2">*</font><bean:message	key="firmItpan" /></br>(In respect of Individuals ITPAN of borrower is to be filled) 
					</td>
 ...
 %><html:text property="ssiITPan" styleId="ssiITPan" size="20" alt="ssiITPan"	name="appForm" maxlength="10" onkeyup="getCGTItpanGuaranteeAmt();" /> <%
 	}
 %>
					</td>
					<%-- <TD align="left" valign="top" class="ColumnBackground" width="25%" colspan="2">&nbsp;<bean:message
							key="ssiRegNo" />
					</td>
					<TD align="left" valign="top" class="TableData" width="15%"
						colspan="2">
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%"
							colspan="2">&nbsp;<bean:message key="udyogAdharNo" />
						</td>
						<TD align="left" valign="top" class="TableData" width="15%"
							colspan="2">
							<%
 ...
 %>
				...
				<TR align="left" >
					<TD align="left" valign="top" class="ColumnBackground" width="16.5%">
                      <p class="toolDkrShow"><font color="#FF0000" size="2">*</font><bean:message key="industryNature" /></p>
                             <span class="hideDkrTooltip"><bean:message key="industrySectorTooltipdkr" /></span>
                             </TD>
 ...
 %>  <html:select property="activityType" name="appForm"
												styleId="activityTypeList"
												onchange="javascript:submitForm('afterTcMli.do?method=getIndustryNatureList')">
												<html:option value="">Select</html:option>
												<html:options name="appForm" property="activityTypeList"></html:options>
				         </html:select>    <% 	} %>
					</td>
					
					
					<TD align="left" valign="top" class="ColumnBackground" width="16.5%"><bean:message
							key="activitytype" /></td>
					<TD align="left" valign="top" class="TableData" width="16.5%">
						<%
							if ((appCommonFlag.equals("0")) || (appCommonFlag.equals("1"))
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="16.5%" colspan="2">&nbsp;<font
						color="#FF0000" size="2" >*</font>
					...
					<html:select property="industrySector" name="appForm"
								styleId="industrySector" >
								<html:option value="">Select</html:option>
								<html:options name="appForm" property="industrySectorList"></html:options>
								<!-- <html:option value="Others">Others</html:option>-->
							</html:select> 						
					  <%--  <html:text property="activityType" size="20"	styleId="activityType" alt="Activity Type" name="appForm"
												maxlength="75" /> --%> <%
					 	}
					 %>
					</td>
 ...
 %> <html:text property="projectedSalesTurnover" size="20" styleId="projectedSalesTurnover" onblur="checkAmountwith10k('projectedSalesTurnover');"
							alt="turnover" name="appForm" maxlength="16"
							onkeypress="return decimalOnly(this, event,13);"
							onkeyup="isValidDecimal(this)" /> <%
 	}
 %>
					...
					<TD align="left" valign="top" class="TableData" width="15%"
						...
						%> <html:text property="projectedExports" size="7" styleId="projectedExports" 
 ...
 %> <html:select property="cpTitle" name="appForm" styleId="cpTitleId" onchange="enableGender()">
				<html:option value="">Select</html:option>
 ...
 %> <html:radio name="appForm" value="M" property="cpGender" styleId="cpGenderM">
			</html:radio> <bean:message key="male" />&nbsp;&nbsp;&nbsp; <html:radio
				name="appForm" value="F" property="cpGender" styleId="cpGenderF"></html:radio> <bean:message
				key="female" /><html:radio name="appForm" value="T" property="cpGender" styleId="cpGenderT"></html:radio>
	              <bean:message key="transgender" /> <%
 	}
 %>

		</TD>
		<TD align="left" valign="top" class="ColumnBackground">&nbsp;</font><font color="#FF0000" size="2">*</font><bean:message
				key="chiefItpan" />
		</TD>
		<TD align="left" valign="top" class="TableData" colspan="2"
			width="20%">
 ...
 %>
	...
	<TR align="left">
		...
		<TD align="left" valign="top" class="ColumnBackground"><input type="radio" name="religion" value="Y">Yes<input
			type="radio" name="religion" value="N" checked="checked">No</TD>



		<TD align="left" valign="top" class="ColumnBackground">
			<font color="#FF0000" size="2">*</font>&nbsp; Physically Handicapped:</TD>
		<TD align="left" valign="top" class="ColumnBackground">&nbsp;<html:radio
...
<!--  <IMG src="images/CalendarIcon.gif"
			width="15" onClick="showCalendar('appForm.cpDOB')" onblur="checkAgeMinority();" /> -->
			<%
				}
			%>
 ...
 %>
		...
		<TD align="left" valign="top" class="ColumnBackground" >Unit Assisted is Women Operated/Owned:</TD>
		<TD align="left" valign="top" class="ColumnBackground" colspan="1">
			<input type="radio" name="womenOperated" value="Y" id="womenOperatedY" onclick="changeGendarFlag();">Yes
			<input type="radio" name="womenOperated" value="N" checked="checked" id="womenOperatedN" onclick="changeGendarFlag();">No
		</TD>
...
<TR align="left">
		...
		<%-- <TD align="left" valign="top" class="TableData"> <font
			color="#FF0000" size="2">*</font>&nbsp;
 ...
 %>
					...
					<td width="17%" class="TableData"><b><span style="font-size: 9pt"> <%
 	if ((appCommonFlag.equals("0")) || (appCommonFlag.equals("1"))
 			|| (appCommonFlag.equals("2"))
 			|| (appCommonFlag.equals("3"))
 			|| (appCommonFlag.equals("4"))
 ...
 %> <html:text property="firstDOB" size="10" alt="firstDOB" styleClass="dkr_datepicker" 
 ...
 %> <html:text property="secondDOB" size="10" styleClass="dkr_datepicker" 
...
<table width="100%" cellspacing="1" cellpadding="0">
 ...
 --%>
	...
	<%  } %> --%>
	  <html:hidden property="exposureFbId" name="appForm" />
	<!-- added vinod 17-Mar-2015 bhu-->
	<TR>
		<TD align="left" valign="top" class="ColumnBackground" colspan="2"><font
			color="#FF0000" size="2">*</font>  Whether exclusive first charge on Primary Securities is available</TD>
		<TD align="left" valign="top" class="TableData" colspan="8">
		<html:radio	property="pSecurity" name="appForm" value="Y" styleId="pSecurityY"  onclick="calSecurityAvail('Y');">Yes</html:radio> 
		<html:radio	property="pSecurity" name="appForm" value="N" styleId="pSecurityN" onclick="calSecurityAvail('N');">No</html:radio></TD>
	</TR>
	...
	<TR>
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="2">
			<html:radio name="appForm" value="Y" property="jointFinance" styleId="jointFinanceY" 
				onclick="enableJointFinance(),joinFinHandLoomHandyCraftValidation()">Yes</html:radio> <html:radio
				name="appForm" value="N" property="jointFinance" styleId="jointFinanceN"
	...
	<TR>
		...
		<TD align="left" valign="top" class="ColumnBackground" width="20%">
			...
			%> <html:radio name="appForm" value="Y" property="handiCraftsStatus" styleId="handiCraftsY">Yes</html:radio>
			<html:radio name="appForm" value="N" property="handiCraftsStatus" styleId="handiCraftsN">No</html:radio>
			<%
				} else {
			%><html:radio name="appForm" value="Y" property="handiCrafts" styleId="handiCraftsY"
				onclick="enableHandiCrafts(),joinFinHandLoomHandyCraftValidation()">Yes</html:radio> <html:radio
				name="appForm" value="N" property="handiCrafts" styleId="handiCraftsN"
 ...
 %> <!--<input type="radio" name="handiCrafts" value="Y" onclick="javascript:enableHandiCrafts()">Yes<input type="radio" name="handiCrafts" value="N" checked="checked" onclick="javascript:enableHandiCrafts()">N-->
		...
		<TD align="left" valign="top" class="ColumnBackground" width="20%" colspan="4">
			<%
				if ((appCommonFlag.equals("4")) || ((appCommonFlag.equals("3")))) {
			%><html:radio name="appForm" value="Y"
...
<%-- 
	...
	<tr>
		...
		<TD align="left" valign="top" class="ColumnBackground">&nbsp;<html:text
				...
				maxlength="15" /></td>
		<TD align="left" valign="top" class="ColumnBackground" colspan="1">&nbsp;I
			Card Issue date:</td>
		<TD align="left" valign="top" class="ColumnBackground" colspan="4">&nbsp;<html:text
				property="icardIssueDate" size="20" styleClass="dkr_datepicker"  alt="icardIssue Date"
				name="appForm" maxlength="10" />&nbsp; <!-- <IMG
			src="images/CalendarIcon.gif" width="20" 
	...
	<TR>
		...
		<TD align="left" valign="top" class="ColumnBackground">
			<%
				if ((appCommonFlag.equals("4")) || ((appCommonFlag.equals("3")))) {
			%> <html:radio name="appForm" value="Y" 	property="dcHandloomsStatus">Yes</html:radio> <html:radio
				name="appForm" value="N" property="dcHandloomsStatus"
				onclick="javascript:enabledcHandlooms()">No</html:radio> <%
 	} else {
 %> <html:radio name="appForm" value="Y" property="dcHandlooms" styleId="dcHandloomsY"
				onclick="enabledcHandlooms(),joinFinHandLoomHandyCraftValidation()">Yes</html:radio> <html:radio
				name="appForm" value="N" property="dcHandlooms" styleId="dcHandloomsN"
				onclick="enabledcHandlooms(),joinFinHandLoomHandyCraftValidation()">No</html:radio> <%
 	}
 %>
		</TD>
				<TD align="left" valign="top" class="ColumnBackground" colspan="1"><font
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="4">
			...
			<html:select property="WeaverCreditScheme" name="appForm" style="width:80%;">
...
<%-- 	<TR>
	...
	<TR  align="left">
		<TD align="left" valign="top" class="ColumnBackground" width="50%"><font
		...
		<TD align="left" valign="top" class="ColumnBackground" width="50%" colspan="8">

			<html:checkbox property="handloomchk" name="appForm" value="Y" styleId="handloomchk"/>
		</TD>
	</TR>
	<tr align="left">
	...
	<TD align="left" valign="top" class="ColumnBackground"  width="16%"><font
			color="#FF0000" size="2">*</font>&nbsp;I/We confirm that the same is an investment grade rating of the bank as per Bank's Policy.</td>
		<TD align="left" valign="top" class="ColumnBackground"  width="16%">
		<html:checkbox property="ivConfirmInvestGrad" value="Y" />
		</TD>	
			
		<TD align="left" valign="top" class="ColumnBackground"  width="16%"><!-- <font
			color="#FF0000" size="2">*</font>&nbsp;Internal Rating/Equivalent Standared Rating --></td>
		<TD align="left" valign="top" class="ColumnBackground"  width="16%" colspan="2">
			<%
				if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
						|| appCommonFlag.equals("13")) {
			...
			<%-- <html:select property="equivStandaredRating" styleId="equivStandaredRating">			
			<html:option value="">--Select--</html:option>
			<html:option value="1">1</html:option><html:option value="2">2</html:option><html:option value="3">3</html:option><html:option value="4">4</html:option><html:option value="5">5</html:option>
			<html:option value="6">6</html:option><html:option value="7">7</html:option><html:option value="8">8</html:option><html:option value="9">9</html:option><html:option value="10">10</html:option>
			</html:select> --%>
	...
	<tr valign="top">
		...
		<% if(((appCommonLoanType.equals("TC")) || (appCommonLoanType.equals("CC") || appCommonLoanType.equals("BOTH") || appCommonLoanType.equals("BO"))) && (!appCommonLoanType.equals("WC"))){ %>
			<table width="100%" border="0" align="right" cellpadding="0"
				cellspacing="1">
				<tr>
					<td class="ColumnBackground" width="20%" align="left" valign="top" colspan="0">
						<%
							if (appCommonFlag.equals("7") || appCommonFlag.equals("8")
 ...
 %> <bean:message key="inRs" />
	...
	<td class="ColumnBackground" width="20%" align="left" valign="top"  colspan="0"><bean:message
 ...
 %> <html:text property="tcPromoterContribution" styleId="tcPromoterContribution" size="20"
 ...
 %> <bean:message key="inRs" />
					...
					<td class="ColumnBackground" width="20%" colspan="0">&nbsp; <bean:message
...
<td class="ColumnBackground" width="25%" >&nbsp; <bean:message
				 ...
				 %> <html:text property="tcOthers" size="20" alt="tcOthers"
											...
											styleId="tcOthers"  onblur="countProjectOutlay(),calProjectOutlay()"
											onkeypress="return decimalOnly(this, event,13)"
											onkeyup="isValidDecimal(this)" /> <%
				 	}
				 %> <bean:message key="inRs" />
      ...
      <% if(((appCommonLoanType.equals("WC")) || (appCommonLoanType.equals("CC") || appCommonLoanType.equals("BOTH")  || appCommonLoanType.equals("BO"))) && (!appCommonLoanType.equals("TC"))){ %>
		<tr>
		<td class="ColumnBackground" colspan="6" align="center">
									<%
			...
			<tr>					
								...
								<td class="ColumnBackground" align="left" valign="top" width="20%"><bean:message
										key="wcFundBased" /></td>
								<td class="ColumnBackground" align="left" valign="top" width="20%"
									id="wcFBsanctioned">
									<%
										if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
												|| appCommonFlag.equals("13") || appCommonFlag.equals("2")) {
							...
							<tr align="left"> -->
								...
								<td class="ColumnBackground" align="left" valign="top" width="20%" style="min-width:200px"><bean:message key="marginMoneyAsTL" /></td>
								<td class="ColumnBackground" align="left" valign="top" width="20%" style="min-width:200px">
									<%
										if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
												|| appCommonFlag.equals("13")) {
			...
			<tr>	
					...
					<td class="TableData" width="20%" align="left" valign="top"
					 ...
					 %> <html:text property="wcPromoterContribution"  styleId="wcPromoterContribution" size="20"
					...
					<td class="TableData" width="20%" align="left" valign="top"
						...
						%> <html:text property="wcSubsidyOrEquity" styleId="wcSubsidyOrEquity" size="20"
 ...
 %> <html:text property="wcOthers" size="20" alt="wcOthers"
							name="appForm" maxlength="16"
							styleId="wcOthers"  onblur="countProjectOutlay(),calProjectOutlay()"
							onkeypress="return decimalOnly(this, event,13)"
							onkeyup="isValidDecimal(this)" /> <%
 	}
 %> <bean:message key="inRs" />
 ...
 %> <bean:message key="inRs" />
			 ...
			 %> <%-- <bean:write name="appForm"	property="projectCost" /> --%>
			    <html:text property="projectOutlay" name="appForm" styleId="projectOutlayId" readonly="true" style="background-color:#C4DEE6"/> <%
			 	}
			 %>
			</td> 
					
				<td class="ColumnBackground" width="20%" colspan="0">
						<bean:message key="projectOutlay" />
					</td>
					<td class="ColumnBackground" width="20%" colspan="0" id="projectOutlay" colspan="3">
						<%
							if ((appCommonFlag.equals("0")) || (appCommonFlag.equals("1"))
									|| (appCommonFlag.equals("2"))
									|| (appCommonFlag.equals("3"))
 ...
 %>              <html:text property="projectOutlay" name="appForm" styleId="projectOutlayId" readonly="true" style="background-color:#C4DEE6"/>
			...
			<%-- <td width="20%" class="ColumnBackground"> <div align="left">&nbsp;
 ...
 %>
				...
				<html:hidden property="status" name="appForm" /> <html:hidden property="interestType" name="appForm"  value="F"/>
				<!-- <tr> -->
					<%-- <tr align="left">
					<td class="ColumnBackground" height="28" width="20%" colspan="0">&nbsp;
...
<!--										<bean:write name="appForm" property="interestType"/>-->
									...
									<td width="20%" class="ColumnBackground" height="28" colspan="0"> <div align="left">&nbsp;
		...
		<TD colspan="7">
			...
			if (hybridflg.equals("N")) {%>
				...
				<tr>
					...
					<td width="25%" align="left" class="ColumnBackground" valign="top" colspan="6">
				</td></tr>
				<tr>
					<td width="25%" align="left" class="ColumnBackground" valign="top">
						 <font color="#FF0000" size="2">*</font>
					<bean:message key="immovCollateratlSecurity" />
					</td>
					<td width="20%" align="left" class="TableData" id="immovCollateratlSecurity" colspan="4">
						<%
							if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
									|| appCommonFlag.equals("13") || appCommonFlag.equals("2")) {
