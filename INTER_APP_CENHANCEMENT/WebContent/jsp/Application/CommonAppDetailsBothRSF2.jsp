...
Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are 2mandatory</bold></font>
</td>
</tr><TR>
<TD colspan="4"> 
...
<%
if((appCommonFlag1.equals("0"))||(appCommonFlag1.equals("1"))||(appCommonFlag1.equals("2")) ||(appCommonFlag1.equals("3"))|| (appCommonFlag1.equals("4")) || (appCommonFlag1.equals("5")) || (appCommonFlag1.equals("6")) || (appCommonFlag1.equals("11"))||(appCommonFlag1.equals("12"))||(appCommonFlag1.equals("13"))  || (appCommonFlag1.equals("14"))||(appCommonFlag1.equals("17"))||(appCommonFlag1.equals("18"))||(appCommonFlag1.equals("19")))
{
%>
...
<html:text property="unitValue" size="15" alt="Value" name="appForm"  maxlength="13"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%}
else if((appCommonFlag1.equals("14"))||(appCommonFlag1.equals("17"))||(appCommonFlag1.equals("18"))||(appCommonFlag1.equals("19"))){
%>
<script>
booleanVal=true;
</script>
<html:text property="unitValue" size="15" alt="Value" name="appForm"  maxlength="15" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%}else {%>
<script>
booleanVal=false;
</script>
...
<%}%>
<%
if((appCommonFlag1.equals("7"))||(appCommonFlag1.equals("8"))||(appCommonFlag1.equals("9")) || (appCommonFlag1.equals("10")) || (appCommonFlag1.equals("14"))||(appCommonFlag1.equals("17"))||(appCommonFlag1.equals("18"))||(appCommonFlag1.equals("19")))
{
%>
...
{ %>
<html:select property="district" name="appForm" onchange="javascript:enableDistrictOthers()" >
<html:option value="">Select</html:option>
...
<TD align="left" valign="top" class="TableData">
<% if(appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13") || (appCommonFlag1.equals("14"))||(appCommonFlag1.equals("17"))||(appCommonFlag1.equals("18"))||(appCommonFlag1.equals("19")))
 {
%>
...
%>
<html:text property="districtOthers" size="10" alt="district" name="appForm"  maxlength="100" disabled="true"/>
...
<html:option value="">Select</html:option>
<html:options name="appForm" property="industryNatureList"/>
</html:select>
<%}%>
 </td>
...
{ %> <!-- <html:text property="employeeNos" size="10" alt="No Of employees" name="appForm" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)"/>-->
      <html:text property="employeeNos" size="10" alt="No Of employees" name="appForm" maxlength="2"/>
<%}%>
</td>
</tr>
...
<input type="radio" name="activityConfirm" value="Y">Yes<input type="radio" name="activityConfirm" value="N" checked="checked">No</TD>
...
<!--<html:text property="projectedSalesTurnover" size="20" alt="turnover" name="appForm" maxlength="16" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/> -->
    <html:text property="projectedSalesTurnover" size="20" alt="turnover" name="appForm" maxlength="16"/>
<%}%>
<bean:message key="inRs"/>
 </td>
...
<!--<html:text property="projectedExports" size="10" alt="exports" name="appForm" maxlength="16" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/> -->
  <html:text property="projectedExports" size="10" alt="exports" name="appForm" maxlength="16"/>
<%}%>
<bean:message key="inRs"/>
</td>
</tr>
...
<bean:message key="chiefInfo"/>
  ...
  <TR align="left">
  <TD align="left" valign="top" class="ColumnBackground" colspan="2" width="15%">&nbsp;</TD> 
...
<tr align="left"> 
									<td colspan="4" align="left" class="ColumnBackground"><b><font color="#008600" size="4">Joint Finance</font></b></td>
								</tr>
								<TR>
                  ...
                  <<TD align="left" valign="top" class="ColumnBackground" colspan="7" >             
	                <input type="radio" name="jointFinance" value="Y" onclick="javascript:enableJointFinance()">Yes
                  <input type="radio" name="jointFinance" value="N" checked="checked" onclick="javascript:enableJointFinance()">No
                  </TD>      
				     	</TR>
...
<TR>
<TD align="left" valign="top" class="ColumnBackground" colspan="2">&nbsp;Joint Cgpan (Existing Cgpan of this borrower)&nbsp;</TD>
<TD align="left" valign="top" class="ColumnBackground" colspan="2" >&nbsp;<input type="text" name="jointcgpan" maxlength="15" size="25" value="" disabled="disabled" alt="jointcgpan"></td>
</TR>

      <TR align="left">
<TD align="left" valign="top" class="ColumnBackground" colspan="2"><font color="#FF0000" size="2">*</font>&nbsp;Internal Rating</td>
<TD align="left" valign="top" class="tableData"><% if(appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13"))
  {%>Internal Rating<%}
else
{ %><html:text property="internalRating" size="20" alt="internal Rating" name="appForm" maxlength="5"/><%}%></TD>
  <TD align="left" valign="top" class="ColumnBackground"></td>
        </tr><tr>
    <TD align="left" valign="top" class="ColumnBackground" colspan="2"><font color="#FF0000" size="2">*</font>&nbsp;External Rating</td>
<TD align="left" valign="top" class="tableData"><% if(appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13"))
 {%>External Rating<%}
else
{ %><html:text property="externalRating" size="20" alt="external Rating" name="appForm" maxlength="5"/><%}%>
</TD><TD align="left" valign="top" class="ColumnBackground"></td>
 </TR>

<tr align="left"> 
									<td colspan="8" class="SubHeading" height="28" width="843"><br> &nbsp;<bean:message key="meansOfFinance" /></td>
								</tr>
										...
										<table width="100%" border="0" align="right" cellpadding="0" cellspacing="1">
											<tr> 
												...
												{%><font color="#FF0000" size="2">*</font><bean:message key="tcSanctioned" /><%}
												else
												{%><bean:message key="tcSanctioned" /><%}%></td>
												<td class="TableData" width="20%" align="left" valign="top" id="tcSanctioned">
												<% if(appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13"))
												 {%><bean:write property="termCreditSanctioned" name="appForm"/><%}
												else {%><html:text property="termCreditSanctioned" size="20" alt="tcSanctioned" name="appForm" maxlength="16" onchange="calltotalAmt()" onblur="javascript:calProjectOutlay()" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/>
												...
												<td class="ColumnBackground" colspan="2" align="left" valign="top" >
													<table width="100%" border="0" align="right" cellpadding="0" cellspacing="1">
														<tr align="left">
															...
															{%><font color="#FF0000" size="2">*</font><bean:message key="wcLimitSanctioned"/><%}
															else if(appCommonFlag1.equals("1")){%><font color="#FF0000" size="2">*</font><bean:message key="wcEnhanceLimitSanctioned"/><%}
															else {%><bean:message key="wcLimitSanctioned"/><%}%></td>
														</tr>							
														<tr align="left">
															<td class="ColumnBackground" align="left" valign="top" ><bean:message key="wcFundBased"/></td>
														...
														<tr align="left"><td class="ColumnBackground" align="left" valign="top" ><bean:message key="wcNonFundBased"/></td>
														...
														<tr align="left"><td class="ColumnBackground" align="left" valign="top" width="50%"><bean:message key="marginMoneyAsTL"/></td>
															<td class="TableData" align="left" valign="top" ><% if(appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13")){%>
<!--						<bean:write property="marginMoneyAsTL" name="appForm"/>-->
																...
																<bean:message key="no"/>
															<%}else {%>	<html:radio name="appForm" value="Y" property="marginMoneyAsTL" onclick="javascript:calProjectOutlay()" ></html:radio>
																<bean:message key="yes" />&nbsp;&nbsp;
											...
											<TR align="left">
												...
												<%	
												if((appCommonFlag1.equals("0"))||(appCommonFlag1.equals("1"))||(appCommonFlag1.equals("2"))||(appCommonFlag1.equals("3"))||(appCommonFlag1.equals("4"))||(appCommonFlag1.equals("5"))|| appCommonFlag1.equals("6") || appCommonFlag1.equals("11") || appCommonFlag1.equals("12") || appCommonFlag1.equals("13"))
                     	...
                     	<input type="text" name="expiryDate" maxlength="10" size="20" value="" alt="expiryDate">
											<IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('appForm.expiryDate')" align="center">
							
												
												</td>
                                  <td class="ColumnBackground" width="25%" align="left" valign="top" colspan="4" >
                        </tr>
