...
<%@ taglib uri="/WEB-INF/TLD/struts-bean.tld" prefix="bean"%>
 ...
 <script src = "js/jquery-ui.js"></script>      
	...
	if(parseFloat(document.getElementById("wcFundBasedSanctioned").value)!=0.0 || parseFloat(document.getElementById("wcNonFundBasedSanctioned").value) != 0.0){
		projectCost = parseFloat(document.getElementById("wcFundBasedSanctioned").value) + 
        parseFloat(document.getElementById("wcNonFundBasedSanctioned").value) +
        parseFloat(document.getElementById("wcPromoterContribution").value) + 
        parseFloat(document.getElementById("wcSubsidyOrEquity").value) + 
        parseFloat(document.getElementById("wcOthers").value);
	document.getElementById("projectOutlayId").value= projectCostVal;   //creditGuaranteedVal;
	document.getElementById("projectCost").value= projectCostVal;  //creditGuaranteedVal;	
	}
	
	if(document.getElementById("salesRevenue")!=null &&
			document.getElementById("salesRevenue").value!= "" && document.getElementById("salesRevenue").value!="0.0"){
...
<%
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="25%">
					&nbsp;<font color="#FF0000" size="2">*</font><bean:message	key="firmItpan" /><font color="#FF0000" size="1"><br/>(In respect of Individuals ITPAN of borrower is to be filled)</font> 
					</td>
 ...
 <%-- <html:text property="ssiITPan" styleId="ssiITPan" size="20" alt="ssiITPan"	name="appForm" maxlength="10" /> --%>
 <%
 	}
 %>
					</td>
...
<TR align="left">
 ...
 %>  <html:select property="industryNature" name="appForm" 	styleId="industryNature" style="width:75%;" onchange="javascript:submitForm('afterTcMli.do?method=getIndustrySector');">
							<html:option value="">Select</html:option>
							<html:options name="appForm" property="industryNatureList"></html:options>
						</html:select> <% 	} %>
					</td>
					<TD align="left" valign="top" class="ColumnBackground" width="20%"><bean:message
							key="industrySector" /></td>
 ...
 %> <html:select property="industrySector" name="appForm" styleId="industrySector"  style="width:98%;"
							onchange="javascript:submitForm('afterTcMli.do?method=getTypeOfActivity')">
							<html:option value="">Select</html:option>
							<html:options name="appForm" property="industrySectorList"></html:options>
							<!-- <html:option value="Others">Others</html:option>-->
 ...
 %>
					...
					<TD align="left" valign="top" class="ColumnBackground" width="20%" colspan="2">&nbsp;<font
						color="#FF0000" size="2" >*</font>
					...
					<TD align="left" valign="top" class="TableData"
						...
						%> <html:text property="activityType" styleId="activityType"
							size="20" alt="Activity Type" name="appForm" maxlength="75" /> 
								<html:select property="activityType" name="appForm"	onchange="enableActivityType()">
						<html:option value="">Select</html:option>
						<html:option value="Manufacturing">Manufacturing</html:option>
						<html:option value="Services">Services</html:option>
						<html:option value="Retail Trade">Retail trade</html:option>						
 ...
 %><html:text property="cpITPAN" styleId="cpITPAN" size="15" 
				name="appForm" maxlength="10" onkeyup="getCGTItpanGuaranteeAmt();" alt="chiefItpan"/> <%
 	}
 %>
 ...
 <html:text property="cpDOB" alt="dob" styleId="cpDobId" name="appForm" 
  ...
  <%-- <html:text property="cpDOB"  name="appForm" maxlength="10" styleClass="dkr_datepicker"  style="width:70%" onblur="checkAgeMinority();"  alt="dob"  styleId="cpDobId" /> --%>
 <!--  <IMG src="images/CalendarIcon.gif"
			width="15" onblur="checkAgeMinority()" onClick="showCalendar('appForm.cpDOB')"  /> -->
			<%
				}
			%>
...
<%-- 
	...
	<tr>
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="4">&nbsp;<html:text
				property="icardIssueDate" size="20" alt="icardIssue Date" styleClass="dkr_datepicker"
				name="appForm" maxlength="10" />&nbsp; <!-- <IMG
			src="images/CalendarIcon.gif" width="20" 
 ...
 %>
		...
		<TD align="left" valign="top" class="ColumnBackground" colspan="4">
			...
			<html:select property="WeaverCreditScheme" name="appForm" style="width:50%;">
...
<tbody>
	...
	<tr align="left">
		<td colspan="8" class="SubHeading" height="28" width="100%"><br>
...
<% } %> 
								...
								<td class="ColumnBackground" align="left" valign="top" width="20%"
									...
									%> <bean:write property="wcFundBasedSanctioned"
									 ...
									 %> <html:text property="wcFundBasedSanctioned" styleId="wcFundBasedSanctioned" size="20"
																			...
																			onblur="countProjectOutlay(),calProjectOutlay(),setSanctionDtValueInNFBSanDt()"
																			onkeypress="return decimalOnly(this, event,13)"
																			onkeyup="isValidDecimal(this)" /> <%
									 	}
									 %> <bean:message key="inRs" />
 ...
 %> <html:text property="wcOthers" size="20" styleId="wcOthers" 
 ...
 %>              <html:text property="projectOutlay" name="appForm" styleId="projectOutlayId" readonly="true" style="background-color:#C4DEE6"/>
			 ...
			 %> 
			     <html:text property="projectCost" name="appForm" styleId="projectCost" readonly="true" style="background-color:#C4DEE6"/>
			<%--  <bean:write name="appForm"	property="projectCost" /> --%> <%
			 	}
			 %>
			</td> 
