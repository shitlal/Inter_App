...
<%
	session.setAttribute("CurrentPage", "uploadOutstandingInputNew.do");
%>
<%@ include file="/jsp/SetMenuInfo.jsp"%>
<HTML>
<BODY>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:form action="uploadOutstandingAmtNew.do?method=uploadOutstandingAmtNew"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('uploadOutstandingAmtNew.do?method=uploadOutstandingAmtNew')">
