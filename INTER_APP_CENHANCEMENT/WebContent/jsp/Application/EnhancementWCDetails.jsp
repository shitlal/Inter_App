...
<!--start of enhance WC-->
	<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<TR align="left">
									...
									{
									%>
										<bean:write name="appForm" property="limitFundBasedInterest"/>&nbsp;&nbsp;<bean:message key="inPa" />
									<%
									}
									else
									{%>
					...
					<TR align="left">		    								
						...
						<TR align="left">		    								
									<td class="ColumnBackground" >
									<bean:message key="creditFundBased" /><font color="#FF0000" size="2">*</font>(e. Credit to be guaranteed)
									</td>
									<td class="TableData" id="enhancedFundBased">
									<%
										if(appWCEFlag.equals("1"))
										...
										{
										%>										
										Enhance:&nbsp;&nbsp;&nbsp;<html:text property="wcEnhanceLimitGauranteeAmt" styleId="creditFundBased" size="20" alt="wcEnhanceLimitGauranteeAmt" name="appForm" maxlength="16" onkeypress="isValidDecimal(this);" onblur="checkGurentyMaxtotalMIcollatSecAmt();"  onkeyup="return enableExtGreenFld('WCE');"/>
										<br><font color="#FF0000">Existing:&nbsp;&nbsp;&nbsp;<bean:write name="appForm" property="creditFundBased"/></font>
							...
							<!-- 	<TR align="left">		    								
									...
									<%
										...
										{
										%>
										   <html:text property="creditNonFundBased" size="20"	alt="creditNonFundBased" name="appForm"  />
										<%}%>
								</td>								
								<td class="ColumnBackground">
										&nbsp;<bean:message key="limitFundbasedSanctionedDate" /></td>
