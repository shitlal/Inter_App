...
<body onLoad="enableAssistance(),enableNone(),setConstEnabled(),enableDistrictOthers(),enableOtherLegalId(),enableSubsidyName(),calProjectCost(),calProjectOutlay(),enableGender(),enableHandiCrafts()">
					...
					<TR >
						...
						if (request.getParameter("detail")!=null)
							...
							<%}
								...
								<A href="javascript:submitForm1('addWcApp.do?method=submitApp')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>	
