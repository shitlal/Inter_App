...
<tr>
			<TD  align="left" colspan="4"><font size="2"><bold>
				Fields markedSS as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
			</td>
		</tr>
								<TR>
									<TD colspan="4"> 
								...
								<TR align="left">
									...
									<TD align="left" valign="top" class="tableData">
										...
										<%	}										
											...
											{%>
												<html:text property="mliRefNo" size="25" alt="Bank Reference No" name="appForm" maxlength="12" />
											<%}%>
...
<html:option value="Society/Co op">Society/Co op Society</html:option>
											 ...
											 <TR align="left">											
												...
												<TD align="left" valign="top" class="ColumnBackground" width="25%"><font color="#FF0000" size="2">*74</font>&nbsp;<bean:message key="state"/>
												</TD>												
												...
												<%
													...
													<html:select property="state" name="appForm" onchange="javascript:submitForm('afterRSF2TCMli.do?method=getDistricts')">
														<html:option value="">Select</html:option>
											 ...
											 <TR align="left">
												...
												<%
													...
													{ %>											
													<html:select property="industryNature" name="appForm" onchange="javascript:submitForm('afterRSF2TCIndustreSectorMli.do?method=getIndustrySector')">
														<html:option value="">Select</html:option>
												...
												<%
													...
													<html:select property="industrySector" name="appForm" onchange="javascript:submitForm('afterRSF2TCIndustrysector2.do?method=getTypeOfActivity')">
														<html:option value="">Select</html:option>
...
<TD align="left" valign="top" class="ColumnBackground" colspan="2" >&nbsp;<html:text property="jointcgpan" size="25" alt="jointcgpan" name="appForm" maxlength="15" disabled="true"/></td>
									...
									<td class="ColumnBackground" colspan="4">									
										<font color="#FF0000" size="2">*&nbsp;</font> <font color="#008600" size="2"><b>Credit facilities above Rs. 50 lakh and upto Rs.100 lakh will have to be rated internally by the MLI and should be of investment grade.For loan facility upto 50 lakhs MLIs may indicate ‘N.A’ if rating is not available.</b></font><br>
                                                                 ...
                                                                 <TR align="left">
									<TD align="left" valign="top" class="ColumnBackground" colspan="2"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message key="internalRating"/></td>								
									<TD align="left" valign="top" class="tableData">
									 <% if(appCommonFlag.equals("11") || appCommonFlag.equals("12") || appCommonFlag.equals("13"))
										 {
										%>
								 ...
								 <TR align="left">
									<TD align="left" valign="top" class="ColumnBackground" colspan="2"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message key="externalRating"/></td>								
									<TD align="left" valign="top" class="tableData">
									 <% if(appCommonFlag.equals("11") || appCommonFlag.equals("12") || appCommonFlag.equals("13"))
										 {
										%>
