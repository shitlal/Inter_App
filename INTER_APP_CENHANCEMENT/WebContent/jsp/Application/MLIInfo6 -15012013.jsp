...
}else if(session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE).equals("RSF"))
{
...
<html:errors />
<html:form action="afterTcMliPage2.do?method=getRSF2Apps" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('afterTcMliPage2.do?method=getRSF2Apps')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>					
				</TABLE>
