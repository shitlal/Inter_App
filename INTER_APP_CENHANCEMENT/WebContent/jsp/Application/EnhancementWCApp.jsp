...
<body onLoad="setConstEnabled(),enableNone(),enableDistrictOthers(),enableOtherLegalId(),enableSubsidyName(),calProjectCost(),calProjectOutlay(),enableHandiCrafts(),enabledcHandlooms()">
		...
		<TR>
			...
			<TD>
				<DIV align="right">			
					...
					<%@include file="CommonAppEnhancementDetails.jsp"%>
...
Click Here</A> to see Terms 'n' Conditions:
					...
					<TR >
						<TD align="center" valign="baseline" colspan="6">
							<DIV align="center">
								<A href="javascript:submitForm1('afterWcEnhanceApp.do?method=afterWcEnhanceApp')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>		
