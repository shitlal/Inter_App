...
<!--start of term-->		<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<tr align="left"> 
									...
									<%				
										...
										<html:text property="tenure" size="20" alt="tenure" name="appForm" maxlength="2" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)"/><bean:message key="inMonths" />
									<%}%>
