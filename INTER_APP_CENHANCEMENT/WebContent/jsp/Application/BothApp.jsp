	...
	<TABLE width="99%" border="0" cellpadding="0" cellspacing="0">
		...
		<TR>
			...
			<TD>
				...
				<%@include file="CommonAppTCWCDetails.jsp"%>
					...
					<TR >
						<TD align="center" valign="baseline" colspan="7">
							...
							<IMG align="center" src="images/warten-gif-5.gif" alt="Wait.." width="49" height="37" border="0"  id="progress_id" style="display:none"/>
								<A href="javascript:submitForm1('addBothApp.do?method=submitApp')"><IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0" onclick="showProgress('block');"></A>	
