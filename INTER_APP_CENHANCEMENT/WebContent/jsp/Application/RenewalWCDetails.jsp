	...
	function validateInterestRateWCR(rateType){
		...
		if(rateType === 'plr'){
			if(!(parseFloat(interest) > 0)){
				//alert('Please enter Interest rate first.');
				//document.forms[0].wcPlr.value='0.0';
				//return false;
			}
			if(parseFloat(interest) > (parseFloat(plr) + 4)){				
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
								...
								<tr>
									<td class="ColumnBackground" height="28" >&nbsp;
										<font color="#FF0000" size="2">*</font>&nbsp;<!--<bean:message key="typeOfPLR" />-->Type of Base Rate
									</td>
									<td class="TableData" height="28" >&nbsp;
										<html:text property="wcTypeOfPLR" disabled="true"  size="30" alt="wcTypeOfPLR" name="appForm" maxlength="50" />&nbsp;						
