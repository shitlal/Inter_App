...
<% if(session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE)!=null)
{
	...
	{
		session.setAttribute("CurrentPage","tcMliCgscl.do?method=getWCMliInfoCgscl");   // CO-LEND
		focusField="district";
	}
	...
	{
		session.setAttribute("CurrentPage","afterTcMli.do?method=getBorrowerDetails");   // CO-LEND
...
<body
	...
	<html:form action="addWcAppCgscl.do?method=submitApp" method="POST"
		focus="<%=focusField%>">
					...
					if(appFlag.equals("4"))
						...
						if (request.getParameter("detail")!=null)
							...
							%>
									...
									<A
										href="javascript:submitForm1('addWcAppCgscl.do?method=submitApp')"><IMG
