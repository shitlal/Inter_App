...
<%
	session.setAttribute("CurrentPage", "ApplicationLogdementInBulkInput.do");
%>
<%@ include file="/jsp/SetMenuInfo.jsp"%>
<HTML>
<BODY>
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:form action="ApplicationLogdementInBulkProcess.do?method=ApplicationLogdementInBulkProcess"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
				...
				<TR>
					...
					<A target="_blank" href="Download/Template_upto_10_Lac.xls" >
					Click here to download Excel Template File</A>
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							...
							<font style="color: red; font-size: 15px;">
							      Note: 1] File Format should be xls (or XLS)  ANanad
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('ApplicationLogdementInBulkProcess.do?method=ApplicationLogdementInBulkProcess')">
