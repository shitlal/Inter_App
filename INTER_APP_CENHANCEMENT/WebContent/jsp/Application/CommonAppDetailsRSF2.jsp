...
<html:option value="Society/Co op">Society/Co op Society</html:option>
											 ...
											 <TR align="left">											
												...
												<TD align="left" valign="top" class="ColumnBackground" width="25%"><font color="#FF0000" size="2">*7</font>&nbsp;<bean:message key="state"/>
												</TD>												
												...
												<%
													...
													<html:select property="state" name="appForm" onchange="javascript:submitForm('afterRSF2Mli.do?method=getDistricts')">
														<html:option value="">Select</html:option>
											 ...
											 <TR align="left">
												...
												<%
													...
													{ %>											
													<html:select property="industryNature" name="appForm" onchange="javascript:submitForm('afterRSF2ForWCIndustrySecotrMli.do?method=getIndustrySector')">
														<html:option value="">Select</html:option>
												...
												<%
													...
													<html:select property="industrySector" name="appForm" onchange="javascript:submitForm('afterRSF2ForWCIndustrySecor2rMli.do?method=getTypeOfActivity')">
														<html:option value="">Select</html:option>
