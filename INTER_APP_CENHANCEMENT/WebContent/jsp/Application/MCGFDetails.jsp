<TABLE border="0" cellpadding="1" cellspacing="1" width="100%" >
 ...
 <TR>
  ...
  <TR>
	...
	{ %>
	    <html:text property="mcgfApprovedDate" size="20"  name="appForm" maxlength="10" styleClass="dkr_datepicker" />
	...
	{ %>
	    <html:text property="mcgfGuaranteeCoverStartDate" size="20" styleClass="dkr_datepicker"   name="appForm" maxlength="10"/>
