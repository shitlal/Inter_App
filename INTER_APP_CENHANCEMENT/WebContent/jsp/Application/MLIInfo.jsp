...
<% if (session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE).equals("TC"))
{
...
}if (session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE).equals("BO"))
{
session.setAttribute("CurrentPage","tcMli.do?method=getBothMliInfo");
}
if (session.getAttribute(SessionConstants.APPLICATION_LOAN_TYPE).equals("GS"))
{
session.setAttribute("CurrentPage","tcMlistate.do?method=getMemStateGSTiInfo");
}
;%>

<html:errors />
<html:form action="afterTcMliPage.do?method=getApps" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('afterTcMliPage.do?method=getApps')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>					
				</TABLE>
