...
<body onLoad="setConstEnabled(),enableNone(),enableDistrictOthers(),enableOtherLegalId(),enableSubsidyName(),enableHandiCrafts(),enabledcHandlooms()">
		...
		<TR>
			...
			<TD>
				<DIV align="right">			
					...
					<%@include file="CommonAppRenuwalDetails.jsp"%>
