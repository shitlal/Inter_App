		...
		<TR>
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <TD width="10%" align="left" valign="top" class="ColumnBackground">
                       <%--  <bean:message key="ssiName"/> --%>Unit Name
                      </TD>
                       <TD width="10%" align="left" valign="top" class="ColumnBackground">
                        CGPAN
                      </TD>
                      ...
                      <%=details.getMemberId()%>
                       ...
                       <TD width="10%" align="left" valign="top" class="ColumnBackground1">
                                 <%= details.getBranchName() %>
												...
												<TD width="10%" align="left" valign="top" class="ColumnBackground1">															
												<%-- <%=details.getAppRefNo().toString()%> --%>
												<% String reference=details.getAppRefNo();
												    String url = "applicationStatusWiseReportDetails.do?method=applicationStatusWiseReportDetails&number="+reference; 	%>				
											  <html:link href="<%=url%>"><%=reference%></html:link>
												</TD>
					  <TD width="10%" align="left" valign="top" class="ColumnBackground">						
							 <% if(details.getLoanAcntNumber()!=null){ %>
                            <%= details.getLoanAcntNumber()%>
                            <% } else { %>
                                ---
                            <% } %>
						...
						<TD width="10%" align="left" valign="top" class="ColumnBackground1">					
						<% String reference1=details.getCgPan();
						String url1 = "";
						 if(reference1!=null){
							 url1 = "applicationWiseReportDetailsForCgpan.do?method=applicationWiseReportDetailsForCgpan&number="+reference1;  
						 %>				
						<html:link href="<%=url1%>"><%=reference1%></html:link>
						<% }else{ %>
						 --
						<% } %>
						</TD>
                        ...
                        <%= decimalFormat.format(amount)%>
						  ...
						  <TD width="10%" align="left" valign="top" class="ColumnBackground1">
                            <% if(details.getAmountSanctionedDate()!=null){ %>
                            <%= details.getAmountSanctionedDate()%>
                            <% } else { %>
                             ---
                               <% } %>
						 </TD>	
						  <TD width="10%" align="left" valign="top" class="ColumnBackground1">
                           <% if(details.getGuarStartDate()!=null){ %>
                            <%= details.getGuarStartDate() %>
                            <% } else { %>
                             ---
                               <% } %>
                          </TD>	
