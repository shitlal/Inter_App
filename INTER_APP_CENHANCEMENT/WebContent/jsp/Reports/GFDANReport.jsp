...
<% session.setAttribute("CurrentPage","gfdanReport.do?method=gfdanReport");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="gfdanReport.do?method=gfdanReport" method="POST" enctype="multipart/form-data">
		<TR> 
                      ...
                      <TR>
                        ...
                        <bean:message key="ssiName"/>
									...
									<%	double sum = 0;
										...
										double totalpendAmt= 0;
										double totalunPaidAmt= 0;
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="gfdan" indexId="index">
									<%
                   ...
                   <%=branchName%> 
											...
											<TD width="10%" align="left" valign="top" class="ColumnBackground1">		
												<div align="right">
													...
													double paidAmount = dReport.getPaidAmount();
													totalPaidAmt = totalPaidAmt + paidAmount;
												%>
										        <%=decimalFormat.format(paidAmount)%>
                                             ...
                                             <TD width="10%" align="left" valign="top" class="ColumnBackground1">		
												<div align="right">
													<%
														...
														double pendingAmount = dReport.getPendingAmount();
														totalpendAmt = totalpendAmt + pendingAmount;
													%>
											        <%=decimalFormat.format(pendingAmount)%>
											   </div>
                                             </TD>
                                             <TD width="10%" align="left" valign="top" class="ColumnBackground1">		
												<div align="right">
													<%
														double unPaidAmount = dReport.getUnPaidAmount();
													totalunPaidAmt = totalunPaidAmt + unPaidAmount;
													%>
											        <%=decimalFormat.format(unPaidAmount)%>
											   </div>
                                             </TD>
									...
									<%=decimalFormat.format(totalhecess)%>
									 ...
									 <TD width="10%" align="left" valign="top" class="ColumnBackground">
									<div align="right">
									<%=decimalFormat.format(totalPaidAmt)%>
									</div>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
									<div align="right">
									<%=decimalFormat.format(totalpendAmt)%>
									</div>
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
									<div align="right">
									<%=decimalFormat.format(totalunPaidAmt)%>
									</div>
									</TD>
									<!--Added By Rajuk-->
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('gfdanReportInput.do?method=gfdanReportInput')">
