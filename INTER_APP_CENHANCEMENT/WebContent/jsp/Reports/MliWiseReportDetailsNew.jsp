...
<% session.setAttribute("CurrentPage","mliWiseReportDetailsNew.do?method=mliWiseReportDetailsNew");%> 
...
<TABLE width="780" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="mliWiseReportDetailsNew.do?method=mliWiseReportDetailsNew" method="POST" enctype="multipart/form-data">
		<TR> 
               ...
               <tr>
                ...
                <tr>
								...
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="30%" class="Heading"><bean:message key="mliWiseHeader" /></TD>
                        <td class="Heading" width="70%"><bean:write name="radioValue"/>&nbsp;<bean:message key="from"/><bean:write  name="rsForm" property="dateOfTheDocument12"/>&nbsp;<bean:message key="to"/> <bean:write  name="rsForm" property="dateOfTheDocument13"/>
                        </td>
												<TD><IMG src="images/TriangleSubhead.gif" width="19" height="19"></TD>
											</TR>
											<TR>
												<TD colspan="3" class="Heading"><IMG src="images/Clear.gif" width="450" height="5"></TD>
											</TR>
											</TABLE>
									</TD>
								</TR>
                  ...
                  <TD align="left" class="ColumnBackground"> 
									Corresponding Previous Period Approvals
									</TD>
                  <% if (value.equals("yes")){%>	
										<TD align="left" class="ColumnBackground"> 
										<bean:message key="amountApprovedLakhs"/>
                  ...
                  <% if (value.equals("yes")){%>	
                    ...
                    int cumcount       = 0;
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="mliWiseReportNew" indexId="id">
                  ...
                  <TD align="left" valign="top" class="ColumnBackground1">
									...
									String url = "zoneWiseReportDetailsNew.do?method=zoneWiseReportDetailsNew&Zone="+bank;
									int i = bank.indexOf("&");
									if(i == -1)
									{	%>
									...
									String newUrl = "zoneWiseReportDetailsNew.do?method=zoneWiseReportDetailsNew&Zone="+newZone;
									%>
									<html:link href="<%=newUrl%>"><%= bank%></html:link>
									<%}%>
									|							
									<% String bank1 = dReport.getType();
									String url1 = "sectorWiseReportDetailsNew.do?method=sectorWiseReportDetailsNew&Sector="+bank1;
									int j = bank1.indexOf("&");
									if(j == -1)
									{	%>
                  <html:link href="<%=url1%>">SectorWise</html:link>
									...
									String newUrl1 = "sectorWiseReportDetailsNew.do?method=sectorWiseReportDetailsNew&Sector="+newZone1;
									%>
									<html:link href="<%=newUrl1%>">SectorWise</html:link>
									<%}%>
									|
									<% String bank2 = dReport.getType();
									String url2 = "statesWiseReportNew.do?method=statesWiseReportNew&state="+bank2;
									int k = bank2.indexOf("&");
									if(k == -1)
									{%>
									...
									String newUrl2 = "statesWiseReportNew.do?method=statesWiseReportNew&state="+newZone2;
									%>
									<html:link href="<%=newUrl2%>">StateWise</html:link>
									<%}%>
									</TD>
									<TD width="2" align="left" class="ColumnBackground1"> 
									<div align="right">
									...
									<TD width="5" align="left" class="ColumnBackground1"> 
									<div align="right">
                  ...
                  <TD align="left" class="ColumnBackground1"> 
									...
									<% prevtotalSum = prevtotalSum+Double.parseDouble(decimalFormat.format(prevsum));%>
                  ...
                  <TD align="left" class="ColumnBackground1"> 
									...
									<% cumtotalSum = cumtotalSum+Double.parseDouble(decimalFormat.format(cumsum));%>
                  ...
                  <TD align="left" class="ColumnBackground"> 
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">
							<A href="javascript:submitForm('mliWiseReportNew.do?method=mliWiseReportNew')">
