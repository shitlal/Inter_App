...
<% session.setAttribute("CurrentPage","asfpaymentReportInput.do?method=asfpaymentReportInput");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfpaymentReport.do?method=asfpaymentReport" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
			<A HREF="paymentReportHelp.do?method=paymentReportHelp">
			HELP</A>
								...
								<TR>
									...
									<DIV align="center">
									   ...
									   <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument16" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument16')" align="center">
										  <DIV align="left">
									  </TD>
									...
									<font color="#FF0000" size="2">*</font>
									    ...
									    <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument17" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument17')" align="center">
										  <DIV align="left">
									  </TD>
									  </TR>
