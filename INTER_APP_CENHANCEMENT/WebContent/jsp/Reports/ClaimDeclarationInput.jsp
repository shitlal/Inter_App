...
<% session.setAttribute("CurrentPage","npaReportInput.do?method=npaReportInput");%>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							        <A href="javascript:submitForm('claimDeclarationReport.do?method=claimDeclarationReport')">
