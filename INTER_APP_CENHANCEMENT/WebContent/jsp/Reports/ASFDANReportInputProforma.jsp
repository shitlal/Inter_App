...
<% session.setAttribute("CurrentPage","asfdanReportInputProforma.do?method=asfdanReportInputProforma");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReportProforma?method=asfdanReportProforma" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				<tr>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm('asfdanReportProforma.do?method=asfdanReportProforma')">
