						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									<%	String url = "stateDetailsForState.do?method=stateDetailsForState";%>
									<html:link href = "<%=url%>"> State Wise </html:link>
										|
										<%String url1 = "districtDetailsForState.do?method=districtDetailsForState";%>
