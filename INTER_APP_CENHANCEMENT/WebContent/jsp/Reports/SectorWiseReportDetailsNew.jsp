...
<% session.setAttribute("CurrentPage","sectorWiseReportDetailsNew.do?method=sectorWiseReportDetailsNew");%>
...
<TABLE width="780" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="sectorWiseReportDetailsNew.do?method=sectorWiseReportDetailsNew" method="POST" enctype="multipart/form-data">
		<TR> 
                ...
                <tr> <td colspan="6">&nbsp;</td></tr>
								<TR>
									<TD colspan="8"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="19%" class="Heading"><bean:message key="sectorWiseHeader" /></TD>
												<td class="Heading" width="35%"> From Date <bean:write  name="rsForm" property="dateOfTheDocument12"/>&nbsp;To <bean:write  name="rsForm" property="dateOfTheDocument13"/></td>
                  ...
                  <% if (value.equals("yes")){%>	
                    ...
                    int cumcount       = 0;
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="sectorReport" indexId="id">
									<%
