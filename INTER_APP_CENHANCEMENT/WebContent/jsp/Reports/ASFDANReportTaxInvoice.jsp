...
<% session.setAttribute("CurrentPage","asfdanReportInputTaxInvoice.do?method=asfdanReportInputTaxInvoice");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReportTaxInvoice.do?method=asfdanReportTaxInvoice" method="POST" enctype="multipart/form-data">
		<TR> 
 ...
 String branchName = dReport.getBranchName();%>
                   ...
                   <%=branchName%> 
											...
											String url = "asfdanReportDetailsTaxInvoice.do?method=asfdanReportDetailsTaxInvoice&danValue="+danId+"&bankName="+bank+"&zoneName="+zone+"&branchName="+branch+"&bName="+branchName+"&date="+formatedDate+"&memid="+memid;%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('asfdanReportInputTaxInvoice.do?method=asfdanReportInputTaxInvoice')">
