...
<% session.setAttribute("CurrentPage","minorityprogressReport.do?method=minorityprogressReport");%>
<%@page import ="java.text.DecimalFormat"%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.#####");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="minorityprogressReport.do?method=minorityprogressReport" method="POST" enctype="multipart/form-data">
		<TR> 
        ...
        double total = 0;
				...
				<logic:iterate id="object" name="rsForm" property="minorityprogressReport" indexId="index">
				<%
        ...
        <TR>
            <td align = "right"  class="ColumnBackground ">&nbsp;TOTAL<div align="right"><%= decimalFormat.format(total)%>&nbsp;</div></TD>
            </TR>
						</TD>
					</TR>
					<TR >
					...
					<TR >
						<TD align="center" valign="baseline">
							<DIV align="center">
								<A href="javascript:submitForm('minorityReport.do?method=minorityReport')">
