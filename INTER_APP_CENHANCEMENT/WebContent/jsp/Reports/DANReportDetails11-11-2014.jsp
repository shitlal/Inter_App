			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <tr> <td colspan="6">&nbsp;</td></tr>
											...
											<TR>
												...
												<TD  align="left" valign="top" class="SubMenu">
												Branch: <% if(branch.equals("")||branch==null){
                     ...
                     <%=branch%>	     
                      ...
                      <TD width="10%" align="left" valign="top" class="ColumnBackground">
                        <bean:message key="reapprovedAmount"/>
                      </TD>
                      <TD width="10%" align="left" valign="top" class="ColumnBackground">
                        ReApproved Date
                      </TD>
                    ...
                    <!-- close date will be displayed only if status is CL -->
                      ...
                      <TD width="10%" align="left" valign="top" class="ColumnBackground1">						
   											<%=dReport.getAppropriationBy()%>
											</TD>
											</TR>
											</logic:iterate>

									<TR>
									<TD width="10%" align="left" valign="top" colspan="5" class="ColumnBackground">
									Total									
									</TD>
