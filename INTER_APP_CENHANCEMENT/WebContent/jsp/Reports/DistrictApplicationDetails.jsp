...
<% session.setAttribute("CurrentPage","districtApplicationDetails.do?method=districtApplicationDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="districtApplicationDetails.do?method=districtApplicationDetails" method="POST" enctype="multipart/form-data">
		<TR> 
					...
					<TR>
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<tr>
									<logic:iterate id="object" name="rsForm" property="districtReport">
									<%
