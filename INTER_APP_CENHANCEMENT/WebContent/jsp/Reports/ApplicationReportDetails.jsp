...
<% session.setAttribute("CurrentPage","applicationReportDetails.do?method=applicationReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="applicationReportDetails.do?method=applicationReportDetails" method="POST" enctype="multipart/form-data">
		...
		<TR>
			...
			<TD>
				...
				<tr> 
                  <td class="tableData"> <div align="left">&nbsp; <b><bean:message key="cgpanForApplication" /></b><bean:write property="applicationReport.cgpan" name="rsForm"/>  &nbsp; &nbsp;&nbsp;
                  &nbsp;<b><bean:message key="hybridSecurityFlag" /></b><bean:write property="applicationReport.hybridSecurityFlag" name="rsForm"/></div></td>
          ...
          System.out.println(newexpiredOn);
                 ...
                 <!-- Diksha  -->
                   ...
                   <td class="tableData"> <div align="left">&nbsp; <b><bean:message key="pmrBankAccNo" />
                   </b><bean:write property="applicationReport.pmrBankAccNo" name="rsForm"/></div></td>
        ...
        <td class="tableData">&nbsp;<b><bean:message key="microFlag" /></b>:&nbsp;&nbsp;<bean:write property="applicationReport.microFlag" name="rsForm"/></td>
        </tr>
  ...
  <tr>
        <td class="tableData"><b>&nbsp;FLAGGING OF WCTL</b>:&nbsp;&nbsp;<bean:write property="applicationReport.flaggingofWCTL" name="rsForm"/></div></td>
        <td class="tableData">&nbsp;</td>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm('applicationReport.do?method=applicationReport')">
