...
<% session.setAttribute("CurrentPage","branchWiseReportDetails.do?method=branchWiseReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="branchWiseReportDetails.do?method=branchWiseReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <tr>
                        <td colspan="6" class="Heading1" align="center"><u><!-- <bean:message key="reportHeader"/> -->
Credit Guarantee Fund Trust for Micro And Small Enterprises </u>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="6">&nbsp;</td>
                  ...
                  <td align="left" valign="top" class="ColumnBackground"><bean:message key="sNo"/></td>
                   ...
                   // System.out.println("bank:"+request.getAttribute("bankName"));
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="branchReport" indexId="id">
									<%
                  ...
                  <td align="left" valign="top" class="ColumnBackground1"><%=Integer.parseInt(id+"")+1%></td>
									<TD align="left" valign="top" class="ColumnBackground1">
										<%String branch=dReport.getType();
                    
										if((branch == null) || (branch.equals("")))
										{
										%>
										<%=request.getAttribute("zoneName")%>
										<%
										}
										else
										{
