...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="mliWiseNEDistrictReportDetailsNew1.do?method=mliWiseNEDistrictReportDetailsNew1" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					<TR>
                      ...
                      <TR>
												<TD width="16%" class="Heading">NER District-wise Report </TD>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
             <tr> 
                  ...
                  <td width="20%" class="ColumnBackground "><div align="center"><bean:message key="districtName"/>
                 </div></td>
                  <td width="10%" class="ColumnBackground "><div align="center"><bean:message key="proposals"/>
                 </div></td>
                  <td class="ColumnBackground"  width="10%"> <div align="center"><!--<bean:message key="amountApprovedLakhs"/>--> Approved Amount(In Rs.)
                </div></td>
                 <logic:equal property="bankId" value="0000" name="rsForm">
                   ...
                   <td class="ColumnBackground"  width="10%"> <div align="center"><!-- <bean:message key="amountIssuedLakhs"/>--> Issued Amount(In Rs.) </div></td>
                   </logic:equal>
            </tr> 
        ...
        <td>
              ...
              double totalissued = 0;
				...
				<logic:iterate id="object" name="rsForm" property="mliWiseNEDistrictReportDetailsNew" indexId="index">
				<%
        ...
        <tr class="tableData">
				  ...
				  <td><div align="left">&nbsp;<%= pReport.getName()%>&nbsp;</div>
         ...
         <tr class="tableData">
					...
					<TR >
						<TD align="center" valign="baseline">
							<DIV align="center">
								<A href="javascript:submitForm('mliWiseNEStateReportDetailsNew.do?method=mliWiseNEStateReportDetailsNew')">
