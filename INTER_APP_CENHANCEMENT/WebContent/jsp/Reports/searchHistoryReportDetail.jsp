...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="searchHistory.do?method=searchHistory"
		...
		<TR>
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="15%" class="Heading">Search Itpan History Report</TD>
			...
			<TR>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('searchHistory.do?method=searchHistory')">
