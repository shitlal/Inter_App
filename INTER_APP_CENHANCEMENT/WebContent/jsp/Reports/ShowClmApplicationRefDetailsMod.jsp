...
<html:form action="addFirstClaimsPageDetails.do?method=addFirstClaimsPageDetails" method="POST" enctype="multipart/form-data">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">    
                    ...
                    <td colspan="8" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  					  ...
  					  <%
						 ...
						 lastDsbrsmntDtStr = "";
  					     ...
  					     outstandingAsOnDateOfNPA = Double.parseDouble(decimalFormat.format(tlcldtl.getOutstandingAsOnDateOfNPA()));
  					     outstandingStatedInCivilSuit = Double.parseDouble(decimalFormat.format(tlcldtl.getOutstandingStatedInCivilSuit()));
  					     outstandingAsOnDateOfLodgement = Double.parseDouble(decimalFormat.format(tlcldtl.getOutstandingAsOnDateOfLodgement()));
  					  %>  					          
  					  <tr>					  
  				...
  				<tr>
                    <td colspan="5" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  					  ...
  					  <% 
  					     ...
  					     outstandingAsOnDateOfNPA = Double.parseDouble(decimalFormat.format(wcdtl.getOutstandingAsOnDateOfNPA()));
  					     outstandingStatedInCivilSuit =Double.parseDouble(decimalFormat.format(wcdtl.getOutstandingStatedInCivilSuit()));
  					     outstandingAsOnDateOfLodgement = Double.parseDouble(decimalFormat.format(wcdtl.getOutstandingAsOnDateOfLodgement()));  					     				  					  
  					  %>  					  
  					  <tr>
   ...
   <tr><td width="20" align="right" valign="bottom"><img src="images/TableLeftBottom.gif" width="20" height="51"></td>
