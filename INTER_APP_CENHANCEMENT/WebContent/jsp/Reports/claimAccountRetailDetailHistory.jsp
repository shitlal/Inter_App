...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form
		action="accountDetailHistoryReport.do?method=accountDetailHistoryReport"
		...
		<TR>
			...
			<TABLE width="100%" border="0" align="left" cellpadding="0"
					...
					<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
						<TR>
							...
							<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD width="15%" class="Heading">CLAIM ACCOUNT REPORT HISTORY</TD>
				...
				<TR>
					...
					<DIV align="center"><A
						href="javascript:submitForm('claimAccountReportInput.do?method=claimAccountReportInput')">
