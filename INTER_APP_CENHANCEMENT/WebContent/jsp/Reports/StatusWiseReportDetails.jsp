						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									...
									<TR>
                                                                         <TD width="2%" align="left" valign="top" class="ColumnBackground">
...
<TD width="10%" align="left" valign="top" class="ColumnBackground">
									...
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
								        SSi Unit Name
											...
											<tr>
<% int index = 0; %>
											<logic:iterate name="rsForm" id="object" property="mliWiseReport">
											<%
											...
											<TR>
<% index = index+1; %>
                                                                                               	<td width="2%" align="left" valign="top" class="ColumnBackground1"><%=index%></td>
