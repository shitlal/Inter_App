...
<% session.setAttribute("CurrentPage","districtDetailsForState.do?method=districtDetailsForState");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="districtDetailsForState.do?method=districtDetailsForState" method="POST" enctype="multipart/form-data">
		<TR> 
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									%>
										<TD align="left" class="ColumnBackground"> 
										<bean:message key="amountIssuedRs"/>
										</TD>
									<%
									}
									%>
