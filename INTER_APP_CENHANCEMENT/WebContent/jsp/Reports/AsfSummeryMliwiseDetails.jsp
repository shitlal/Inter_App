...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
								...
								<TR>
									<TD colspan="16"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<tr>
                        <td colspan="6" class="Heading1" align="center"><u><!--<bean:message key="reportHeader"/>--><b>Credit Guarantee Fund Trust For Micro and Small Enterprises</b></u>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="6">&nbsp;</td>
    ...
    %> 
                 <TR class="tableData">
                  ...
                  <th class="ColumnBackground">DAN Amount</th>
                  ...
                  <th class="ColumnBackground">App. Status</th>
                    <th class="ColumnBackground">IGST</th>
                        <th class="ColumnBackground">CGST</th>
                           ...
                           <th class="ColumnBackground">GuaranteeAmount</th>
                           <th class="ColumnBackground">FinalRate</th>
                </TR>
