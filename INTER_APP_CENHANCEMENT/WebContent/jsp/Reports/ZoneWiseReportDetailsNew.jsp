...
<% session.setAttribute("CurrentPage","zoneWiseReportDetailsNew.do?method=zoneWiseReportDetailsNew");%>
...
<TABLE width="780" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="zoneWiseReportDetailsNew.do?method=zoneWiseReportDetailsNew" method="POST" enctype="multipart/form-data">
		<TR> 
