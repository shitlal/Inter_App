...
<% session.setAttribute("CurrentPage","shortReport.do?method=shortReport");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="shortReport.do?method=shortReport" method="POST" enctype="multipart/form-data">
		<TR> 
								...
								<TR>
									<TD colspan="8"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="30%" class="Heading"><bean:message key="shortInfoReport" /></TD>
									...
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="shortDate" />
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="shortAmount" />
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
										<bean:message key="isDan" />
									</TD>
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="danRaised">
									<%
									...
									%>
											...
											String url = "shortReportDetails.do?method=shortReportDetails&paymentValue="+paymentId;
