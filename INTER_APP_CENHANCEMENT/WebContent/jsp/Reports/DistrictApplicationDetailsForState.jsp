...
<% session.setAttribute("CurrentPage","districtApplicationDetails1.do?method=districtApplicationDetails1");
%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="districtApplicationDetails1.do?method=districtApplicationDetails1" method="POST" enctype="multipart/form-data">
		<TR> 
					...
					<TR>
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="31%" class="Heading"><bean:message key="districtHeader" /></TD>
								...
								<tr>
									<logic:iterate id="object" name="rsForm" property="mliDistrictReport">
									<%
