...
<% session.setAttribute("CurrentPage","asfAllocatedReportDetails.do?method=asfAllocatedReportDetails");%> 
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfAllocatedReportDetails.do?method=asfAllocatedReportDetails" method="POST" enctype="multipart/form-data">
		<TR> 
		...
		<TR>
			...
			<TD>
              ...
              <TD align="left" valign="top" class="ColumnBackground">MemberId
           	 ...
           	 <tr>
									<logic:iterate id="object" name="rsForm" property="asfallocatedpaymentdetails" indexId="id">
