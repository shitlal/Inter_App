...
<% session.setAttribute("CurrentPage","stateApplicationDetails1.do?method=stateApplicationDetails1");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="stateApplicationDetails1.do?method=stateApplicationDetails1" method="POST" enctype="multipart/form-data">
		<TR> 
					...
					<TR>
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="31%" class="Heading"><bean:message key="mliWiseHeader" /></TD>
								...
								<tr>
									<logic:iterate id="object" name="rsForm" property="stateReport">
									<%
