...
<% session.setAttribute("CurrentPage","asfdanReport.do?method=asfdanReport");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReport.do?method=asfdanReport" method="POST" enctype="multipart/form-data">
		<TR> 
                  ...
                  <td width="3%" align="left" valign="top" class="ColumnBackground"><bean:message key="sNo"/></td>
					  ...
					  <TD width="10%" align="left" valign="top" class="ColumnBackground">
                        	Bank App Ref No.
									...
									<TD width="10%" align="left" valign="top" class="ColumnBackground">
									 ...
									 <tr>
									<logic:iterate id="object" name="rsForm" property="asfdan" indexId="index">
									<%
                      ...
                      <td align="left" valign="top" class="ColumnBackground1"><%=Integer.parseInt(index+"")+1%></td>
                             ...
                             <%=branchName%>
											...
											<TD width="10%" align="left" valign="top" class="ColumnBackground1">						
											<%String bankRefNo=dReport.getBankAppRefNo();
											%>
											<%=bankRefNo%>
...
<TD width="10%" align="left" valign="top" class="ColumnBackground">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('asfdanReportInput.do?method=asfdanReportInput')">
