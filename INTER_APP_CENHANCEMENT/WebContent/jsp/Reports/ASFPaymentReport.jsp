...
<% session.setAttribute("CurrentPage","asfpaymentReport.do?method=asfpaymentReport");%>
			...
			<TD>
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <TD width="20%" align="left" valign="top" class="ColumnBackground">
									...
									<tr>
									<logic:iterate name="rsForm"  property="asfpayment"  id="object" indexId="index">
									<%
                    ...
                    String url = "payInstrumentDetails1.do?method=payInstrumentDetailsNew&payInstrumentNo="+payInstrumentNo+"&memberId="+memberId;%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('asfpaymentReportInput.do?method=asfpaymentReportInput')">
