...
<% session.setAttribute("CurrentPage","gfdanReportInput.do?method=gfdanReportInput");%>
...
function submitForm1(action)
{
	...
	if(document.forms[0].dateOfTheDocument20.value=="" || document.forms[0].dateOfTheDocument20.value==null )
	{
		alert("please enter From Date ");

		document.getElementById('dateOfTheDocument20').focus();

	}
	//alert("raju1")
    var todaysDate='01/07/2017';
    var machingDate=document.forms[0].dateOfTheDocument20.value;
    var date=machingDate.split("/");
    var dates=todaysDate.split("/");
    var dat=date[0];
   // alert(dat);
    var month=date[1];
   // alert(month);
  ...
  //  alert(year1);
	...
	//alert("rajuk"+document.forms[0].dateOfTheDocument20.value);
	//if(machingDate < todaysDate)
	//{
		alert("Please Entered FromDate is Not Less Than '01/07/2017'  ");
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="gfdanReportProforma.do?method=gfdanReportProforma" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									<A href="javascript:submitForm1('gfdanReportProforma.do?method=gfdanReportProforma')">
