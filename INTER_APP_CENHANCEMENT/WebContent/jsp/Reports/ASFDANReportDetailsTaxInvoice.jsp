...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReportInputTaxInvoice.do?method=asfdanReportInputTaxInvoice" method="POST"
...
<%}
								...
								<% if(danType.equalsIgnoreCase("AF")||danType.equalsIgnoreCase("SF")||danType.equalsIgnoreCase("RS")) 
                                                                {  %>
