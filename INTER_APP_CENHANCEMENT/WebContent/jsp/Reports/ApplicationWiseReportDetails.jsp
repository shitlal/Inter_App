...
<% session.setAttribute("CurrentPage","applicationWiseReportDetails.do?method=applicationWiseReportDetails");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="applicationWiseReportDetails.do?method=applicationWiseReportDetails" method="POST" enctype="multipart/form-data">
		...
		<TR>
			...
			<TD>
				...
				<tr>
                  ...
                  <td class="tableData"> <div align="left">&nbsp; <b><bean:message key="unitType" /></b>
				<bean:define id="unitType" name="rsForm" property="statusDetails" type="com.cgtsi.reports.ApplicationReport"/>
           ...
           <td class="tableData"> <div align="left">&nbsp; <b>Application Expiry Date :</b>
				  <bean:define id="expiryDate" name="rsForm" property="statusDetails" type="com.cgtsi.reports.ApplicationReport"/>
				  <%String date10 = null;
        ...
        <tr>
        <td class="tableData"><b>&nbsp;<bean:message key="activitytype" /></b>:&nbsp;&nbsp;<bean:write property="statusDetails.typeOfActivity" name="rsForm"/></div></td>
        <td class="tableData">&nbsp;</td>
				...
				<tr>
				  ...
				  <td class="tableData"><div align="left">&nbsp;<b><bean:message key="tcTenure" /></b>:&nbsp;&nbsp<bean:write property="statusDetails.tcTenure" name="rsForm"/></div></td>
				...
				<tr>
                  <td class="tableData"> <div align="left">&nbsp; <b><bean:message key="WCEquity" /></b><bean:write property="statusDetails.wcEquity" name="rsForm"/></div></td>
				   <td class="tableData"> <div align="left">&nbsp;<b><bean:message key="workingCapitalTenure" /></b>:&nbsp;&nbsp;<bean:write property="statusDetails.wcTenure" name="rsForm"/></div></td>
