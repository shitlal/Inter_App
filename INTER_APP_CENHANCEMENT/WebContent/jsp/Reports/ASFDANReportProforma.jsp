...
<% session.setAttribute("CurrentPage","asfdanReportProforma.do?method=asfdanReportProforma");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReportProforma.do?method=asfdanReportProforma" method="POST" enctype="multipart/form-data">
		<TR> 
 ...
 String branchName = dReport.getBranchName();%>
                   ...
                   <%=branchName%> 
                      ...
                      <TD width="10%" align="left" valign="top" class="ColumnBackground1">
											...
											String url = "asfdanReportDetailsProforma.do?method=asfdanReportDetailsProforma&danValue="+danId+"&bankName="+bank+"&zoneName="+zone+"&branchName="+branch+"&bName="+branchName+"&date="+formatedDate+"&memid="+memid;%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('asfdanReportInputProforma.do?method=asfdanReportInputProforma')">
