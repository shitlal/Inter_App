...
<% session.setAttribute("CurrentPage","gfdanReportTaxInvoice.do?method=gfdanReportTaxInvoice");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<%DecimalFormat decimalFormat = new DecimalFormat("##########.##");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="gfdanReportTaxInvoice.do?method=gfdanReportTaxInvoice" method="POST" enctype="multipart/form-data">
		<TR> 
 ...
 String branchName = dReport.getBranchName();%>
                   ...
                   <%=branchName%> 
											...
											String url = "danReportDetailsTaxInvoice.do?method=danReportDetailsTaxInvoice&danValue="+danId+"&bankName="+bank+"&zoneName="+zone+"&branchName="+branch+"&bName="+branchName+"&date="+formatedDate+"&memid="+memid;%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('gfdanReportInputTaxInvoice.do?method=gfdanReportInputTaxInvoice')">
