...
<%  session.setAttribute("CurrentPage","asfSummeryReport.do?method=asfSummeryReport");%>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfSummeryReport.do?method=asfSummeryReportDetails" enctype="multipart/form-data" method="POST">
		<TR> 
		...
		<TR>
			...
			<TD>
			<DIV align="right">			
			<A HREF="asfSummeryReportHelp.do?method=asfSummeryReportHelp">HELP</A>
				...
				<TD  align="left" colspan="4"><font size="2"><bold></font>
								...
								<TR>
									...
									<DIV align="center">
									   ...
									   <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument36" size="20" maxlength="10" alt="Reference" name="rsForm"/>
									  ...
									  <TD align="left" valign="top" class="ColumnBackground">
									    ...
									    <TD  align="left" valign="center" class="TableData">
										  <DIV align="left">
										  <html:text property="dateOfTheDocument37" size="20" maxlength="10" alt="Reference" name="rsForm"/>
										  <IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rsForm.dateOfTheDocument37')" align="center">
										  <DIV align="left">
									  </TD>
									  </TR>
									  ...
									  <bean:message key="memberId" /> 
									   ...
									   <DIV align="left">
										<bean:write property="mliID" name="rsForm"/>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							       <A href="javascript:submitForm('asfSummeryReport.do?method=asfSummeryReportDetails')">
								...
								<A href="javascript:document.rsForm.reset()">
									...
									<a href="asfOutstandingExcelReport.do?method=asfOutstandingExcelReport&&fileType=CSVType&FlowLevel=OutstandingEXcelReport&&Flag=A">
