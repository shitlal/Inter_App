...
<% session.setAttribute("CurrentPage","sectorWiseReportDetails1.do?method=sectorWiseReportDetails1");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="sectorWiseReportDetails1.do?method=sectorWiseReportDetails1" method="POST" enctype="multipart/form-data">
		<TR> 
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="31%" class="Heading"><bean:message key="sectorWiseHeader" /></TD>
								...
								<TR align="left" valign="top">
									...
									<tr>
									<logic:iterate id="object" name="rsForm" property="sectorReport">
									<%
