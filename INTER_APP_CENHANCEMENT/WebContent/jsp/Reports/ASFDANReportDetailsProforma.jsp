...
<% session.setAttribute("CurrentPage","asfdanReportDetailsProforma.do?method=asfdanReportDetailsProforma");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfdanReportDetailsProforma.do?method=asfdanReportDetailsProforma" method="POST"
					...
					<TR>
						...
						<table>
								...
								<TR>
									<TD colspan="21">
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                                ...
                                                                                <% if("AF".equalsIgnoreCase(danType)||"SF".equalsIgnoreCase(danType))
                            {
                            %>
                            <tr id="invoice" >
                               <td colspan="6"  align="center"><u>Proforma Invoice</u></td>
                            ...
                            <% }%>
											...
											<tr>
												<td align="left" colspan="6" >&nbsp; <h6><font class="fontsized">Proforma Invoice No:
											...
											%>
												...
												<TD align="left" valign="top">
													<h6><font class="fontsized">Date:<%=date%></font></h6>
												</TD>
											</tr>
											...
											<TR>
												<TD align="left" valign="top" colspan="6"><font class="fontsized"><h6>Address of Principal :<%=danDetails.getBankaddress()%></h6></font>
...
<%}
								...
								<% if(danType.equalsIgnoreCase("AF")||danType.equalsIgnoreCase("SF")) 
                                                                {  %>
    ...
    `                                                                       </TD>
										...
										<div align="right"><%=dec.format(dReport.getSgstAmt())%></div>
									      ...
									      <TD width="10%" align="left" valign="top"	class="ColumnBackground1">
                                                                ...
                                                                <% if(danType.equalsIgnoreCase("RS")) 
                                                                {  %>
                                                                <tr>
								...
								<TR>
									<TD>
										...
										<tr>
                                          ...
                                          **Only in case,SSI already covered under CGTMSE in previous periods.
                                          </h6>
                                          </TD> 
										</tr>
											...
											<TR>
												...
												<TD align="left" colspan="4" valign="top" ><h6>
                                                                                                    Term And Conditions:-
                                                                                                    <br>
                                                                                                   1)	Guarantee Cover shall commence or be renewed from the date of receipt of guarantee fees together with applicable taxes indicated herein above.
                                                                                                    <br>
                                                                                                   2)	No Input Tax Credit can be claimed on the basis of this Proforma Invoice.  A final invoice will be issued in accordance with the provisions of Tax Invoice Rules as notified by CG and Input Tax Credit can be claimed only on the basis of the final invoice.
                                                                                                    <br>
                                                                                                    3)	Tax mentioned above is based on the tax rates prevalent on the date of this Proforma Invoice.  The actual Tax could vary based on the rates prevalent at the time of receipt of the guarantee fees or raising of the invoice, whichever is earlier.  
                                                                                                    <br>
                                                                                                    4)	For guarantee covers seeking renewal, the payment should be made by the end date of existing guarantee cover.
                                                                                                    <br>
                                                                                                    5)	The Courts in Mumbai shall have exclusive jurisdiction in respect of any dispute arising in connection the above matter.
                                                                                                    <br>
											...
											<TR>
                                                                                        ...
                                                                                        <TR>
                                                                                                                     <td align="left" colspan="4" valign="top" class="ColumnBackground"><div
														align="left">&nbsp;***This is computer genereted advice and does not need signature.*******</div></TD>
                                                                                        </TR>
										</TABLE>
									</TD>
								</TR>
