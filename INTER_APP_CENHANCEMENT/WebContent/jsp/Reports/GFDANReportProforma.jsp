 ...
 %>
                   ...
                   <%=branchName%> 
                       ...
                       <TD width="10%" align="left" valign="top" class="ColumnBackground1">
											...
											String url = "danReportDetailsProforma.do?method=danReportDetailsProforma&danValue="+danId+"&bankName="+bank+"&zoneName="+zone+"&branchName="+branch+"&bName="+branchName+"&date="+formatedDate+"&memid="+memid;%>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
								<A href="javascript:submitForm('gfdanReportInputProforma.do?method=gfdanReportInputProforma')">
