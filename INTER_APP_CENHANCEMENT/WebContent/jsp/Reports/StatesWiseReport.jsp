...
<% session.setAttribute("CurrentPage","statesWiseReport.do?method=statesWiseReport");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="statesWiseReport.do?method=statesWiseReport" method="POST" enctype="multipart/form-data">
		<TR> 
						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left" valign="top">
									...
									<logic:iterate id="object" name="rsForm" property="statesWiseReport">
									<%
