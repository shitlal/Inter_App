...
<% session.setAttribute("CurrentPage","cgpanHistoryReport.do?method=cgpanHistoryReport");%>
								...
								<TR>
									...
									<TD align="left" valign="top" class="ColumnBackground">
									 ...
									 <TD align="left" valign="center" class="TableData">
										 <html:text property="appRefNo" size="20"  alt="Cgpan" maxlength="12" name="rsForm"/>  
									  </TD>
									  </TR>				
