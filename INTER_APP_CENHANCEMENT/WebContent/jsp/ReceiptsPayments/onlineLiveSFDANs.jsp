...
<% session.setAttribute("CurrentPage","asfPaymentThroughNeftRtgs.do?method=getOnlineSFDANsLive");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	
	<html:form action="asfPaymentThroughNeftRtgs.do?method=getOnlineSFDANsLive" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">								
								<A href="javascript:submitForm('asfPaymentThroughNeftRtgs.do?method=getOnlineSFDANsLive')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>					
				</TABLE>
