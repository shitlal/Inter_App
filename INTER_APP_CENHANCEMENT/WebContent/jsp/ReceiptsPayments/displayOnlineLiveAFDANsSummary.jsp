...
String thiskey = "";
session.setAttribute("CurrentPage","asfPaymentThroughNeftRtgs.do?method=allocategetLiveAFDANsPaymentDetails");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="asfPaymentThroughNeftRtgs.do?method=allocategetLiveAFDANsPaymentDetails"  method="POST" >
		<TR> 
		...
		<TR>
		 ...
		 <!-- 			<TD align="left" valign="top" class="ColumnBackground">
                ...
                <TD align="left" valign="top" class="ColumnBackground">
					 ...
					 <TD align="left" valign="top" class="ColumnBackground">
						Included S & H Ecess
									...
									<TD 	class="ColumnBackground" align="center">For select max.200 at a time
									<html:checkbox property="selectAll" alt="Close" name="rpAllocationForm" onclick="raju(this,1)"/>							
				...
				<TR>
					...
					<DIV align="center">
					<a href="javascript:submitForm('asfPaymentThroughNeftRtgs.do?method=allocategetLiveAFDANsPaymentDetails');">
