...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="asfPaymentThroughNeftRtgs.do?method=allocategetLiveASFDANsPaymentDetails" method="POST" >
	<TR> 
		...
		<TR>
		 ...
		 <!-- 			<TD align="left" valign="top" class="ColumnBackground">
				...
				<TR>
					...
					<DIV align="center">
					<a href="javascript:submitForm('asfPaymentThroughNeftRtgs.do?method=allocategetLiveASFDANsPaymentDetails');">
