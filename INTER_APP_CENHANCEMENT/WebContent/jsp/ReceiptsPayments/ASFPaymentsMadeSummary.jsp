...
<% session.setAttribute("CurrentPage","asfappropriatePayments.do?method=getPaymentsMadeForASF");%>
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="asfappropriatePayments.do" method="POST" enctype="multipart/form-data">
									...
									<%} else {%>
										...
										com.cgtsi.receiptspayments.PaymentList paymentList =(com.cgtsi.receiptspayments.PaymentList)object;%>
											<TR>
												...
												<TD align="left" valign="top" class="tableData">
													<a href="javascript:setHiddenFieldValue('paymentId', '<%=paymentList.getPaymentId()%>', 'asfappropriatePayments.do?method=getPaymentDetailsForASF');">
