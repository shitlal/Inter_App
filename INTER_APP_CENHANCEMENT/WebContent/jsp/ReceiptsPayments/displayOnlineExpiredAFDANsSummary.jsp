...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="asfPaymentThroughNeftRtgs.do?method=allocategetExpiredAFDANsPaymentDetails" method="POST" >
		...
		<TR>
		 ...
		 <!-- 			<TD align="left" valign="top" class="ColumnBackground">
                ...
                <TD align="left" valign="top" class="ColumnBackground">
					...
					<TD 	class="ColumnBackground" align="center"> select max.200 at a time
				...
				<TR>
					...
					<DIV align="center">
					<a href="javascript:submitForm('asfPaymentThroughNeftRtgs.do?method=allocategetExpiredAFDANsPaymentDetails');">
