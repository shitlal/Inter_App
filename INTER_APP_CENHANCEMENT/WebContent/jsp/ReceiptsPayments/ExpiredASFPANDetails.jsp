...
<%session.setAttribute("CurrentPage","expiredasfallocatePayments.do?method=getExpiredASFPANDetails");
String name;
int i = 0;
String fDisbDate;
...
<body>
	...
	<html:form name="rpAllocationForm" type="org.apache.struts.validator.DynaValidatorActionForm" action="submitExpiredASFPANPayments.do?method=submitExpiredASFPANPayments" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
...
<!--								<TD align="left" valign="top" class="TableData">
						...
						<TR>
							<TD align="center" valign="baseline" colspan="8">
								<DIV align="center">
									<A href="javascript:submitForm('submitExpiredASFPANPayments.do?method=submitExpiredASFPANPayments')">
