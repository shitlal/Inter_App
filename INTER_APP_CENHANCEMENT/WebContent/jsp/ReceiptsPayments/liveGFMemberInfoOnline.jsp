...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="allocatePaymentsAll.do?method=getPendingGFDANsLiveOnline" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">								
								<A href="javascript:submitallocatepayment('allocatePaymentsAll.do?method=getPendingGFDANsLiveOnline')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>
