...
<%session.setAttribute("CurrentPage","gfallocatePayments.do?method=getGFPANDetails");
String name;
int i = 0;
String fDisbDate;
...
<body>
	...
	<html:form name="rpAllocationForm" type="org.apache.struts.validator.DynaValidatorActionForm" action="submitGFPANPayments.do?method=submitGFPANPayments" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
...
<!--								<TD align="left" valign="top" class="TableData">
						...
						<TR>
							<TD align="center" valign="baseline" colspan="8">
								<DIV align="center">
									<A href="javascript:submitForm('submitGFPANPayments.do?method=submitGFPANPayments')">
