...
<%session.setAttribute("CurrentPage","claimappropriatePayments.do?method=getPaymentDetailsForCLAIM");%>
...
%>
	...
	<html:form name="rpAllocationForm" type="org.apache.struts.validator.DynaValidatorActionForm" action="afterAppropriatePaymentsForASF.do?method=appropriatePaymentsForASF" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
...
--%>
				<TR>
					...
					<DIV align="center">
					<A href="javascript:setChkHiddenValue('<%=(index-1)%>','appropriatedFlags', 'appropriatedFlags','afterAppropriatePaymentsForCLAIM.do?method=appropriatePaymentsForASF','Y', 'N');">
...
<%--								<TR>
										<TD align="center" valign="baseline" colspan="10">
											<DIV align="center">
						<A href="javascript:setChkHiddenValue('<%=(index-1)%>','appropriatedFlags', 'appropriatedFlags','afterAppropriatePaymentsForASF.do?method=appropriatePaymentsForASF','Y', 'N');">
