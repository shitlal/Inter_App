...
String thiskey = "";
session.setAttribute("CurrentPage","asfPaymentThroughNeftRtgs.do?method=allocategetExpiredASFDANsPaymentDetails");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="asfPaymentThroughNeftRtgs.do?method=allocategetExpiredASFDANsPaymentDetails" method="POST" >
		...
		<TR>
		 ...
		 <!-- 			<TD align="left" valign="top" class="ColumnBackground">
                ...
                <TD align="left" valign="top" class="ColumnBackground">
					...
					<TD 	class="ColumnBackground" align="center">Select All
				...
				<TR>
					...
					<DIV align="center">
					<a href="javascript:submitForm('asfPaymentThroughNeftRtgs.do?method=allocategetExpiredASFDANsPaymentDetails');">
