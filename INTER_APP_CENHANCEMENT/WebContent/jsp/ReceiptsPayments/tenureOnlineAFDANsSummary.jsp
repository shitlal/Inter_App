...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	...
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="tenurePaymentThroughNeftRtgs.do?method=getTenureAFDANsPaymentDetailsOnline" method="POST" >
		<TR> 
				...
				<TR>
					...
					<DIV align="center">
						<!--<A href="javascript:if(checkbox_checker()) submitForm('danPaymentDetails.do?method=getLiveGFDANsPaymentDetailsOnline');">	-->
						 <a href="javascript:submitForm('tenurePaymentThroughNeftRtgs.do?method=getTenureAFDANsPaymentDetailsOnline');">
