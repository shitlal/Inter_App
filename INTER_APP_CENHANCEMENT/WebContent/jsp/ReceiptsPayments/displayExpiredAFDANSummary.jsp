...
String thiskey = "";
	session.setAttribute("CurrentPage","allocatePaymentsAll.do?method=getPendingAFDANsExpired");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="danPaymentDetails.do?method=getExpiredAFDANsPaymentDetails" method="POST" >
		<TR> 
		...
		<TR>
			...
			<TD>
				...
				<TR>
					...
					<DIV align="center">
						<A href="javascript:if(checkbox_checker()) submitForm('danPaymentDetails.do?method=getExpiredAFDANsPaymentDetails');">
