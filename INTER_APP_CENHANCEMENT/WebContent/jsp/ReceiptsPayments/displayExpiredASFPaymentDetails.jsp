...
<% session.setAttribute("CurrentPage","danPaymentDetails.do?method=getExpiredASFDANsPaymentDetails");
String danNo ;
int danIndex = 0;
...
<script>
	function savePaymentDetails(){
		...
		document.forms[0].action = "submitASFDANsPaymentDetails.do?method=submitASFDANsPaymentDetails";
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <html:errors />
<html:form action="submitASFDANsPaymentDetails.do?method=submitASFDANsPaymentDetails" method="POST" focus="modeOfPayment">
        ...
        <tr align="center" valign="baseline">
          <td>
			<!-- <a href="javascript:submitForm('danPaymentDetails.do?method=submitASFDANsPaymentDetails');"> -->
