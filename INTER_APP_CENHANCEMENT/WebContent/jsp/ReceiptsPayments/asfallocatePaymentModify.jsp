...
<% session.setAttribute("CurrentPage","asfdisplayallocatePaymentModifySubmit.do?method=asfdisplayallocatePaymentModifySubmit");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>
<body onload="disableBackButton()">

	<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
    <html:errors />
		<html:form action="asfdisplayallocatePaymentModifySubmit.do?method=asfdisplayallocatePaymentModifySubmit" method="POST" >
			<TR> 
...
%>
             ...
             <TD width="10%" align="left" valign="top" class="ColumnBackground1"><div align="center"><%=Integer.parseInt(index+"")+1%></div></TD>
              ...
              <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center">
                  <%
                    ...
                    String url = "asfdisplayPaymentIdDetail.do?method=asfdisplayPaymentIdDetail&PaymentId="+PaymentId;%>
   ...
   <tr align="center" valign="baseline">
           		 <td colspan="4"> 
           		 <div align="center"> 
		         <a href="javascript:submitForm('asfdisplayallocatePaymentModifySubmitDetails.do?method=asfdisplayallocatePaymentModifySubmitDetails')"><IMG src="images/Submit.gif" alt="Save" width="49" height="37" border="0"></a>
