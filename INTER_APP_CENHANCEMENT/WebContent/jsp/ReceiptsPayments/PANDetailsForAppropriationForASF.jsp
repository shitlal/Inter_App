...
<%session.setAttribute("CurrentPage","asfappropriatePayments.do?method=getPaymentDetailsForASF");%>
											...
											<%}%>
												...
												<TR>
										            ...
										            <TD class="tableData">
														...
														<IMG src="images/CalendarIcon.gif" width="20" onClick="showCalendar('rpAllocationForm.dateOfRealisation')" align="middle">
													</TD>
