...
<% session.setAttribute("CurrentPage","expiredasfallocatePayments.do?method=submitExpiredASFDANPayments");
String danNo ;
int danIndex = 0;
...
function chkDate(){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <html:errors />
<html:form action="expiredasfallocatePayments.do?method=expiredasfallocatePayments" method="POST" focus="modeOfPayment">
        ...
        <tr align="center" valign="baseline">
          <td>
			<a href="javascript:submitForm('expiredasfallocatePayments.do?method=expiredasfallocatePayments');"><img src="images/Save.gif" alt="Save"
