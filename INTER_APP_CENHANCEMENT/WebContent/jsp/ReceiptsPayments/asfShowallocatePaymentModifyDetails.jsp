...
<% session.setAttribute("CurrentPage","asfdisplayPaymentIdDetail.do?method=asfdisplayPaymentIdDetail");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>

	<TABLE width="725" border="0" cellpadding="0" cellspacing="0">

    <html:errors />
		<html:form action="asfdisplayPaymentIdDetail.do?method=asfdisplayPaymentIdDetail" method="POST" >
			<TR> 
...
%>
            ...
            <html:checkbox name="rpAllocationForm" property="<%=name%>" onclick="<%=jsMethodDef%>" value="<%=name%>"/></div>
               ...
               <tr align="center" valign="baseline">
		         ...
		         --><a href="javascript:submitForm('asfsubmitDanWiseDeallocation.do?method=asfsubmitDanWiseDeallocation')"><img src="images/Save.gif"  alt="Save" width="49" height="37" border="0"></a>
