...
<% session.setAttribute("CurrentPage","tenurePaymentThroughNeftRtgs.do?method=getOnlineTenureCasesAF");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>

<script type="text/javascript">

function submitallocatepayment(action)
{
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="tenurePaymentThroughNeftRtgs.do?method=getOnlineTenureCasesAF" method="POST" focus="selectMember">
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR>
						<TD align="center" valign="baseline">
							<DIV align="center">								
								<A href="javascript:submitallocatepayment('tenurePaymentThroughNeftRtgs.do?method=getOnlineTenureCasesAF')"><IMG src="images/OK.gif" alt="OK" width="49" height="37" border="0"></A>								
							</DIV>
						</TD>
					</TR>
