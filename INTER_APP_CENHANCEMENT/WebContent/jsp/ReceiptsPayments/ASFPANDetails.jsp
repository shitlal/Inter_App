...
<%session.setAttribute("CurrentPage","asfallocatePayments.do?method=getASFPANDetails");
String name;
int i = 0;
String fDisbDate;
...
<!--								<TD align="left" valign="top" class="TableData">
						...
						<TR>
							<TD align="center" valign="baseline" colspan="8">
								<DIV align="center">
									<A href="javascript:submitForm('submitASFPANPayments.do?method=submitASFPANPayments')">
