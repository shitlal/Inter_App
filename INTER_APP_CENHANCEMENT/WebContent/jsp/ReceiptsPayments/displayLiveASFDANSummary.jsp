...
String thiskey = "";
	session.setAttribute("CurrentPage","allocatePaymentsAll.do?method=getPendingASFDANsLive");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="danPaymentDetails.do?method=getLiveASFDANsPaymentDetails" method="POST" >
		<TR> 
		...
		<TR>
		 ...
		 <!-- 			<TD align="left" valign="top" class="ColumnBackground">
				...
				<TR>
					...
					<DIV align="center">
						<A href="javascript:if(checkbox_checker()) submitForm('danPaymentDetails.do?method=getLiveASFDANsPaymentDetails');">
