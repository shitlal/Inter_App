...
<%
	session.setAttribute("CurrentPage","allocatePayments.do?method=getPendingDANs");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="allocatePayments.do?method=submitDANPayments" method="POST" >
		<TR> 
			...
			<TD>
				...
				<TR>
					...
					<TD align="left" valign="top" class="tableData">
							<a href="javascript:setHiddenFieldValue('danNo', '<%=danNo%>', 'allocatePayments.do?method=getPANDetails');">
						<%=danNo%>
						<%name="danIds(key-"+i+")";%>
				...
				<TR>
					...
					<DIV align="center">
                                   ...
                                   <A onclick ="" href="javascript:if(checkbox_checker()) submitForm('allocatePayments.do?method=submitDANPayments')">
          		                               <IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>

				<!-- <A href="javascript:submitForm('allocatePayments.do?method=submitDANPayments')">
							<IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A> -->
