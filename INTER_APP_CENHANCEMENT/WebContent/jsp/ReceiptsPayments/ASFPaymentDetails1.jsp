...
<% session.setAttribute("CurrentPage","asfallocatePayments.do?method=submitASFDANPayments");
String danNo ;
int danIndex = 0;
...
function chkDate(){
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <html:errors />
<html:form action="asfallocatePayments.do?method=asfallocatePayments" method="POST" focus="modeOfPayment">
        ...
        <tr>
		  ...
		  <tr>
            ...
            <tr>
              <TD align="left" valign="top" class="ColumnBackground">&nbsp;<span id="instdate" name="instdate">&nbsp;&nbsp;<font color="#FF0000" size="2">*</font>&nbsp;<bean:message key="paymentDate"/></span>&nbsp;&nbsp;<i>(Date should be in DD/MM/YYYY format.)</td>
              <td class="tableData"><table cellpadding="0" cellspacing="0">
                <tr>
                  <td><html:text property="paymentDate" size="20" alt="Payment Date" name="rpAllocationForm" maxlength="10" onchange="chkDate();"/></td>
            ...
            <tr>
              ...
              <td class="tableData"><html:text property="instrumentNo" size="20" alt="Instrument Number" name="rpAllocationForm" maxlength="6" onkeypress="return numbersOnly(this, event)" /></td>
            </tr>
            <tr>
              <TD align="left" valign="top" class="ColumnBackground">&nbsp;<span id="instdate" name="instdate">&nbsp;&nbsp;<font color="#FF0000" size="2">*</font>&nbsp;<bean:message key="instrumentDate"/></span>&nbsp;&nbsp;<i>(Date should be in DD/MM/YYYY format.)</td>
              <td class="tableData"><table cellpadding="0" cellspacing="0">
                <tr>
        ...
        <TR >
					...
					<TR >
                                                ...
                                                <td align="left" valign="top" class="ColumnBackground"><div align="leftt">&nbsp;Service Tax Number:</div></td>
						
						<TD align="left" valign="top" class="ColumnBackground"><div align="leftt">&nbsp;AAATC2613DSD001</div></td>
						
						<td align="left" valign="top" class="ColumnBackground"><div align="leftt">&nbsp;PAN Number:</div></td>
        ...
        <tr align="center" valign="baseline">
          <td>
			<a href="javascript:submitForm('asfallocatePayments.do?method=asfallocatePayments');"><img src="images/Save.gif" alt="Save"
