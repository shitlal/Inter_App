...
** Payment Initiated Successfully For following RP's. Please use Virtual A/C No, Amount & IFSC Code for making payments for respective Pay Ids.
  ...
  <body onload="disableBackButton()">
    ...
    <html:errors />
		...
		<html:form name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm"  action="tenuredisplayallocatePaymentFinal.do?method=tenuredisplayallocatePaymentFinal" method="POST" >
		   ...
		   <TD width="15%" align="left" valign="top" class="ColumnBackground1"><div align="center">CORP0000633</div></TD>			                
              ...
              <tr align="center" valign="baseline">
		         ...
		         <a href="home.do?method=getMainMenu&menuIcon=<%=session.getAttribute("menuIcon")%>"><img src="images/OK.gif" width="40" height="37" border="0"></a>
		          ...
		          <a href="javascript:submitForm('displayallocatePaymentFinalSubmit.do?method=exportExcelNew&fileType=xls');">Export To Excel</a>
		          <a href="javascript:submitForm('displayallocatePaymentFinalSubmit.do?method=exportCsvNew&fileType=csv');">Export To Csv</a>
              </div>
		      </td>
