...
<%
String thiskey = "";
	session.setAttribute("CurrentPage","gfallocatePayments.do?method=getPendingGFDANsFilterNew");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="gfallocatePayments.do?method=submitNEFTGFDANPayments" method="POST" >
		<TR> 
...
<% 
				...
				%>
					...
					<TR >
                        ...
                        <td valign="top" class="ColumnBackground" colspan="3"><div align="center">&nbsp;Service Tax Number:</div></td>
						
						<TD valign="top" class="ColumnBackground" colspan="5"><div align="leftt">&nbsp;AAATC2613DSD001</div></td>
						
						<td valign="top" class="ColumnBackground" colspan="3"><div align="center">&nbsp;PAN Number:</div></td>
										
						<td valign="top" class="ColumnBackground" colspan="5"><div align="leftt">&nbsp;AAATC2613D</div></TD>
						
					</TR>
				<TR>
					<TD align="center" valign="baseline" colspan="10">
					<DIV align="center">
			<!--	 	<A href="javascript:submitForm('gfallocatePayments.do?method=submitGFDANPayments')">
							<IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A> -->
              <A onclick ="" href="javascript:if(checkbox_checker()) submitForm('gfallocatePayments.do?method=submitNEFTGFDANPayments')"> 
          		  <IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A> 
