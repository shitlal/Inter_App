...
<%
	session.setAttribute("CurrentPage","asfallocatePayments.do?method=getPendingASFDANs");
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="asfallocatePayments.do?method=submitASFDANPayments" method="POST" >
		<TR> 
			...
			<TD>
				...
				<TR>
					...
					<TD align="left" valign="top" class="tableData">
							<a href="javascript:setHiddenFieldValue('danNo', '<%=danNo%>', 'asfallocatePayments.do?method=getASFPANDetails');">
						<%=danNo%></a>
						<%name="danIds(key-"+i+")";%>
				...
				<TR>
					...
					<DIV align="center">
				 	<A href="javascript:submitForm('asfallocatePayments.do?method=submitASFDANPayments')">
							<IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A> 
             <!-- <A onclick ="" href="javascript:if(checkbox_checker()) submitForm('asfallocatePayments.do?method=submitASFDANPayments')">
          		  <IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A> -->
