...
<% session.setAttribute("CurrentPage","allocatePayments.do?method=submitDANPayments");
String danNo ;
int danIndex = 0;
...
return true;
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <html:errors />
<html:form action="allocatePayments.do?method=allocatePayments" method="POST" focus="modeOfPayment">
        ...
        <tr align="center" valign="baseline">
          <td>
			<a href="javascript:submitForm('allocatePayments.do?method=allocatePayments');"><img src="images/Save.gif" alt="Save"
