...
<% session.setAttribute("CurrentPage","gfbatchappropriatePayments.do?method=gfbatchappropriatePayments");%>
<%
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="gfbatchappropriatePayments.do?method=aftergfbatchappropriatePayments" method="POST" enctype="multipart/form-data">
		...
		<TR>
          ...
          <A href="javascript:submitForm('gfbatchappropriatePayments.do?method=aftergfbatchappropriatePayments')">
