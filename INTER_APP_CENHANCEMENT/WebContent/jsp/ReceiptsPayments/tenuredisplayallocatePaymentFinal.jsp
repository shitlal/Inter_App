...
<% session.setAttribute("CurrentPage","tenuredisplayallocatePaymentFinal.do?method=tenuredisplayallocatePaymentFinal");%>
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                  ...
                  <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>Vitrual Account No.</strong></div></td>
                     ...
                     <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>PayID Created Date
                      ...
                      </strong><input type="checkbox" name="selectAll" value="on" 

onclick="selectDeselect(this,1)" alt="Close"> <br></div></td>
...
Total
              ...
              <tr align="center" valign="baseline">
           		 <td colspan="4"> 
           		 <div align="center"> 
		         <A href="javascript:submitFinalMakePayment('tenuredisplayallocatePaymentFinalSubmit.do?method=tenuredisplayallocatePaymentFinalSubmit')"><IMG src="images/Next.gif" alt="Next" width="49" height="37" border="0"></A>
...
<br/>
<div>
<input type="button" id="trap" value="OK" class="bouton" onclick="makePaymentOK('tenuredisplayallocatePaymentFinalSubmit.do?method=tenuredisplayallocatePaymentFinalSubmit');" style="left:0px;"/>
