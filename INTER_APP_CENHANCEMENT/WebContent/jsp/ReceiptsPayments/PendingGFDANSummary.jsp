...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="gfallocatePayments.do?method=submitGFDANPayments" method="POST" >
		<TR> 
		...
		<TR>
			...
			<TD>
				...
				%>
				<TR>
					<TD align="left" valign="top" class="tableData"><%=(i+1)%>
					</TD>
          ...
          <%=danSummary.getBranchName()%>
					...
					<TD align="left" valign="top" class="tableData">
					 ...
					 <TD align="left" valign="top" class="tableData">
                       ...
                       <TD align="left" valign="top" class="tableData">
						<%=df.format(danSummary.getKrishiKalCess())%>
					</TD> 
...
<% 
               ...
               <A onclick ="" href="javascript:if(checkbox_checker()) submitForm('gfallocatePayments.do?method=submitGFDANPayments')">
          		  <IMG src="images/Save.gif" alt="Save" width="49" height="37" border="0"></A>
