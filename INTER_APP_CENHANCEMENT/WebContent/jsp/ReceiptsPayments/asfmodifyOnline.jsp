						...
						<TD>
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
                                    ...
                                    <option value="AFLIV" >Modify For Live AF DANs</option>
                                    <option value="AFEXP">Modify For Expired AF DANs</option>
                                    <option value="SFLIV">Modify For Live SF DANs</option>
                                    <option value="SFEXP">Modify For Expired SF DANs</option>
</select>
									  </TD>
