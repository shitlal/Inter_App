...
<TABLE width="100%" border="0" cellspacing="1" cellpadding="0">
	...
	<TR align="left">
		<TD align="left" valign="top" class="ColumnBackground">IFSC Code/<bean:message
				key="branchCode" /></td>
		<TD align="left" valign="top" class="tableData">
			<%
										if ((appCommonFlag.equals("1")) || (appCommonFlag.equals("11"))
...
<table width="100%" cellspacing="1" cellpadding="0">
	...
	<tr align="left">
		<td class="ColumnBackground" width="25%" style="background-color: #C4DEE6;"><font color="#FF0000" size="2">*</font>&nbsp;<bean:message
		...
		<td class="ColumnBackground"  width="25%"> &nbsp;<div class="dkrtooltip"><font color="#FF0000" size="1">#</font>&nbsp;<bean:message
				key="thirdPartyTaken" /><span class="dkrtooltiptext"><bean:message	key="thirdPartyTooltipTxt" /></span></div>
		</td>
		<td align="left" valign="middle" class="TableData" width="25%">
			<%
										 	if (appCommonFlag.equals("11") || appCommonFlag.equals("12")
	...
	<tr align="left">
		<td colspan="4" align="left" class="ColumnBackground"><b><font
				color="#FF0000" style="font-size:14px;">Handicrafts</font></b></td>
	</tr>
	<TR>
		<TD align="left" valign="top" class="ColumnBackground" colspan="2"><font
			color="#FF0000" size="2">*</font>&nbsp;Whether the credit is
	...
	<tr align="left">
		<td class="ColumnBackground" colspan="4"><font color="#FF0000"
			size="2">*&nbsp;</font> <font color="#008600" style="font-size:12px;"><b>Credit
				...
				<tr>
					...
					<td class="TableData" width="20%" align="left" valign="top"
						...
						<%
												...
												%> <html:text property="expiryDate" styleId="expiryDate" size="20"
