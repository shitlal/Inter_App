				...
				<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
					...
					<TR align="left">
					 ...
					 <TR align="left">
						...
						<TD align="left" class="TableData" colspan="4"> 
							<html:radio name="gmForm" value="Y" property="npa" disabled="true" ><bean:message key="yes" /></html:radio>&nbsp;&nbsp;<html:radio name="gmForm" value="N" property="npa" disabled="true"><bean:message key="no"/></html:radio>
						</TD>								
					</TR>
							...
							<TABLE width="100%" border="0" cellpadding="1" cellspacing="1">
								 ...
								 <TR align="left">
									...
									<TD align="left" valign="top" class="TableData" colspan="5">
										<html:select property="constitution" disabled="true" name="gmForm">
								 ...
								 <TR align="left">
									...
									<TD align="left" valign="top" class="TableData">
										<html:select property="ssiType" name="gmForm" disabled="true">
										<html:option value="">Select</html:option>
										...
										<html:text property="ssiName" size="20" alt="unitName" name="gmForm" maxlength="100" disabled="true"/>	
									 </td>
...
--%>
     							 ...
     							 <TR align="left">
									...
									<TR align="left">											
										...
										<TD align="left" valign="top" class="TableData" width="30%">
											<html:textarea property="address" cols="20" alt="address" name="gmForm" disabled="true"/>						
										</td>
										<TD align="left" valign="top" class="ColumnBackground" width="25%"><font color="#FF0000" size="2">*</font><bean:message key="state"/>
										</TD>												
										<TD align="left" valign="top" class="TableData" width="15%">
											<html:select property="state" disabled="true" name="gmForm" onchange="javascript:submitForm('getDistrictValues.do?method=getDistricts')">
											<html:option value="">Select</html:option>
									 ...
									 <TR align="left">
										...
										<TD align="left" valign="top" class="TableData" >
										<html:select property="district" disabled="true" name="gmForm" onchange="javascript:enableDistrictOthers()">
										<html:option value="">Select</html:option>
						...
						<TR align="left">
							...
							<TD align="left" valign="top" class="TableData">
								<html:select property="cpTitle" name="gmForm" onchange="enableGender()" disabled="true">
										<html:option value="">Select</html:option>
							...
							<TD align="left" valign="top" class="TableData">
								<html:text property="cpFirstName" size="20" alt="firstName" name="gmForm" maxlength="20" disabled="true"/>	
							</TD>
							<TD align="left" valign="top" class="TableData">
								<html:text property="cpMiddleName" size="20" alt="middleName" name="gmForm" maxlength="20" disabled="true"/>	
							</TD>
							<TD align="left" valign="top" class="TableData">
								<html:text property="cpLastName" size="20" alt="lastName" name="gmForm" maxlength="20" disabled="true"/>	
							</TD>
						</TR>
						...
						<TR align="left">
							...
							<TD align="left" valign="top" class="TableData" colspan="2">
								<html:text property="cpITPAN" size="20" alt="chiefItpan" name="gmForm" maxlength="10" disabled="true"/>
							</TD>													
						</TR>
