...
<html:errors />
<html:form action="updateOutstandingDetailsEntry.do?method=updateOutstandingDetailsEntry" method="POST" enctype="multipart/form-data">
...
<td><table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr align="center" valign="baseline">
    <td colspan="4"> 
    <div align="center">
    <a href="getcgpanForOutstandingUpdate.do?method=getcgpanForOutstandingUpdate"><img src="images/OK.gif" width="49" height="37" border="0"></a></div></td>
  </tr>
</table></td>
