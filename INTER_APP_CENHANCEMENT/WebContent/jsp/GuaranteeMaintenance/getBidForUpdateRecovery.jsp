...
<% session.setAttribute("CurrentPage","getBorrowerIdForUpdateRecovery.do?method=getBorrowerIdForUpdateRecovery");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="modifyRecoveryDetails.do?method=modifyRecoveryDetails" method="POST" focus="<%=focusField%>">
		<TR>
		...
		<TR>
			...
			<TD>
			<DIV align="right">
				<A HREF="javascript:submitForm('helpRecoveryDetailsFilter.do?method=helpRecoveryDetailsFilter')">
			    HELP</A>
			</DIV>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('modifyRecoveryDetails.do?method=modifyRecoveryDetails')">
