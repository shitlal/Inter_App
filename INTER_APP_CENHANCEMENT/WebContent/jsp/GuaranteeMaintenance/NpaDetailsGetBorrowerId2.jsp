...
<% session.setAttribute("CurrentPage","NpaDetailsGetBorrowerId1.do?method=NpaDetailsGetBorrowerId1");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showNPADetails1.do?method=showNPADetails1" method="POST" focus="<%=focusField%>">
		<TR>
		...
		<TR>
			...
			<TD>
			<DIV align="right">
				<A HREF="javascript:submitForm('helpNpaDetailsFilter.do?method=helpNpaDetailsFilter')">
			    HELP</A>
			</DIV>
					...
					<TR>
						...
						<TR align="left" valign="top">
									<TD align="left" valign="top" 								  class="ColumnBackground">CGPAN</TD>
										<TD align="left" valign="top" class="TableData" colspan="4">
										<html:text property="cgpan" size="30" alt="osAmtOnNPA" name="gmPeriodicInfoForm"/>
										</TD>
								</TR>
							   
								<TR align="left" valign="top">
									<TD align="left" valign="top" 								  class="ColumnBackground">NPA OUT STANDING AMT</TD>
										<TD align="left" valign="top" class="TableData" colspan="4">
										<html:text property="osAmtOnNPA" size="30" alt="osAmtOnNPA" name="gmPeriodicInfoForm"/>
										</TD>
								</TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showNPADetails2.do?method=showNPADetails2')">
