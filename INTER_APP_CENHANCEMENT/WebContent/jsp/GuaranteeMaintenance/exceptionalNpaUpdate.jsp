...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="exceptionalNpaUpdate.do?method=exceptionalNpaUpdate" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
		<TR> 
			...
			<TD  align="left" colspan="4"><font size="2"><bold>
             ...
             <logic:equal property="bankId" value="0000" name="gmPeriodicInfoForm">		
              ...
              <TR>                								
								...
								<TR align="left" valign="top">
									<TD align="left" valign="top"   class="ColumnBackground"><font color="#FF0000" size="2">*</font>Reasons&nbsp;
									</TD>
									<TD align="left" valign="top" class="TableData" colspan="4">
              <!--    <html:textarea cols="20" rows="2" property="closureRemarks"   name="gmPeriodicInfoForm" >  </html:textarea> -->
								<html:text property="remarks"  size="100" alt="closure Remarks" name="gmPeriodicInfoForm"/>
						      </TD>
								</TR> 
