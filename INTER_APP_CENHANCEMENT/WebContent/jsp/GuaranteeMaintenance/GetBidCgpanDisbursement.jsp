...
<% session.setAttribute("CurrentPage","GetBidCgpanDisbursement.do?method=GetBidCgpanDisbursement");%>
...
<%focusField = "borrowerId";%>
	...
	<html:errors />
	<html:form action="showDisbursementDetails.do?method=showDisbursementDetails" method="POST" focus="<%=focusField%>">
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
		...
		<TR>
			...
			<TD>
			<DIV align="right">
				<A HREF="javascript:submitForm('helpDisbursementDetailsFilter.do?method=helpDisbursementDetailsFilter')">
			    HELP</A>
			</DIV>
						 ...
						 <logic:equal property="periodicBankId" value="0000" name="gmPeriodicInfoForm">
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData" colspan="4">
										<html:text property="memberId" size="20" alt="MemberID" maxlength ="12" name="gmPeriodicInfoForm"/>
									</TD>
								</TR>
						</logic:equal>
						 <logic:notEqual property="periodicBankId" value="0000" name="gmPeriodicInfoForm">
						 		<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData" colspan="4">
									   ...
									   <TR align="left" valign="top">
											...
											<TD align="left" valign="top" class="TableData">
												 <html:text property="cgpan" size="20" alt="CGPAN" maxlength ="15"  name="gmPeriodicInfoForm"/>
											</TD>
										</TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showDisbursementDetails.do?method=showDisbursementDetails')">
