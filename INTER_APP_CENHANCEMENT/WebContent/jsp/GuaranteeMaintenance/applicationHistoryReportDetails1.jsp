...
<% session.setAttribute("CurrentPage","applicationHistoryReport.do?method=applicationHistoryReport");%>
RRRRRRRRRRRR---
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="getcgpanForOutstandingUpdate.do?method=getcgpanForOutstandingUpdate" method="POST" enctype="multipart/form-data">
		<TR> 
				...
				<TABLE width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
							<A href="javascript:submitForm('getcgpanForOutstandingUpdate.do?method=getcgpanForOutstandingUpdate')">
