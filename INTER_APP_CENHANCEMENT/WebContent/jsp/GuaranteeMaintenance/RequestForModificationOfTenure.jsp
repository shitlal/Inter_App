...
<% //session.setAttribute("CurrentPage","requestModifyTenure.do?method=requestModifyTenure");
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	...
	<html:form action="getUnitForTenureRequest.do?method=getUnitForTenureRequest" method="POST" enctype="multipart/form-data" >
	...
	<!--			<A HREF="javascript:submitForm('helpClosureDetailsFilter.do?method=helpClosureDetailsFilter')">
			...
			<TD  align="left" colspan="4"><font size="2"><bold>
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory for Modification of Tenure Request</bold></font>
			</td>
		</tr>
							<TR>
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData">
										<html:text property="memberIdForClosure"    size="25" alt="MemberID"   onkeypress="return numbersOnly(this, event)"    maxlength ="12" name="gmClosureForm"/>
									</TD>
                  <TD align="left" valign="top" class="ColumnBackground"><font color="#FF0000" size="2">*</font><bean:message key="cgpan"/>
									</TD>
									<TD align="left" valign="top" class="TableData">
									 <html:text property="cgpanForClosure" size="25"  alt="CGPAN" name="gmClosureForm"  maxlength ="15" />
									</TD> 
								</TR>
					...
					<TR >
 					...
 					<td align="left"><div id="errorsMessage" class="errorsMessage"></div>  </td>
						<TD height="20" >
							&nbsp;
						</TD> 
					</TR>
...
<A href="javascript:funcTenureModificationChk()">
