...
<script type="text/javascript">
	...
	function calOutstanding(field) {
		...
		var at = fname.search(regex);
		//alert("at"+at);
		var index = fname.substr(at, fname.length);
			//alert("index:"+index);
		...
		if ((npaYearStr > subsidyYearStr)
				|| ((npaYearStr == subsidyYearStr) && (npaMonStr > subsidyMonStr))
				|| ((npaYearStr == subsidyYearStr) && (npaMonStr == subsidyMonStr && npaDayStr > subsidyDayStr))) {
			os = Math.min(totalDisbAmt.value, approvedAmount.value)
					- (repayAmt + (subAmt/count));
		} else {
			os = Math.min(totalDisbAmt.value, approvedAmount.value)
					- (repayAmt);
		}
		...
		if (os<=0)
		{
		alert("Outstanding Amount should be greater than 0");
		}
	}
		...
		if ((npaYearStr > subsidyYearStr)
			...
			for ( var i = 1; i <= size; i++) {
				...
				if (loanType == 'TC' || loanType == 'CC') {
					...
					//alert("subsidyAmt:"+subsidyAmt);
						...
						var os = Math.min(totalDisbAmt.value, approvedAmount.value)- (repayAmt + (subsidyAmt/count));
			...
			for ( var j = 1; j <= size; j++) {
				...
				if (loanType == 'TC' || loanType == 'CC') {
					...
					var os = Math.min(totalDisbAmt.value, approvedAmount.value)
							- (repayAmt);
	...
	function onOffFields() {
		...
		if (document.forms[0].subsidyFlag[1].checked == true
			...
			document.forms[0].subsidyLastRcvdAmt.value = '';
			document.forms[0].subsidyLastRcvdDt.value = '';
		} else if (document.forms[0].subsidyFlag[0].checked == true
				&& document.forms[0].isSubsidyRcvd[1].checked == true) {
			//alert('isSubsidyRcvd:');
			document.forms[0].isSubsidyAdjusted[0].checked = false;
			document.forms[0].isSubsidyAdjusted[0].value = '';
			document.forms[0].isSubsidyAdjusted[1].checked = false;
			...
			document.forms[0].subsidyLastRcvdDt.value = '';
				...
				&& document.forms[0].isSubsidyRcvd[0].checked == true
...
<%
	...
	if (menu != null && subMenu != null) {
		if ((menu.equals(MenuOptions
				...
				&& (subMenu.equals(MenuOptions
						.getMenu(MenuOptions.GM_PI_NPA_DETAILS)))) {
			session.setAttribute("CurrentPage",
					"showNPADetails.do?method=showNPADetails");
		}
...
<table width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="saveNpaDetails.do?method=saveNpaDetails"
		method="POST" enctype="multipart/form-data">
		<TR>
			
			<TD width="20" align="left" valign="bottom"><IMG src="images/TableLeftTop.gif" width="20" height="31" alt=""></TD>
			<TD background="images/TableBackground1.gif"><IMG src="images/GuaranteeMaintenanceHeading.gif" alt=""></TD>
			<TD width="20" align="right" valign="bottom"><IMG src="images/TableRightTop.gif" width="23" height="31" alt=""></TD>
		</TR>
		<TR>
			<TD width="20" background="images/TableVerticalLeftBG.gif">&nbsp;</TD>
			<TD>
			<DIV align="right"><A
				HREF="javascript:submitForm('helpNpaDetails.do?method=helpNpaDetails')">HELP</A>
			</DIV>
			<table width="100%" border="0" align="left" cellpadding="0"
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<TR>
									<td class="Heading" WIDTH="55%">&nbsp; <bean:message
										key="NPADetailsHeader" />&nbsp; for &nbsp;<bean:write
										name="newNpaForm" property="unitName" /> &nbsp;(<bean:write
										name="newNpaForm" property="borrowerId" />)</td>

									<td align="left" valign="bottom"><img
										src="images/TriangleSubhead.gif" width="19" height="19" alt=""></td>
									<td align="right">
									<div align="right"></div>
									</td>
								</TR>
				...
				<TR>
					<TD class="SubHeading" COLSPAN="12">&nbsp;General Details</TD>
				</TR>
				<TR>
					<TD>
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<!--loop start -->
						<TR>
							<TD rowspan="2" class="ColumnBackground">
							<div align="center">cgpan</div>
							</TD>
							<TD rowspan="2" class="ColumnBackground">
							<div align="center">Guarantee start Date<font
								color="#FF0000" size="2">*</font></div>
							</TD>
							<td rowspan="2" class="ColumnBackground">
							<div align="center">Sanction Date<font color="#FF0000"
								size="2">*</font></div>
							</td>
							<td rowspan="2" class="ColumnBackground">
							<div align="center">First Disbursement Date<font
								color="#FF0000" size="2">*</font></div>
							</td>
							<td rowspan="2" class="ColumnBackground">
							<div align="center">Last Disbursement Date<font
								color="#FF0000" size="2">*</font></div>
							</td>
							<TD rowspan="2" class="ColumnBackground">
							<div align="center">First Installment Date<font
								color="#FF0000" size="2">*</font></div>
							</TD>

							<td colspan="2" class="ColumnBackground">&nbsp;&nbsp;Moratorium<br>
							(in months)<font color="#FF0000" size="2">*</font></td>
						</TR>
						<TR>
							<td class="ColumnBackground">
							<div align="center"><font color="#FF0000" size="2">*</font>principal</div>
							</td>
							<td class="ColumnBackground">
							<div align="center"><font color="#FF0000" size="2">*</font>interest</div>
							</td>
						</TR>
						<%
							//java.lang.Double totalGuaranteeAmt = (java.lang.Double)request.getAttribute("totalGuaranteedAmt");
								...
								org.apache.struts.validator.DynaValidatorActionForm newNpaForm2 = (org.apache.struts.validator.DynaValidatorActionForm) session
										.getAttribute("newNpaForm");

								java.lang.Double totalApprovedAmount = (java.lang.Double) newNpaForm2
								...
								java.lang.Integer size = (java.lang.Integer) newNpaForm2
										.get("size");
								...
								java.util.Vector cgpansVector = (java.util.Vector) newNpaForm2
										.get("cgpansVector");
								...
								for (int i = 1; i <= total; i++) {
									java.util.HashMap map = (java.util.HashMap) cgpansVector
											.get(i - 1);
									String cgpanNo = (String) map.get("CGPAN");
									String loanType = (String) map.get("CGPAN_LOAN_TYPE");
									String guarStartDate = (String) map
											.get("GUARANTEE_START_DT");
						...
						%>
						<TR>
							<TD class="tableData">&nbsp;<%=cgpanNo%><html:hidden
								name="newNpaForm" property="<%=cgpan%>" value="<%=cgpanNo%>" /></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=guarStartDt%>" value="<%=guarStartDate%>" size="10"
								maxlength="10" readonly="true" /><IMG
								src="images/CalendarIcon.gif" width="20" align="center"
								disabled="true" alt=""></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=sanctionDt%>" value="<%=sanctionDate%>" size="10"
								maxlength="10" readonly="true" /><IMG
								src="images/CalendarIcon.gif" width="20" align="center"
								disabled="true" alt=""></TD>
							<%
							...
							%>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=firstDisbDt%>" size="10" maxlength="10" /><IMG
								src="images/CalendarIcon.gif" width="20"
								onClick="showCalendar('newNpaForm.<%=firstDisbDt%>')"
								align="center" alt=""></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=lastDisbDt%>" size="10" maxlength="10" /><IMG
								src="images/CalendarIcon.gif" width="20"
								onClick="showCalendar('newNpaForm.<%=lastDisbDt%>')"
								align="center" alt=""></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=firstInstDt%>" size="10" maxlength="10" /><IMG
								src="images/CalendarIcon.gif" width="20"
								onClick="showCalendar('newNpaForm.<%=firstInstDt%>')"
								align="center" alt=""></TD>
							<TD class="tableData">
							<div align="center"><html:select name="newNpaForm"
								property="<%=moratoriumPrincipal%>">
								<%
									for (int j = 0; j < 30; j++) {
								%>
							...
							%>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=firstDisbDt%>" disabled="true" size="10"
								maxlength="10" /><IMG src="images/CalendarIcon.gif" width="20"
								align="center" disabled="true" alt=""></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=lastDisbDt%>" disabled="true" size="10"
								maxlength="10" /><IMG src="images/CalendarIcon.gif" width="20"
								align="center" disabled="true" alt=""></TD>
							<TD class="tableData"><html:text name="newNpaForm"
								property="<%=firstInstDt%>" disabled="true" size="10"
								maxlength="10" /><IMG src="images/CalendarIcon.gif" width="20"
								align="center" disabled="true" alt=""></TD>
							<TD class="tableData">
							<div align="center"><html:select name="newNpaForm"
								property="<%=moratoriumPrincipal%>" disabled="true">
							...
							<TD class="tableData">
							<div align="center"><html:select name="newNpaForm"
								property="<%=moratoriumInterest%>" disabled="true">
								<html:option value="">0</html:option>
							</html:select></div>
							</TD>
							<%
				...
				<TR>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						<!--npa details -->
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;Npa date<font
								color="#FF0000" size="2">*</font></TD>
							<TD colspan="3" class="tableData">
							<table cellpadding="0" cellspacing="0">
								<TR>

									<logic:equal name="newNpaForm" property="operationType"
										value="NCU">
										<TD><font size="1"><bean:write name="newNpaForm"
											property="npaDt" /></font> <html:hidden name="newNpaForm"
											property="npaDt" /></TD>
									</logic:equal>
									<logic:equal name="newNpaForm" property="operationType"
										value="OCU">
									...
									<logic:notEqual name="newNpaForm" property="operationType"
										value="NCU">
										<logic:notEqual name="newNpaForm" property="operationType"
											value="OCU">
											<TD><html:text name="newNpaForm" property="npaDt"
												size="10" maxlength="10" /></TD>
											<TD><IMG src="images/CalendarIcon.gif" width="20"
												onClick="showCalendar('newNpaForm.npaDt')" align="center"
												alt=""></TD>
										</logic:notEqual>
									</logic:notEqual>
								</TR>
						...
						<TR>
							<TD colspan="1" class="ColumnBackground" align="left">&nbsp;Is
							the NPA date as per the RBI guidelines<font color="#FF0000"
								size="2">*</font></TD>
							<TD colspan="3" class="tableData"><logic:equal
								name="newNpaForm" property="operationType" value="NCU">
								<bean:write name="newNpaForm" property="isAsPerRBI" />
							</logic:equal> <logic:notEqual name="newNpaForm" property="operationType"
								value="NCU">

								<html:radio name="newNpaForm" value="Y" property="isAsPerRBI"
									onclick="enableDisableFields('Y');">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
											<html:radio name="newNpaForm" value="N" property="isAsPerRBI"
									onclick="enableDisableFields('N');">
									<bean:message key="no" />
								</html:radio>
						...
						<TR>
							<TD colspan="1" class="ColumnBackground" align="left">&nbsp;Do
							you confirm the NPA date<font color="#FF0000" size="2">*</font></TD>
							<TD colspan="3" class="tableData"><logic:equal
								name="newNpaForm" property="operationType" value="NCU">
								...
								<html:radio name="newNpaForm" value="Y" property="npaConfirm"
									onclick="confirmNpaDate('Y');">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
											<html:radio name="newNpaForm" value="N" property="npaConfirm"
									onclick="confirmNpaDate('N');">
									<bean:message key="no" />
								</html:radio>
						...
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;<bean:message
								key="npaReason" /><font color="#FF0000" size="2">*</font></TD>
							<TD colspan="3" class="tableData"><logic:equal
								name="newNpaForm" property="operationType" value="NCU">
								<bean:write name="newNpaForm" property="npaReason" />
							</logic:equal> <logic:equal name="newNpaForm" property="operationType"
								value="OCU">
								<bean:write name="newNpaForm" property="npaReason" />
							</logic:equal> <logic:notEqual name="newNpaForm" property="operationType"
								value="NCU">
								<logic:notEqual name="newNpaForm" property="operationType"
									...
									<html:select name="newNpaForm" property="npaReason">
										...
										<html:option
											value="Delay in commencement/implementation of project">Delay in commencement/<br>implementation of project</html:option>
						...
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;<bean:message
								key="enumerateEfforts" /><font color="#FF0000" size="2">*</font>
							</TD>
							<TD colspan="3" class="tableData"><html:select
								name="newNpaForm" property="effortsTaken">
								<html:option value="">Select</html:option>
						...
						<TR>
							...
							account being restructured/rescheduled<font color="#FF0000"
								size="2">*</font></TD>
							<TD colspan="3" class="tableData"><html:radio
								name="newNpaForm" value="Y" property="isAcctReconstructed">
								<bean:message key="yes" />
							</html:radio>&nbsp; <html:radio name="newNpaForm" value="N"
								property="isAcctReconstructed">
								<bean:message key="no" />
							</html:radio></TD>
						</TR>
						<!--Subsidy Details -->
						<TR>
							...
							<TD colspan="3" class="tableData"><html:radio
								name="newNpaForm" value="Y" property="subsidyFlag"
								onclick="enableDisableSubRcvd('Y');">
								<bean:message key="yes" />
							</html:radio>&nbsp; <html:radio name="newNpaForm" value="N"
								property="subsidyFlag" onclick="enableDisableSubRcvd('N');">
								<bean:message key="no" />
							</html:radio></TD>
						</TR>
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;Has the
							subsidy been received?</TD>
							<TD colspan="3" class="tableData"><logic:equal
								name="newNpaForm" property="subsidyFlag" value="Y">
								<html:radio name="newNpaForm" value="Y" property="isSubsidyRcvd"
									onclick="enableDisableSubAdj('Y');">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
												<html:radio name="newNpaForm" value="N"
									property="isSubsidyRcvd" onclick="enableDisableSubAdj('N');">
									<bean:message key="no" />
								</html:radio>
							</logic:equal> <logic:notEqual name="newNpaForm" property="subsidyFlag"
								value="Y">
								<html:radio name="newNpaForm" value="Y" property="isSubsidyRcvd"
									onclick="enableDisableSubAdj('Y');" disabled="true">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
												<html:radio name="newNpaForm" value="N"
									property="isSubsidyRcvd" onclick="enableDisableSubAdj('N');"
							...
							</logic:notEqual> <%--	<html:hidden name="newNpaForm" value="N" property="isSubsidyRcvd" />  --%>

							</TD>
						</TR>
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;Has the
							subsidy been adjusted?</TD>
							...
							<logic:equal name="newNpaForm" property="isSubsidyRcvd" value="Y">
								<html:radio name="newNpaForm" value="Y"
									property="isSubsidyAdjusted"
									onclick="enableDisableSubsidyFields('Y');">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
												<html:radio name="newNpaForm" value="N"
									property="isSubsidyAdjusted"
									onclick="enableDisableSubsidyFields('N');">
									<bean:message key="no" />
								</html:radio>
							</logic:equal> <logic:notEqual name="newNpaForm" property="isSubsidyRcvd"
								value="Y">
								<html:radio name="newNpaForm" value="Y"
									property="isSubsidyAdjusted"
									onclick="enableDisableSubsidyFields('Y');" disabled="true">
									<bean:message key="yes" />
								</html:radio>&nbsp; 
												<html:radio name="newNpaForm" value="N"
									property="isSubsidyAdjusted"
									onclick="enableDisableSubsidyFields('N');" disabled="true">
									<bean:message key="no" />
								</html:radio>
							</logic:notEqual> <%--	<html:hidden name="newNpaForm" value="N" property="isSubsidyAdjusted" />  --%>

							</TD>
						</TR>
						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;Subsidy Last
							Received Date</TD>
							<TD colspan="3" class="tableData">
							<table cellpadding="0" cellspacing="0">
								<TR>
									<TD><logic:equal name="newNpaForm"
										property="isSubsidyAdjusted" value="Y">
										<html:text name="newNpaForm" property="subsidyLastRcvdDt"
											size="10" maxlength="10" />
									</logic:equal> <logic:notEqual name="newNpaForm" property="isSubsidyAdjusted"
										value="Y">
										<html:text name="newNpaForm" property="subsidyLastRcvdDt"
									...
									<TD><IMG src="images/CalendarIcon.gif" width="20"
										onClick="showCalendar('newNpaForm.subsidyLastRcvdDt')"
										align="center" alt=""></TD>
						...
						<TR>
							...
							Received Amount</TD>
							<TD colspan="3" class="tableData"><logic:equal
								name="newNpaForm" property="isSubsidyAdjusted" value="Y">
								<html:text name="newNpaForm" property="subsidyLastRcvdAmt"
									size="10" maxlength="10" onchange="calOSAmt(this);" />
							</logic:equal> <logic:notEqual name="newNpaForm" property="isSubsidyAdjusted"
								value="Y">
								<html:text name="newNpaForm" property="subsidyLastRcvdAmt"
									size="10" maxlength="10" disabled="true"
									onchange="calOSAmt(this);" />
							</logic:notEqual></TD>
						</TR>


						<TR>
							<TD colspan="1" class="ColumnBackground">&nbsp;Last
							Inspection Date<font color="#FF0000" size="2">*</font></TD>
							<TD colspan="3" class="tableData">
							<table cellpadding="0" cellspacing="0">
								<TR>
									<%
									...
									%>
									<TD><html:text name="newNpaForm"
										property="lastInspectionDt" size="10" maxlength="10" /><!-- enable when total amount guaranteed greater than 7.5lac-->
									</TD>
									<TD><IMG src="images/CalendarIcon.gif" width="20"
										onClick="showCalendar('newNpaForm.lastInspectionDt')"
										align="center" alt=""></TD>
									<%
										} else {
									%>
									<TD><html:text name="newNpaForm"
										property="lastInspectionDt" size="10" maxlength="10"
										disabled="true" /></TD>
									<TD><IMG src="images/CalendarIcon.gif" width="20"
										onClick="showCalendar('newNpaForm.lastInspectionDt')"
										align="center" disabled="true" alt=""></TD>
				...
				<TR>
					<TD class="SubHeading" colspan="12">Repayment (before NPA date
					exclusive of subsidy) and Outstanding amount Details</TD>
				</TR>
				<TR>
					<TD>
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							...
							<TD rowspan="2" class="ColumnBackground">&nbsp;&nbsp;Total
							Amount Disbursed<font color="#FF0000" size="2">*</font></TD>
							<TD colspan="2" class="ColumnBackground">
							<div align="center">Repayment(before NPA date)<font
								color="#FF0000" size="2">*</font></div>
							</TD>
							<td colspan="2" class="ColumnBackground">
							<div align="center">Outstanding amount(as on NPA date)<font
								color="#FF0000" size="2">*</font></div>
							</td>
						</TR>
						<TR>
							<td class="ColumnBackground">
							<div align="center"><font color="#FF0000" size="2">*</font>principal(in
							Rs.)</div>
							</td>
							<td class="ColumnBackground">
							<div align="center"><font color="#FF0000" size="2">*</font>interest(in
							Rs.)</div>
							</td>
							<td class="ColumnBackground">
							<div align="center"><font color="#FF0000" size="2">*</font>principal(in
						...
						<%
							String totalDisbAmt = null;
								...
								for (int i = 1; i <= total; i++) {
									...
									String cgpanNo = (String) map.get("CGPAN");
									String loanType = (String) map.get("CGPAN_LOAN_TYPE");
									Double approvedAmt = (java.lang.Double) map
											.get("APPROVED_AMOUNT");
						...
						<TR>
							<TD class="tableData">&nbsp;<%=cgpanNo%><html:hidden
								name="newNpaForm" property="<%=approvedAmount%>"
								value="<%=String.valueOf(guarAmt)%>" /> <html:hidden
								name="newNpaForm" property="<%=interestRate%>"
								value="<%=String.valueOf(r)%>" /></TD>
							<%
								if ("TC".equals(loanType) || "CC".equals(loanType)) {
							%>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=totalDisbAmt%>" onchange="calOutstanding(this);"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=repayPrincipal%>" onchange="calOutstanding(this);"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=repayInterest%>"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=outstandingPrincipal%>" readonly="true" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=outstandingInterest%>"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</TD>
							<%
							...
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=totalDisbAmt%>" disabled="true" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=repayPrincipal%>" disabled="true" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=repayInterest%>" disabled="true" /></div>
							</TD>
							<TD class="tableData">
							<div align="center"><html:text name="newNpaForm"
								property="<%=outstandingPrincipal%>"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</TD>
							<TD class="tableData">
						...
						<!--loop end -->
						<TR>
							<TD style="color: green; font: 15px;" COLSPAN="12">Note: The
							Outstanding amount for Term Loan as on date of NPA has been
							derived by deducting Principal repayment from Total disbursement/
							Guarantee amount whichever is lower.</TD>
						</TR>
					</table>
					</TD>
				</TR>
					...
					<table width="100%" border="0" cellspacing="1" cellpadding="1">
						...
						<TR>
							<TD colspan="6" class="SubHeading"
								style="backgroundcolor: yellow;">&nbsp;Primary Security
							Details</TD>
						</TR>
						<tr>
							...
							<td class="ColumnBackground" rowspan="2">
							<div align="center">Networth of guaranotr/Promoter(in Rs.)</div>
							</td>
							<td class="ColumnBackground" rowspan="2">
						...
						<tr>
							...
							<td class="ColumnBackground">
							<div align="center"><bean:message key="value" /><br>
							<bean:message key="inRs" /></div>
							</td>
						</tr>
						...
						<%
							//	java.lang.Double totalSecurityAsOnSanc = (java.lang.Double)request.getAttribute("totalSecurityAsOnSanc");
								...
								java.lang.Double totalSecurityAsOnSanc = (java.lang.Double) newNpaForm2
										.get("totalSecurityAsOnSanc");

								double totalSecurityAsOnSanc2 = 0.0;
								if (totalSecurityAsOnSanc != null) {
									totalSecurityAsOnSanc2 = totalSecurityAsOnSanc
											.doubleValue();
								}
								String totalSecurityAsOnSancDt = String
										.valueOf(totalSecurityAsOnSanc2);
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=landAsOnDtOfSnctnDtl%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
							</td>
							<td class="TableData" rowspan="6">
							<div align="center"><html:text name="newNpaForm"
								property="networthAsOnSancDt" size="10" maxlength="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</td>
							<td class="TableData" rowspan="6">
							<div align="center"><html:select
								property="reasonForReductionAsOnSancDt" name="newNpaForm"
								disabled="true">
								<html:option value="">Select</html:option>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=bldgAsOnDtOfSnctn%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=machinecAsOnDtOfSnctn%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=otherAssetsAsOnDtOfSnctn%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=currAssetsAsOnDtOfSnctn%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=otherValAsOnDtOfSnctn%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calculatePsTotalNew();" />
							</div>
						...
						<TR>
							...
							<td class="TableData" id="totalsecurityasonsancdt"><html:text
								name="newNpaForm" property="totalSecurityAsOnSanc"
								maxlength="10" size="10" readonly="true" /></td>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=landAsOnDtOfNPA%>" name="newNpaForm" maxlength="10"
								size="10" onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
							<td class="TableData" rowspan="6">
							<div align="center"><html:text name="newNpaForm"
								property="networthAsOnNpaDt" size="10" maxlength="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" /></div>
							</td>
							<td class="TableData" rowspan="6">
							<div align="center"><html:select
								property="reasonForReductionAsOnNpaDt" name="newNpaForm">
								<html:option value="">Select</html:option>
								<html:option value="Activity/ Unit closed">Activity/ Unit closed</html:option>
								<html:option value="Depreciation">Depreciation</html:option>
								<html:option value="Assets disposed">Assets disposed</html:option>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=bldgAsOnDtOfNPA%>" name="newNpaForm" maxlength="10"
								size="10" onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
						</tr>
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=machinecAsOnDtOfNPA%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=otherAssetsAsOnDtOfNPA%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=currAssetsAsOnDtOfNPA%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event,13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
						...
						<tr>
							...
							<td class="TableData">
							<div align="center"><html:text
								property="<%=otherValAsOnDtOfNPA%>" name="newNpaForm"
								maxlength="10" size="10"
								onkeypress="return decimalOnly(this, event, 13)"
								onkeyup="isValidDecimal(this)" onchange="calPsTotalNpa();" /></div>
							</td>
						...
						<TR>
							...
							<td class="TableData" id="totalsecurityasonnpadt"><html:text
								name="newNpaForm" property="totalSecurityAsOnNpa" maxlength="10"
		...
		<tr>
			<td width="20" align="right" valign="bottom"><img src="images/TableLeftBottom.gif" width="20" height="51" alt=""></td>
			<td colspan="1" valign="bottom" background="images/TableBackground3.gif">
			...
			<IMG src="images/Reset.gif" alt="Cancel" width="49" height="37" border="0"></A> 
			<A href='subHome.do?method=getSubMenu&amp;menuIcon=<%=session.getAttribute("menuIcon")%>&amp;mainMenu=<%=session.getAttribute("mainMenu")%>'>
			<IMG src="images/Cancel.gif" alt="Cancel" width="49" height="37" border="0"></A></div>
			</td>
			<td width="20" align="right" valign="bottom"><img src="images/TableRightBottom.gif" width="23" height="51" alt=""></td>
		</tr>
		<!--	<TR>
