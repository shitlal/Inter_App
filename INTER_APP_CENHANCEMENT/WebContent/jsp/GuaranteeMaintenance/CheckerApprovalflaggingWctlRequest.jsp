...
<% session.setAttribute("CurrentPage","CheckerApprovalSubmitDetails.do?method=CheckerApprovalSubmitDetails");%>
<%SimpleDateFormat dateFormat=new SimpleDateFormat("dd/MM/yyyy");%>

	<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
    <html:errors />
	<html:form action="CheckerApprovalSubmitDetails.do?method=CheckerApprovalSubmitDetails" method="POST" enctype="multipart/form-data">
	<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	   <TR> 
		...
		<TR>
			...
			<tr>
                  ...
                  <td valign="top"  class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>Reschdulement<br>Date</strong></div></td>
                  ...
                  <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>Guarantee<br>
                      ...
                      <td valign="top" class="HeadingBg"><div align="center">&nbsp;&nbsp;<strong>Loan<br>Account<br>Number</strong></div></td> 
    ...
    document.getElementById('contactText').setAttribute('maxlength', '10');
                           ...
                           <logic:iterate id="object" name="cpTcDetailsForm" property="claimDandU" indexId="index">
								...
								ClaimActionForm   cReport = (ClaimActionForm)object;
									...
									System.out.println("ClmreferenceNumber"+ClmreferenceNumber);
								%>
         	...
         	%>   </TD>
              ...
              <tr align="center" valign="baseline">
           		 <td colspan="4"> 
           		 <div align="center"> 
		         <a href="javascript:submitForm('CheckerApprovalSubmitDetails.do?method=CheckerApprovalSubmitDetails')"><IMG src="images/Submit.gif" alt="Save" width="49" height="37" border="0"></a>
