...
function checkWithSanctionDt(indx){
	...
	//alert(" 1sancDt:"+sancDt+" \nOtsDt:"+OtsDt);	
	//alert("sancDate:"+sancDate+" \OtsDate:"+OtsDate);
...
<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form  name = "rpAllocationForm" type="com.cgtsi.actionform.RPActionForm" action="updateOutstandingDetailsEntry.do?method=updateOutstandingDetailsEntry" method="POST" >
		<TR> 
				...
				<TR>
                 ...
                 <TD align="left" valign="top" class="ColumnBackground">
						...
						<TD align="left" valign="top" class="ColumnBackground" width="114">
									...
									<html:checkbox property="selectAll" name="rpAllocationForm" onclick="selectDeselect2(this,1)"/>				
								    </TD>
               ...
               <%k++; %>
				...
				<TR>
					...
					<DIV align="center">
							...
							<a href="javascript:submitFormRAJU('updateOutstandingDetailsEntry.do?method=updateOutstandingDetailsEntry')">
