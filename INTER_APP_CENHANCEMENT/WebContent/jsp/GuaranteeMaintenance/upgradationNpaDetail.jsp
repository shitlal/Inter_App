...
<% session.setAttribute("CurrentPage","upgradationNpa.do?method=upgradationNpa");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="submitUpgradationDetails.do?method=submitUpgradationDetails" method="POST" enctype="multipart/form-data" focus="<%=focusField%>">
		<TR> 
			...
			<TD  align="left" colspan="4"><font size="2"><bold>
             ...
             <logic:equal property="bankIdForClosure" value="0000" name="gmPeriodicInfoForm">		
              ...
              <TR>                								
								...
								<TR align="left" valign="top">
									<TD align="left" valign="top"   class="ColumnBackground"><font color="#FF0000" size="2">*</font>Reasons of NPA Detail
									</TD>
									<TD align="left" valign="top" class="TableData" colspan="4">
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('submitUpgradationDetails.do?method=submitUpgradationDetails')">
