...
<% session.setAttribute("CurrentPage","BorrowerIdRecovery.do?method=BorrowerIdRecovery");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showRecoveryDetails.do?method=showRecoveryDetails" method="POST" focus="<%=focusField%>">
		<TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showRecoveryDetails.do?method=showRecoveryDetails')">
