...
<%
	session.setAttribute("CurrentPage", "saveOutstandingAmountNew.do?method=saveOutstandingAmountNew");
%>
<html>
	<head>		
		<title></title>
		<script type="text/javascript">
			...
			{
				alert(" For Outstanding Amount "+actionType);	
				...
				for(var j=0; j<checkList1.length; j++)
				{
					...
					{
						check = true;
						//alert(document.getElementById(checkList1[j].value));
						if(document.getElementById(checkList1[j].value) != null)
						{
							//alert(document.getElementById(checkList1[j].value).value);
							if((document.getElementById(checkList1[j].value).value == "")||(document.getElementById(checkList1[j].value).value == 0))
							{
								alert("Outstanding Amount is required for selected checkbox..And it should be greater than Zero.");
								comment = true;
								break;					
							}				
						}
				...
				{		
					//alert("inside if");
					document.gmPeriodicInfoForm.action="saveOutstandingAmountNew.do?method=saveOutstandingAmountNew&action="+actionType;
	...
	<body>
		<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
			<html:errors />
			<html:form  action="saveOutstandingAmountNew.do?method=saveOutstandingAmountNew" method="POST" enctype="multipart/form-data">
				<TR> 
						...
						<TABLE width="100%" border="0" align="left" cellpadding="1" cellspacing="1">
								...
								<TD colspan="12"> 
									<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
										<TR>
											...
											<IMG src="images/TriangleSubhead.gif" width="19" height="19"></TD>
										</TR>
										<tr>
										...
										<tr><td  width="100%" ><font color="blue">Outstanding amount for Term Loan will be amount as on 31/12/2018 and<br>
							...
							<logic:iterate id="object" name="gmPeriodicInfoForm" property="npaRegistFormList" indexId="index">
								<%
									...
									String empComments = "";
									String empComments1 = "";
									String cgpan = npaRegistForm.getCgpan();
									String cgpan1 = npaRegistForm.getCgpan();
									//System.out.println("JSP checkerId : "+checkerI);
								%>
								<TR>
									<TD align="left" valign="top" class="ColumnBackground" width="50"><%=Integer.parseInt(index+"")+1%></TD>
									<TD align="left" valign="top" class="ColumnBackground" width="98"><%=npaRegistForm.getCgpan()%></TD>
									<TD align="left" valign="top" class="ColumnBackground" width="98"><%=npaRegistForm.getUnitName()%></TD>
									<TD align="left" valign="top" class="ColumnBackground" width="98"><%=npaRegistForm.getGuaranteeamt()%></TD>
									...
									<TD align="left" valign="top" class="ColumnBackground" width="114">
										<%
											...
											empComments = "empComments("+cgpan+")";
											//System.out.println("JSP empComments : "+empComments);
										%>
										<html:text property="<%=empComments%>"     name="gmPeriodicInfoForm" styleId="<%=cgpan%>" onkeypress="return numbersOnly(this, event)" onkeyup="isValidNumber(this)" maxlength="10"/>
									...
									<TD align="left" valign="top" class="ColumnBackground" width="114">
										<%
											...
											empComments1 = "empComments1("+cgpan1+")";
											//System.out.println("JSP empComments : "+empComments);
										%>
										<input onclick="ds_sh(this);" name="date" readonly="readonly" style="cursor: text" />
										<!--
										<html:text property="<%=empComments1%>"     name="gmPeriodicInfoForm"  styleId="<%=cgpan1%>" />
							...
							<TD align="left" valign="top" class="ColumnBackground" width="114">&nbsp;&nbsp;
										<html:checkbox property="check"   value="<%=cgpan1%>" name="gmPeriodicInfoForm"/>
									</TD>
							...
							<TR>
								<TD align="center" valign="baseline" colspan="10">
									<DIV align="center">
										...
										<a href="javascript:document.gmPeriodicInfoForm.reset()"><img src="images/Reset.gif"  alt="Reset" width="49" height="37" border="0"></a>
