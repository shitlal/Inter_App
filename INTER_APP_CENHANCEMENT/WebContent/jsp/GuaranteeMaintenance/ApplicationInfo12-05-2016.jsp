						 ...
						 <logic:notEqual property="bankId" value="0000" name="gmForm">
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData">
										<html:text property="borrowerIdForModifyBorrDtl" size="20" maxlength ="9" name="gmForm"/>
										&nbsp;&nbsp;&nbsp;&nbsp;<bean:message key="or"/>
									</TD>
								...
								<TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData" colspan="4">
										<html:text property="borrowerNameForModifyBorrDtl" size="30" alt="SSIBorrowerName" name="gmForm">
										</html:text>
