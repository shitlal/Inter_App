...
<% session.setAttribute("CurrentPage","NpaDetailsGetBorrowerId.do?method=NpaDetailsGetBorrowerId");%>
...
<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showNPADetails.do?method=showNPADetails" method="POST" focus="<%=focusField%>">
		<TR>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showNPADetails.do?method=showNPADetails')">
