						...
						<logic:notEqual property="periodicBankId" value="0000" name="gmPeriodicInfoForm">
							    ...
							    <TR align="left" valign="top">
									...
									<TD align="left" valign="top" class="TableData">
										<html:text property="borrowerId" size="20" maxlength ="9"  name="gmPeriodicInfoForm"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Or</b>
									</TD>
					...
					<TR >
						<TD align="center" valign="baseline" >
							<DIV align="center">
									...
									<A href="javascript:submitForm('showNPADetails1.do?method=showNPADetails1')">
