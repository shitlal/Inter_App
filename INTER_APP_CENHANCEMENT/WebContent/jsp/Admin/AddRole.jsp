...
<% session.setAttribute("CurrentPage","showAddRole.do?method=showAddRole");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>
<HTML>
	<BODY>
		<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
			<html:errors />
			<html:form action="addRole.do" method="POST" focus="roleName" >
			<TR>
				<TD>
					<TABLE width="680" border="0" cellspacing="0" cellpadding="0" align="center">
						...
						<TR>
							...
							<TD width="713">
							<DIV align="right">			
								<A HREF="javascript:submitForm('helpAddRole.do?method=helpAddRole')">
								HELP</A>
							</DIV>
				...
				Fields marked as </font><font color="#FF0000" size="2">*</font><font size="2"> are mandatory</bold></font>
									...
									<TR> 
										<TD colspan="2" width="700">
											<TABLE width="604" border="0" cellspacing="0" cellpadding="0">
												<TR>
													<TD width="45%" class="Heading"><bean:message key="addRoleHeader" /></TD>
									...
									<TR>
										...
										<TD align="left" valign="top" class="TableData">
											<html:text property="roleName" size="20" maxlength="50" alt="Role Name"  name="adminForm"/>
										</TD>
									</TR>
									<TR>
										<TD align="left" valign="top" class="ColumnBackground">
									...
									<TR >
										...
										<TD colspan="2" width="700"><DIV align="center">
												...
												<A href="javascript:submitForm('addRole.do?method=addRole')">
