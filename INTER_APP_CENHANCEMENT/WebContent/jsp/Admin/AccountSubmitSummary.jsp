...
<td><table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  Iterator itr = appclms1.iterator();
   while(itr.hasNext())
    ...
    %>
       <tr> <td>&nbsp;<strong><%=clmrefno%></strong>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Please Forward physical copy of Bank Mandate Form to CGTMSE. The Account will be Activated only when the bank Mandate form is Received at CGTMSE. <br> &nbsp; </td> <td>&nbsp;<strong></strong><br> &nbsp; </td></tr>
       <% 
    }
