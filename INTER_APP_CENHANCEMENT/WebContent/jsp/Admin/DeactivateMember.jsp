...
<% session.setAttribute("CurrentPage","showDeactivateMem.do");%>
<%@ include file="/jsp/SetMenuInfo.jsp" %>

<TABLE width="725" border="0" cellpadding="0" cellspacing="0">
	<html:errors />
	<html:form action="showDeactivateMem.do" method="POST" focus="memberId" >
		<TR> 
							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								<TR>
									<TD colspan="4"> 
										<TABLE width="100%" border="0" cellpadding="0" cellspacing="0">
											<TR>
												<TD width="31%" class="Heading"><bean:message key="deactivateMemberHeader" /></TD>
								...
								<TR align="left">
									<TD align="left" colspan="4" valign="top" class="ColumnBackground">
										...
										<html:textarea property="reason" name="adminForm" cols="55" rows="3" />				
									</TD>
								</TR>
