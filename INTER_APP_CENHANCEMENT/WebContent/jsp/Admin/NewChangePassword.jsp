...
<html:form action="changeExpiredPassword.do" method="POST" focus="oldPassword">
		...
		<TR>
          ...
          <TR>
		   ...
		   <TR>
			...
			<TD align="left" valign="top" class="TableData" >										
			<html:password property="confirm" size="20"  alt="Reference" maxlength="16"  name="adminForm"/>
			</TD>            
          </TR>
		  <TR>
		    <TD align="left" valign="top" class="ColumnBackground" >
			...
			<% String hintQuestion=(String)request.getAttribute("hintQuestion");			
				
			%>
			<TD align="left" valign="top" class="TableData" >										
			<html:text property="newQuestion" value="<%=hintQuestion%>" size="20"  alt="Reference"  name="adminForm"/>
			</TD>            
          </TR>
		   ...
		   <TR>
			...
			<% String hintAnswer=(String)request.getAttribute("hintAnswer");	
				
			%>
			<TD align="left" valign="top" class="TableData" >										
			<html:text property="newAnswer" size="20" value="<%=hintAnswer%>" alt="Reference"  name="adminForm"/>
			</TD>            
          </TR>
   <TR>
		    <TD align="left" valign="top" class="ColumnBackground" >
										&nbsp;<font color="#FF0000" size="2">*</font>emailId
			</TD>
			<% String emailId=(String)request.getAttribute("emailId");	
				
			%>
			<TD align="left" valign="top" class="TableData" >										
			<html:text property="emailId" size="20" value="<%=emailId%>" alt="Reference"  name="adminForm"/>
			</TD>            
          </TR>
						...
						<A href="javascript:submitForm('changeExpiredPassword.do?method=changeExpiredPassword')">
