	...
	<html:form action="downloadThinClient.do?method=downloadThinClient" method="POST" >
		...
		<TR>
			...
			<!-- <DIV align="right">			
				...
				<bean:define id="mcgf" name="adminForm" property="MCGFStatus" type="java.lang.String"/>
				   ...
				   <TR align="left">
									<TD align="left" colspan="4" valign="top" class="ColumnBackground">
										...
										<html:link href="<%=path+"/Download/ThinClient.exe"%>"><bean:message key="clickToDownload"/> 
										</html:link>		
									</TD>
								</TR>
				   ...
				   <TR align="left">
									<TD align="left" colspan="4" valign="top" class="ColumnBackground">
										&nbsp;
										<html:link href="<%=path+"/Download/ThinClientMCGF.exe"%>"><bean:message key="clickToDownload"/> 
										</html:link>		
									</TD>
								</TR>
