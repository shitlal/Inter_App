							...
							<TABLE width="100%" border="0" cellspacing="1" cellpadding="1">
								...
								<TR align="left">
									...
									<TD align="left" class="TableData"> 
										<html:text property="empFName" name="adminActionForm" size="25" styleId="fname" maxlength="19"/>
									</TD>
								</TR>
								<TR align="left">
									<TD align="left" valign="top" class="ColumnBackground">&nbsp;
									...
									<TD align="left" class="TableData"> 
										<html:text property="empMName" name="adminActionForm" size="25" styleId="mname" maxlength="19"/>
									</TD>
								</TR>
								<TR align="left">
									<TD align="left" valign="top" class="ColumnBackground">&nbsp;
									...
									<TD align="left" class="TableData"> 
										<html:text property="empLName" name="adminActionForm" size="25" styleId="lname" maxlength="19"/>
									</TD>
								</TR>
								<TR align="left">
									<TD align="left" valign="top" class="ColumnBackground">&nbsp;
