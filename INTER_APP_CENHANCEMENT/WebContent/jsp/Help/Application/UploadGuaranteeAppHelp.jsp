...
<%
	session.setAttribute("CurrentPage", "uploadGuaranteeAppHelp.do");
%>
		...
		<TR>
			...
			<table width="606" border="0" cellspacing="1" cellpadding="0">
				...
				<tr>
					...
					<DIV align="left">&nbsp;Choose File</DIV>
					</TD>
					<TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					Choose a Excel file to upload</TD>
				</tr>
				<tr>
					<TD width="20%" align="left" valign="top" class="ColumnBackground">
					<DIV align="left">&nbsp;Field Format</DIV>
					</TD>
					<TD width="27%" align="left" valign="top" class="TableData">&nbsp;
					<a href="Download/Capture.PNG" target="_blank">View</a> <a
						href="Download/GUARAPP FIELD FORMATS.doc" target="_blank">View</a>
					</TD>
				</tr>
				<TR align="center" valign="baseline">
					<td colspan="2" width="700">
					<DIV align="center"><A href="uploadGuaranteeAppInput.do"> <IMG
						src="images/Back.gif" alt="Save" width="49" height="37" border="0">
					</A></DIV>
				</TR>
			</TABLE>
			</TD>
