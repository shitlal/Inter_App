...
//                   }
               ...
               if (fi2=="" && fi3=="" && fi4=="" && fi5=="" && fi6=="")
                 ...
                 document.ioForm.target ="_self";
                 document.ioForm.method="POST";
                 document.ioForm.action="InwardNew.do?method=inwardInput&rowcount="+rowCount;
                 document.ioForm.submit();
...
<BODY>
  <html:errors/>
   ...
   <TABLE>
    ...
    <tr> 
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0">
                ...
                <!-- <td width="7%" class="ColumnBackground "><div align="center">Place&nbsp;</div></td> -->
                <!--  <td width="7%" class="ColumnBackground "><div align="center">Ltr Ref No&nbsp;</div></td> -->
                <!--  <td width="7%" class="ColumnBackground "><div align="center">Ltr Date&nbsp;</div></td> -->
                <!--  <td width="8%" class="ColumnBackground "><div align="center">Subject&nbsp;</div></td> -->
   ...
   <TABLE  id="dataTable"  border="1">
      ...
      <TD> <html:text property="drawnonBank" name="ioForm" size="30" value=""/> </TD>
	    ...
	    <TD> <html:select property="section" name="ioForm">
      <html:option value="">Select</html:option> 
  ...
  <TR>
   ...
   <TD class="ColumnBackground" colspan="14" id="instrumentTotal">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <INPUT type="text" name="instrumentTotal" maxlength="80" size="20" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
