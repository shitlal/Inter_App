...
<% session.setAttribute("CurrentPage","investmentEntry.do?method=investmentEntry");%>
...
//	yearVal = parseInt(depositDate.substring(index1+1, depositDate.length));
 if (depositDate.length >= 11 || depositDate.length < 10) 
  ...
  var tempday=dayVal;
  var tempmonth=monthVal;
  var tempyear=yearVal;
...
<% 
  ...
  dynaForm.set("depositDate",sysDate);
%>

<body >
<html:form action="insertInvestmentDetails.do?method=insertInvestmentDetails" method="POST" enctype="multipart/form-data">
<html:errors />
	...
	<TR>
        ...
        <tr>
					...
					<td class="tableData" colspan="2"><div align="left">
						<html:text  property="depositAmt" maxlength="16" onkeypress="return decimalOnly(this, event, 13)" onkeyup="isValidDecimal(this)"/> <bean:message key="inRs"/>
					</div></td>
				</tr>  
				<tr>
        ...
        <tr>
         	...
         	<html:text property="maturityDate" maxlength="10" onclick="calculateMaturityDt()"/><img src="images/CalendarIcon.gif" onclick="showCalendar('ifForm.maturityDate')" align="center"> 
					</div></td>
				</tr>
        <tr>
          ...
          <tr > 
            <td align="center" valign="baseline" > <div align="center"><html:link href="javascript:submitForm('insertInvestmentDetails.do?method=insertInvestmentDetails')"><img src="images/Save.gif" alt="Save" width="49" height="37" border="0"></html:link><html:link href="javascript:document.ifForm.reset()"><img src="images/Reset.gif" alt="Cancel" width="49" height="37" border="0"></html:link> 
              </div></td>
          </tr>
        </table></td>
