...
<% 
session.setAttribute("CurrentPage","displayTCClaimDetailsInput.do?method=displayClaimDetailsInput");
%>
<body topmargin="0">
<html:errors />
<html:form action="getTCClaimDetailForClmRefNo.do?method=getClaimDetailForClmRefNo" method="POST" enctype="multipart/form-data">
...
<a href="javascript:submitForm('getTCClaimDetailForClmRefNo.do?method=getClaimDetailForClmRefNo')">
