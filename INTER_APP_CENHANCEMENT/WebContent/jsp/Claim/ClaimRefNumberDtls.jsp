...
Legal Forum Name:&nbsp;<%=legalForumName%> at <%=legalLocation%>&nbsp;Legal Suit Number <%=legalSuitNo%>&nbsp;Dated &nbsp;<%=formatedDate8%> </div></td>
    ...
    <td class="ColumnBackground" colspan="7">&nbsp;<html:text property="dateofReceipt" size="15" alt="dateofReceipt" name="cpTcDetailsForm" maxlength="10"/>
      ...
      %>
       ...
       <tr><td class="ColumnBackground" colspan="2">&nbsp;Amount Deductable from MLI, if any</td>
           <td class="ColumnBackground" colspan="2">&nbsp;<html:text property="asfDeductableforTC" name="cpTcDetailsForm" value="<%=tcServiceFee%>" onblur="calculatePsTotal()"  maxlength="10" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/></td>
           <td class="ColumnBackground" colspan="2">&nbsp;<html:text property="asfDeductableforWC" name="cpTcDetailsForm" value="<%=wcServiceFee%>" onblur="calculatePsTotal()"  maxlength="10" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/></td>
          <td class="ColumnBackground" colspan="2" id="servicefee">&nbsp;<html:text name="cpTcDetailsForm" property="servicefee" value="<%=totalServiceFee%>"/></td>
      </tr>
...
<!--		<tr > 
		...
		<tr> 
		  ...
		  <td class="TableData" colspan="8"> <div align="left"> &nbsp;<html:text property="totalAmntPayableNow" name="cpTcDetailsForm" maxlength="16" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" value="<%=(totalFirstInstalment-totalServiceFee)%>"/></div></td>
		</tr>		
