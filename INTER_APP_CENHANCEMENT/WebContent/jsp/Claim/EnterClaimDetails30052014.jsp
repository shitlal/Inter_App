  		...
  		<table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr colspan="3"> 
		    		  ...
		    		  <td class="ColumnBackground">&nbsp;<!-- <bean:message key="uploadfile"/> --></td>
 		    		  <td class="TableData">&nbsp;<!-- <html:file property="recallnoticefilepath" name="cpTcDetailsForm" disabled="true"/> -->
					  </td>
                  </tr>  
				<tr>
				...
				<tr>
				                   <!-- <td colspan="3" class="SubHeading">
									<table width="100%" border="0" cellspacing="1" cellpadding="0"> -->
				  					...
				  					<tr>
										<td class="ColumnBackground">&nbsp;<bean:message key="suit/caseregnumber"/><font color="#FF0000" size="2">*</font></td>
				  						<td class="TableData">						
											<html:text property="caseregnumber" name="cpTcDetailsForm" maxlength="18" onkeypress="return decimalOnly(this, event,13)" onchange="checkSuitNumber(this);"/>
										</td>
									...
									<TR colspan="3">
										<td class="ColumnBackground">&nbsp;Attachment(Legal/suit file)<font color="#FF0000" size="2">*</font></td>
										<td class="TableData" colspan="3">
                    ...
                    <td colspan="8" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  					  ...
  					  <tr>					  
						  ...
						  <%
  						  ...
  						  %>
  						  <html:text property="<%=dsbrsmntamt%>" maxlength="10" size="10" name="cpTcDetailsForm" onchange="calOutstanding(this);" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/><!-- <img src="images/CalendarIcon.gif" width="20" onClick="showCalendar('cpTcDetailsForm.<%=dsbrsmntdt%>')" align="center"> -->
