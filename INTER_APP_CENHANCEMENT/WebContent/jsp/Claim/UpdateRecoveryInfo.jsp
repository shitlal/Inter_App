...
<!--      <marquee scrollamount="3" style="background:#F6D8CE" >1) If bymistake you have made entry of incorrect claim ref no. then do not select checkbox of that claim ref no. , System will auto ignore it. 2)If you are facing any challange in this recovery module then kindly mail on support@cgtmse.in. </marquee>-->
  ...
  <tr>
	  <td>
	    <table id="tblRecoveryDetails" width="100%" border="1" align="left" cellpadding="0" cellspacing="0" >    
		</table>
	  </td>
  </tr>
   ...
   <tr>  
	   <td>
	    	...
	    	<tr>
	   		 	<td align="right"">				
	    			<html:button styleClass="button"  property="totalAmountToDisplayBtn" value="Show Total Remitted Amount" onclick="calculateTotalRemmitedAmount()"/>
	    			Total Remitted Amount :- <html:text name="claimRecoveryForm" property="totalAmountToDisplay"  />          ---
	    		</td>	    	 
			</tr>
			</table>
	  </td>   
		...
		<td>
  			<table id="RTGS_NEFT" width="80%" border="0" align="center" cellpadding="0" cellspacing="0" >
				...
				<tr>
					...
					<td class="TableDataRecovery" ><html:text name="claimRecoveryForm" property="utrNumber" maxlength="22"  /></td>
				</tr>
			</table> 
		</td>
	</tr>
	...
	<td>
		<table id="DDTable"  width="80%" border="0" align="center" cellpadding="0" cellspacing="0" >
			 ...
			 <tr>
				...
				<td class="TableDataRecovery" align="left" ><html:text name="claimRecoveryForm" property="instrumentNumber" maxlength="6"  /></td>
...
<tr>
	<td>
		...
		<td> <font color=""><b>Instructions : -</b></font></td>
			...
			<tr>
			<td> <font color=""><b>2.</b></font> <font color="red">Cases where 1st installment of claim has not been settled , in the New/Additional Recovery column , MLI should feed the "Total Recovery Amount"=old recovery(as indicated in the claim form)+new/Additional recovery(if any)", Tick the pay check box & save the data.  
		   			</font></td>
			</tr>
		</table>
   </td>
