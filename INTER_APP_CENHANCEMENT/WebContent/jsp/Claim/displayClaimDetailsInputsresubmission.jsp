...
<% 
session.setAttribute("CurrentPage","displayClaimDetailsInputsresubmission.do?method=displayClaimDetailsInputsresubmission");
%>
<body topmargin="0">
<html:errors />
...
<a href="javascript:submitForm('getClaimDetailForClmRefNoResub.do?method=getClaimDetailForClmRefNoResub')">
