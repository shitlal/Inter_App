  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">    
  		...
  		<table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr>
						<td class="ColumnBackground"> <div align="left">&nbsp;Wilful defaulter<font color="#FF0000" size="2">*</font></div></td> 
						 <td class="TableData" colspan="3"> <div align="left"> &nbsp;
							<html:radio name="cpTcDetailsForm" property="wilfullDefaulter" value="Y" >kk<bean:message key="yes"/></html:radio>
    ...
    <tr> 
        ...
        <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
          <div>
            <div align="center">
            <a href="javascript:submitForm('updateFirstClaimsPageDetailsResub.do?method=addFirstClaimsPageDetailsResub')"><img src="images/Next.gif" alt="Submit" width="49" height="37" border="0"></a>
