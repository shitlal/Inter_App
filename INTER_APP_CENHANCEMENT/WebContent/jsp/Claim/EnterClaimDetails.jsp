...
//function disableAllClaimLegDetails(flag)
function disableAllClaimLegDetails(flag)
{

	
	alert("Reconfirm the statement as false declaration will lead to rejection of the case ");
 //alert(flag);
	...
	if(flag == 'Y'){
		 ...
		 document.forms[0].forumthrulegalinitiated.value ="";
	...
	//	 document.forms[0].assetPossessionDate.disabled = true;
		  ...
		  //  document.forms[0].caseregnumber.value = '333';
		   // findObj("caseregnumber").value ='666';
			//document.forms[0].caseregnumber.disabled = true;
		//findObj("reasonForFilingSuit").value ='test';
			document.forms[0].reasonForFilingSuit.value ="";
			//findObj("reasonForFilingSuit").value =' kk ';
			document.forms[0].location.value ="";
			document.forms[0].assetPossessionDate.value ="";
			//findObj("amountclaimed").value ='100';
			document.forms[0].amountclaimed.value ="";
			document.forms[0].legaldate.value ="";
...
//function disableAllClaimLegDetails(flag)
function enableAllClaimLegDetails(flag)
{
// alert(flag);
	...
	if(flag == 'N'){
		...
		function onOffFields(){
			...
			document.forms[0].commHeadedByOfficerOrAbove[1].checked = true;
   ...
   function getGSTValue()	{
    ...
    {		 
      var url = "getGSTByStateCodeForClam.do?method=getGstNoForClaim&stateCode="+stateCode;	
...
/*
	...
	function getGSTValue()	{
		...
		xhr.setRequestHeader('If-Modified-Since', 'Thu, 15 Dec 1987 00:00:00 GMT');
    ...
    <tr> 
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
  		...
  		<table width="100%" border="0" cellspacing="1" cellpadding="0">
                  ...
                  <tr> 
                    <td colspan="4" class="SubHeading"><br><div align="center"><bean:message key="subheading4"/></div><br><br></td>
                  </tr>
                  <tr> 
              ...
              <!-- End 23062017 -->              
                 ...
                 <!-- <tr> 
                  ...
                  <tr> 
                   <td class="ColumnBackground"> <div align="left">&nbsp;<bean:message key="eMail"/></div></td>
                    <td class="TableData"> <div align="left"> &nbsp;<bean:write property="memberDetails.email" name="cpTcDetailsForm"/></div></td>
                    <!--   <td class="ColumnBackground"> <div align="left">&nbsp;<bean:message key="branchCode"/></div></td>
                    <td class="TableData"> <div align="left"> &nbsp;<html:text property="mliBranchCode" size="20" alt="Branch Code" name="cpTcDetailsForm" maxlength="10" /></div></td>
                -->
                  </tr>
                  <tr> 
                   <td class="ColumnBackground"> <div align="left">&nbsp;<bean:message key="telephone"/></div></td>
                    <td class="TableData"> <div align="left"> &nbsp;<bean:write property="memberDetails.telephone" name="cpTcDetailsForm"/>	</div></td>
                    <!-- Added for GST by Kailash -->                    
                    <td class="ColumnBackground"> <div align="left">&nbsp;<bean:message key="branchState"/></div></td>
                    ...
                    <html:select property="gstState" styleId="stateCode" onchange="return getGSTValue();">
				                            ...
				                            <html:optionsCollection name="cpTcDetailsForm" property="branchStateList" label="stateName" value="stateCode" />
				                        </html:select></div></td>
                  </tr>
                  <tr> 
                  <td class="ColumnBackground"> <div align="left">&nbsp;Dealing Officer Name<font color="#FF0000" size="2">*</font></div></td>
                    <td class="TableData"> <div align="left"> &nbsp;
					 ...
					 <!-- Added for GST by Kailash -->
                      <td class="ColumnBackground"> <div align="left">&nbsp;<bean:message key="gstlable"/></div></td>
                    <td class="TableData"> <div align="left"> &nbsp;<input type="text" id="gstNo"  name="gstNo" readonly style="color: red; background:#C4DEE6"></div></td>
                  </tr>
				...
				<tr>
  				...
  				<% session.setAttribute("CurrentPage","proceedFromRecoveryFilterPage.do?method=proceedFromRecoveryFilterPage");
 Object ksr=(Object)session.getAttribute("conditnPassedVal");

 Integer kkkk=(Integer)ksr;
 
 

              
                   if(kkkk.intValue()==1)  { %>
                  <TR><td class="ColumnBackground">&nbsp;As per circular 62, waiver of legal action is applicable to only those cases where  guaranteed amount is less than or equal to Rs.50000 and sanctiond date is on or  after 01-01-2013</TD> <td colspan="4" class="ColumnBackground"></td><td class="ColumnBackground"></td></TR>
                 
                  <TR colspan="3">
										<td class="ColumnBackground">&nbsp;Whether an Executive Committee of the MLI headed by an officer not below the rank of General Manager has examined the account and decision for not initiating legal action and filing of claim under the scheme has been taken <font color="#FF0000" size="2">*</font></td>
										<TD colspan="3" class="tableData" colspan="3">
										<html:radio name="cpTcDetailsForm" value="Y" property="commHeadedByOfficerOrAbove" onclick="disableAllClaimLegDetails('Y');" ><bean:message key="yes"/></html:radio>&nbsp; 
										<html:radio name="cpTcDetailsForm" value="N" property="commHeadedByOfficerOrAbove"  onclick="enableAllClaimLegDetails('N');"   ><bean:message key="no" /></html:radio>
									</TD>
									</TR>
                    <%} %>
					<% session.setAttribute("CurrentPage","proceedFromRecoveryFilterPage.do?method=proceedFromRecoveryFilterPage");
 Object raj=(Object)session.getAttribute("conditnPassedVal");

 Integer rrrr=(Integer)raj;
                   ...
                   if(rrrr.intValue()==3)  { %>
                  <TR><td class="ColumnBackground">&nbsp;As per circular 62, waiver of legal action is applicable to only those cases where  Npa Outstanding  amount is less than or equal to Rs.50000 and sanctiond date is on or  after 01-01-2013</TD> <td colspan="4" class="ColumnBackground"></td><td class="ColumnBackground"></td></TR>
				...
				<tr>
				                   <!-- <td colspan="3" class="SubHeading">
									...
									<tr>
										<td class="ColumnBackground">&nbsp;Date of possession of assets under sarfaesi act<font color="#FF0000" size="2">*</font></td>
				  						<td class="TableData" colspan="3">
											...
											<img src="images/CalendarIcon.gif"  alt="" width="20" onClick="showCalendar('cpTcDetailsForm.assetPossessionDate')" align="center" id="assetPossessionDateCal">
				  						</td>
				  					</tr>
				  					<tr>				                       
									...
									<TR colspan="3">
										<td class="ColumnBackground">&nbsp;Any Attachments(Legal file)<font color="#FF0000" size="2">*</font></td>
										<td class="TableData" colspan="3">
						...
						<tr>
							...
							<td class="TableData"><html:text property="subsidyDate" maxlength="10" name="cpTcDetailsForm" size="10"/><img src="images/CalendarIcon.gif" alt="" width="20" onClick="showCalendar('cpTcDetailsForm.subsidyDate')" align="center"></td>
							</logic:equal>
							<logic:notEqual name="cpTcDetailsForm" property="isSubsidyAdjustedOnDues" value="Y">
							<td class="TableData"><html:text property="subsidyDate" maxlength="10" name="cpTcDetailsForm" disabled="true" size="10"/><img src="images/CalendarIcon.gif" alt="" width="20" onClick="showCalendar('cpTcDetailsForm.subsidyDate')" align="center"></td>
							</logic:notEqual>
  	             ...
  	             <tr> 
                    ...
                    <td colspan="8" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                          ...
                          <td class="ColumnBackground" rowspan="2" width="12%"><div align="center">&nbsp;<bean:message key="cgpan"/></div></td>
                          <td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;<bean:message key="dateoflastdisbursement"/><font color="#FF0000" size="2">*</font></div></td>
						  <td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;Total Amnt Disbursed(Rs.)<font color="#FF0000" size="2">*</font></div></td>
                          <td class="ColumnBackground" colspan="2"><div align="center" >&nbsp;<bean:message key="repayments"/><font color="#FF0000" size="2">*</font></div></td>
                          <td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;<bean:message key="outstandingasondateofnpa"/><font color="#FF0000" size="2">*</font></div></td>
  						<td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;<bean:message key="outstandingstatedinthecivilsuit"/><font color="#FF0000" size="2">*</font></div></td>
  						<td class="ColumnBackground" rowspan="2"><div align="center">&nbsp;<bean:message key="osAsOnLodgementOfClaim"/><font color="#FF0000" size="2">*</font></div></td>
  					  ...
  					  <tr>
  						<td class="ColumnBackground" width="12%"><div align="center">Principal<font color="#FF0000" size="2">*</font></div></td>
  						<td class="ColumnBackground" width="12%"><div align="center"><bean:message key="interestandothercharges"/><font color="#FF0000" size="2">*</font></div></td>
  					  </tr>
  					  <% int i=1;%>
  					  ...
  					  <tr>					  
						  ...
						  <%
  						  ...
  						  %>
  						  <html:text property="<%=dsbrsmntamt%>" maxlength="10" size="10" name="cpTcDetailsForm" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" onchange="calOutstanding(this);"/><!-- <img src="images/CalendarIcon.gif" width="20" onClick="showCalendar('cpTcDetailsForm.<%=dsbrsmntdt%>')" align="center"> -->
  						  ...
  						  %>
  						  <td class="TableData"><div align="center">
  							<html:text property="<%=osAsOnNpa%>" name="cpTcDetailsForm" maxlength="16" size="10" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" readonly="true"/>
  						  </div></td>
  						  <%
  				...
  				<tr>
                    <td colspan="5" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
                        <tr>
                          ...
                          <td class="ColumnBackground" ><div align="center">&nbsp;<bean:message key="oswcasonthedateofnpa"/><font color="#FF0000" size="2">*</font></div></td>
  						<td class="ColumnBackground" ><div align="center">&nbsp;<bean:message key="oswcstatedinthecivilsuit"/><font color="#FF0000" size="2">*</font></div></td>
  						<td class="ColumnBackground" ><div align="center">&nbsp;<bean:message key="oswcasonthedateoflodgementofclaim"/><font color="#FF0000" size="2">*</font></div></td>
  					  ...
  					  <tr>
  						  ...
  						  %>
  						   <html:text property="<%=wcAsOnNPA%>" name="cpTcDetailsForm" maxlength="16" size="10" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" readonly="true"/></div>
  						  </td>
  						  <td class="TableData"><div align="center">
  						  <%
            ...
            tcClaimEligible=tcClaimEligible1+tcClaimEligible2;
              ...
              r1 = l2 / 1000000000.0; 
               ...
               claimForm.setTestFirstInstalment(tcFirstInstallment+wcFirstInstallment);               
                ...
                <tr> 
                  ...
                  <tr> 
					...
					<TR>
						...
						<TR>
							<TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;<bean:message key="mliComment"/>
					...
					<TR>
						<TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;<bean:message key = "finAssistDetails"/>
						<font color="#FF0000" size="2">*</font>
						</TD>
					...
					<TR>
						<TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;Does the MLI propose to provide credit support to Chief Promoter/Borrower for any other project
						<font color="#FF0000" size="2">*</font>
						</TD>
						<TD class="TableData" colspan="3">
					...
					<TR>
						<TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;<bean:message key="bankFacilityProvided"/>
						<font color="#FF0000" size="2">*</font>
						</TD>
					...
					<TR>
						<TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;Does the MLI advise placing the Borrower and/or Chief Promoter under watch-List of CGTMSE
						<font color="#FF0000" size="2">*</font>
						</TD>
						<TD class="TableData" colspan="3">
                ...
                <TR>
                  <TD align="left" valign="top" class="ColumnBackground"  colspan="3">&nbsp;<bean:message key="otherRemarks"/></TD>
