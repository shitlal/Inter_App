...
<script type="text/javascript">
	...
	function getGSTValue()	{
	    ...
	    var url = "getGSTByStateCodeForResubmisionOfClam.do?method=getGstNoForClaim&stateCode="+stateCode;
...
<html:form action="updateFirstClaimsPageDetails.do?method=addFirstClaimsPageDetails" method="POST" enctype="multipart/form-data">
<html:errors />
<%
	String returnRemarks = (String)session.getAttribute("RETURNREMARKS");
	String[] rem = null;
	if(returnRemarks != null){
%>
<span class="SubHeading">&nbsp;Please correct following</span>

<%
		rem = returnRemarks.split("#");
		for(int u=0;u< rem.length;u++){
		String t = rem[u];
%>
			<li><%=t%></li>
<%		
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">    
  	             ...
  	             <tr> 
                    ...
                    <td colspan="8" class="SubHeading"><table width="100%" border="0" cellspacing="1" cellpadding="0">
  					  ...
  					  <tr>
  						...
  						<td class="ColumnBackground" width="15%" readonly="true"><div align="center"><bean:message key="interestandothercharges"/><font color="#FF0000" size="2">*</font></div></td>
  					  </tr>
  					  <% int i=1;%>
  					  ...
  					  <tr>					  
  						  ...
  						  <html:text property="<%=dsbrsmntdt%>" maxlength="10" size="10" readonly="true" name="cpTcDetailsForm"/><!-- <img src="images/CalendarIcon.gif" width="20" onClick="showCalendar('cpTcDetailsForm.<%=dsbrsmntdt%>')" align="center"> -->
  						  </div></td>
						  <td class="TableData"><div align="center">
  						  <%
						  ...
						  <%
  						  ...
  						  %>
  						  <html:text property="<%=dsbrsmntamt%>" maxlength="10" size="10"  readonly="true"name="cpTcDetailsForm" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" onchange="calOutstanding(this);"/><!-- <img src="images/CalendarIcon.gif" width="20" onClick="showCalendar('cpTcDetailsForm.<%=dsbrsmntdt%>')" align="center"> -->
  						  ...
  						  %>
  						  <td class="TableData"><div align="center">
  							<html:text property="<%=principal%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" onchange="calOutstanding(this);"/>
  						  </div></td>
  						  <%
  						    interestCharges="tcInterestCharge(key-"+i+")";
  						  %>
  						  <td class="TableData"><div align="center">
  							<html:text property="<%=interestCharges%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/>
  						  </div></td>
  						  <%
  						   osAsOnNpa="tcOsAsOnDateOfNPA(key-"+i+")";
  						  %>
  						  <td class="TableData"><div align="center">
  							<html:text property="<%=osAsOnNpa%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)" readonly="true"/>
  						  </div></td>
  						  <%
  						   osAsStatedinCivilSuit="tcOsAsStatedInCivilSuit(key-"+i+")";
  						  %>
  						  <td class="TableData"><div align="center">
  							<html:text property="<%=osAsStatedinCivilSuit%>" maxlength="16" size="10" readonly="true" name="cpTcDetailsForm" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/>
  						  </div></td>
  						  <%
  						  ...
  						  <td class="TableData"><div align="center">
  							...
  							<html:text property="<%=osAsOnLodgementOfClm%>" name="cpTcDetailsForm" maxlength="16" size="10" readonly="true" onkeypress="return decimalOnly(this, event,13)" onkeyup="isValidDecimal(this)"/>
    ...
    <tr> 
        ...
        <td colspan="2" valign="bottom" background="images/TableBackground3.gif"> 
          <div>
            <div align="center">
            <a href="javascript:submitForm('updateFirstClaimsPageDetails.do?method=addFirstClaimsPageDetails')"><img src="images/Next.gif" alt="Submit" width="49" height="37" border="0"></a>
