...
public class Validator_2021 implements Serializable {
	...
	public static boolean verifyBankTypeAndApproveLoanAmountForWcEnhancement(String loanType, String creditGuaranteed,
			...
			String classificationofMLI,String classificationofMLISFC) {
		...
		try {
			...
			if (validationFlag == true) {
				...
				if (classificationofMLI != null) {
					...
					if (((classificationofMLI.equals("SFC")) || (classificationofMLI == "SFC"))
							&& (totalAmount > rrbValue)) {
						// System.out.println("classificationofMLI RRB
						// totalAmount"+totalAmount );
						resultFlag = false;
	...
	public static boolean validatePromoterMobileNo(Object bean, ValidatorAction validAction, Field field,
		...
		if (proMobileNo == null || proMobileNo == 0) {
	...
	public static boolean checkEntryField(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		Double creditNonFundBased = new Double(ValidatorUtil.getValueAsString(bean, creditNonFundBasedVal));
		...
		Double wcFundBasedCommission = new Double(ValidatorUtil.getValueAsString(bean, wcFundBasedCommissionVal));
		...
		if (wcFundBasedSanctionedValue != 0.0D) {
			...
			if (creditFundBasedValue != 0.0D && wcNonFundBasedSanctionedValue != 0.0D
		...
		if (session.getAttribute("APPLICATION_TYPE_FLAG") != null
				&& (session.getAttribute("APPLICATION_TYPE_FLAG").equals("9")
						...
						|| (session.getAttribute("APPLICATION_TYPE_FLAG").equals("18")
								|| session.getAttribute("APPLICATION_TYPE_FLAG").equals("19")) && (session
										.getAttribute("APPLICATION_LOAN_TYPE").equals("WC")
			...
			if (osNonFBPplValue != 0.0D) {
				...
				} else if (wcNonFundBasedSanctionedValue != 0.0D && osNFBAsOnDateValue.equals("")) {
	...
	public static boolean checkCoveredValue(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		if (cgtsiCoveredValue.equals("Y")) {
			...
			DynaActionForm dynaForm = (DynaActionForm) bean;
			/* String cpITPAN = (String) dynaForm.get("cpITPAN"); */ // Diksha..................
			/*
			 * if (cpITPAN == null || cpITPAN.equals("")) { error = new
			 * ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 */
			ActionError error = null;
			...
			// //Diksha.......................................
			if ((dynaForm.get("constitution") == null || dynaForm.get("constitution").equals("")
					|| dynaForm.get("constitution").equals("Others"))
					&& (dynaForm.get("constitutionOther") == null || dynaForm.get("constitutionOther").equals(""))) {
			...
			/*
			 * else { ======Added By DKR======= String constituition = (String)
			 * dynaForm.get("constitution"); String firstItpan = (String)
			 * dynaForm.get("firstItpan"); String secondItpan = (String)
			 * dynaForm.get("secondItpan"); String firstName = (String)
			 * dynaForm.get("firstName"); String secondName = (String)
			 * dynaForm.get("secondName"); String firmITPan = (String)
			 * dynaForm.get("ssiITPan"); double creditGuaranteed = (Double)
			 * dynaForm.get("creditGuaranteed"); Date firstDOB = (Date)
			 * dynaForm.get("firstDOB"); String firstDob = firstDOB.toString();
			 * Date secondDOB = (Date) dynaForm.get("secondDOB"); String
			 * secondDob = secondDOB.toString();
			 * System.out.println("CreditGuaranteed =="+creditGuaranteed);
			 * //boolean itPanFlag=false; if(creditGuaranteed>=5000000.0D){
			 * itPanFlag=true; }//creditFundBased
			 * 
			 * if (("Proprietary/Individual".equals(constituition)&&
			 * itPanFlag)||"Proprietary/Individual".equals(constituition)) { if
			 * (cpITPAN == null || cpITPAN.equals("")) { cpItPanFlag = true;
			 * error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[pP]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN); if
			 * (!matcher.matches()) { error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 * 
			 * } else if(("Partnership".equals(constituition)&&
			 * itPanFlag)||"Partnership".equals(constituition)) { if (cpITPAN ==
			 * null || cpITPAN.equals("")) { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN); if
			 * (!matcher.matches()) { error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 * if (firmITPan == null || firmITPan.equals("")) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("firmITPanRequired")); error = new
			 * ActionError("firmITPanRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(firmITPan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("firmITPanInvalid");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("firmITPanInvalid")); } }
			 * //System.out.println(creditGuaranteed+
			 * "..................creditGuaranteed"); if(itPanFlag){ if
			 * (!firstItpan.trim().equals("")) { Pattern pattern =
			 * Pattern.compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(firstItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("firstItpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * }else{
			 * 
			 * error = new ActionError("firstItpann");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (!secondItpan.trim().equals("")) { Pattern pattern =
			 * Pattern.compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(secondItpan);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("secondItpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * }else{
			 * 
			 * error = new ActionError("secondNameITPan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (firstName == null || firstName.equals("")) {
			 * 
			 * error = new ActionError("firstNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (secondName == null || secondName.equals("")) {
			 * 
			 * error = new ActionError("secondNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("secondNamerequired"));
			 * 
			 * } if (!(firstItpan == null || firstItpan.equals("")) &&
			 * !(secondItpan == null || secondItpan.equals(""))) { if
			 * (firstItpan.equals(secondItpan)) {
			 * 
			 * error = new ActionError("firstsecondItPanIdentical");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * }
			 * 
			 * } if (firstDob == null || firstDob.equals("")) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobfirstNamerequired")); error = new
			 * ActionError("dobfirstNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { // before or equals today if (validDateFormat(firstDob))
			 * {
			 * 
			 * } else { // errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * // new ActionError("dobfirstNameInvalid")); error = new
			 * ActionError("dobfirstNameInvalid");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } } if (secondDob == null || secondDob.equals("")) { error = new
			 * ActionError("dobsecondNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNamerequired")); } else { if
			 * (validDateFormat(secondDob)) {
			 * 
			 * } else { error = new ActionError("dobsecondNameInvalid");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } }
			 * 
			 * 
			 * } else
			 * if(("Limited liability Partnership".equals(constituition)&&
			 * itPanFlag)||"Limited liability Partnership".equals(constituition)
			 * ) { if (!cpITPAN.trim().equals("")) { Pattern pattern = Pattern
			 * .compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { error = new ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("cpITPAN")); } } if(itPanFlag){ if
			 * (!firstItpan.trim().equals("")) { Pattern pattern =
			 * Pattern.compile(
			 * "[a-zA-Z]{3}[fF]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(firstItpan);
			 ...
			 * (firstItpan.equals(secondItpan)) { //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("firstsecondItPanIdentical")); error = new
			 * ActionError("firstsecondItPanIdentical");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * }
			 * 
			 ...
			 * ActionError("dobsecondNameInvalid")); } } }
			 * 
			 * } else if(("private".equals(constituition)&&
			 * itPanFlag)||"private".equals(constituition)) { if (cpITPAN ==
			 * null || cpITPAN.equals("")) { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[cC]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * 
			 * Matcher matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 * } else { // errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * // new ActionError("cpITPAN")); error = new
			 * ActionError("cpITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } } if(itPanFlag){ if (!firstItpan.trim().equals("")) { Pattern
			 ...
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } } } else
			 * if(("public".equals(constituition)&&
			 * itPanFlag)||"public".equals(constituition)) { //if
			 * ("public".equals(constituition)) { if (cpITPAN == null ||
			 * cpITPAN.equals("")) { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else { Pattern pattern = Pattern .compile(
			 ...
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } } } else
			 * if(("HUF".equals(constituition)&&
			 * itPanFlag)||"HUF".equals(constituition)) { //if
			 * ("HUF".equals(constituition)) { if (cpITPAN == null ||
			 * cpITPAN.equals("")) { cpItPanFlag = true; error = new
			 * ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[hH]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 ...
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } } } else
			 * if(("Trust".equals(constituition)&&
			 * itPanFlag)||"Trust".equals(constituition)) { //if
			 * ("Trust".equals(constituition)) { if (cpITPAN == null ||
			 * cpITPAN.equals("")) { cpItPanFlag = true; //
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			 * 
			 * } else { Pattern pattern = Pattern .compile(
			 * "[a-zA-Z]{3}[tT]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 ...
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR", // new
			 * ActionError("dobsecondNameInvalid")); } } } } else
			 * if(("Society/Co op".equals(constituition)&&
			 * itPanFlag)||"Society/Co op".equals(constituition)) {
			 * 
			 * if (!cpITPAN.trim().equals("")) { Pattern pattern = Pattern
			 * .compile(
			 * "[a-zA-Z]{3}[abAB]{1}[a-zA-Z]{1}(?!0{4})[0-9]{4}[a-zA-Z]{1}");
			 * Matcher matcher = pattern.matcher(cpITPAN);
			 * 
			 * if (matcher.matches()) {
			 * 
			 ...
			 * if (cpItPanFlag) {
			 * 
			 * } else if(itPanFlag){ if (cpITPAN == null || cpITPAN.equals(""))
			 * {
			 * 
			 * // errors.add("org.apache.struts.action.GLOBAL_ERROR",new //
			 * ActionError("cpitpan")); error = new ActionError("cpitpan");
			...
			if (dynaForm.get("cpITPAN") == null || dynaForm.get("cpITPAN").equals(""))
				if (dynaForm.get("loanType").equals("TC")) {
					...
					if (((Double) dynaForm.get("termCreditSanctioned")).doubleValue() >= minAmount) {
					...
					if (((Double) dynaForm.get("termCreditSanctioned")).doubleValue()
							+ ((Double) dynaForm.get("wcFundBasedSanctioned")).doubleValue()
							+ ((Double) dynaForm.get("wcNonFundBasedSanctioned")).doubleValue() >= minAmount) {
						Log.log(4, "Validator", "checkSubsidyName", "ITPAN is not entered");
						error = new ActionError("errors.required", "Chief Promoter ITPAN");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					}
			...
			if (dynaForm.get("cpITPAN") != null && !dynaForm.get("cpITPAN").equals("")) {
				...
				if (array1.length == 10 && Character.isLetter(array1[0]) && Character.isLetter(array1[1])
						...
						&& Character.isLetter(array1[4]) && Character.isDigit(array1[5]) && Character.isDigit(array1[6])
			...
			/*
			 * DynaActionForm dynaForm = (DynaActionForm) bean; if
			 * ((dynaForm.get("constitution") == null ||
			 * dynaForm.get("constitution").equals("") || dynaForm.get(
			 * "constitution").equals("Others")) &&
			 * (dynaForm.get("constitutionOther") == null || dynaForm
			 * .get("constitutionOther").equals(""))) { Log.log(4, "Validator",
			 * "checkConstitution", "constituitionOther is not entered");
			 * ActionError error = new ActionError("constituitionRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("state") == null ||
			 * dynaForm.get("state").equals("")) { ActionError error = new
			 * ActionError("errors.required", "State");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("city") == null || dynaForm.get("city").equals(""))
			 * { ActionError error = new ActionError("errors.required", "City");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * ((dynaForm.get("district") == null ||
			 * dynaForm.get("district").equals("") || dynaForm.get(
			 * "district").equals("Others")) && (dynaForm.get("districtOthers")
			 * == null || dynaForm.get( "districtOthers").equals(""))) {
			 * Log.log(4, "Validator", "checkDistrict",
			 * "Distict Other is not entered"); ActionError error = new
			 * ActionError("districtRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("ssiType") == null ||
			 * dynaForm.get("ssiType").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Unit Type");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("ssiName") == null ||
			 * dynaForm.get("ssiName").equals("")) { ActionError error = new
			 * ActionError("errors.required", "SSI Name");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("employeeNos") == null ||
			 * dynaForm.get("employeeNos").equals("")) { ActionError error = new
			 * ActionError("errors.required", "noOfEmployees");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("projectedSalesTurnover") == null ||
			 * dynaForm.get("projectedSalesTurnover").equals("")) { ActionError
			 * error = new ActionError("errors.required", "turnover");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("projectedExports") == null ||
			 * dynaForm.get("projectedExports").equals("")) { ActionError error
			 * = new ActionError("errors.required", "exports");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("activityType") == null ||
			 * dynaForm.get("activityType").equals("")) { ActionError error =
			 * new ActionError("errors.required", "Activity Type");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("address") == null ||
			 * dynaForm.get("address").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Unit Address");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("pincode") == null ||
			 * dynaForm.get("pincode").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Pincode");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpTitle") == null ||
			 * dynaForm.get("cpTitle").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Promoter Title");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpFirstName") == null ||
			 * dynaForm.get("cpFirstName").equals("")) { ActionError error = new
			 * ActionError("errors.required", "Chief Promoter First Name");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpLastName") == null ||
			 * dynaForm.get("cpLastName").equals("")) { ActionError error = new
			 * ActionError("errors.required",
			 * "Chief Promoter Last Name (Surname)");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpLegalID") != null &&
			 * dynaForm.get("cpLegalID").equals("Others")) { if
			 * (dynaForm.get("otherCpLegalID") == null ||
			 * dynaForm.get("otherCpLegalID").equals("")) { Log.log(4,
			 * "Validator", "checkLegalId", "Legal Id Other is not entered");
			 * ActionError error = new ActionError("legalIdRequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * else if (dynaForm.get("otherCpLegalID") != null &&
			 * !dynaForm.get("otherCpLegalID").equals("") &&
			 * (dynaForm.get("cpLegalIdValue") == null || dynaForm
			 * .get("cpLegalIdValue").equals(""))) { ActionError error = new
			 * ActionError("errors.required", "Legal Id Value");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 * else if (dynaForm.get("cpLegalID") != null &&
			 * !dynaForm.get("cpLegalID").equals("Others") &&
			 * !dynaForm.get("cpLegalID").equals("") &&
			 * (dynaForm.get("cpLegalIdValue") == null || dynaForm.get(
			 * "cpLegalIdValue").equals(""))) { ActionError error = new
			 * ActionError("errors.required", "Legal Id Value");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("subsidyName") != null &&
			 * dynaForm.get("subsidyName").equals("Others") &&
			 * (dynaForm.get("otherSubsidyEquityName") == null || dynaForm
			 * .get("otherSubsidyEquityName").equals(""))) { Log.log(4,
			 * "Validator", "checkSubsidyName", "Subsidy Name is not entered");
			 * ActionError error = new ActionError("subsidyNamerequired");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); }
			 * Administrator admin = new Administrator(); ParameterMaster
			 * parameterMaster = admin.getParameter(); double minAmount =
			 * parameterMaster.getMinAmtForMandatoryITPAN(); SimpleDateFormat
			 * dateFormat = new SimpleDateFormat("dd/MM/yyyy"); Date
			 * fixDateForITPan=null; Date appSactionDate=null; Date
			 * fundBaseDateForITPan=null; Date nonFundBaseDateForITPan=null;
			 * Date maxDateForBothLoanType=null; SortedSet<Date> dates = new
			 * TreeSet<Date>(); try { fixDateForITPan
			 * =dateFormat.parse("01/04/2016");
			 * //System.out.println("loanType is "+dynaForm.get("loanType"));
			 * if(dynaForm.get("loanType").equals("TC")) {
			 * //System.out.println("amountSanctionedDate "+dynaForm.get(
			 * "amountSanctionedDate"));
			 * if(!dynaForm.get("amountSanctionedDate").toString().trim().equals
			 * ("")) {
			 * //System.out.println("amountSanctionedDate is not blank");
			 * boolean flagAppTC=false; try {
			 * appSactionDate=dateFormat.parse(dynaForm.get(
			 * "amountSanctionedDate").toString()); } catch(Exception e) {
			 ...
			 * minAmount=500000; } else {
			 * System.out.println("loanType is TC==");} } } } else
			 * if(dynaForm.get("loanType").equals("WC")) {
			 * if((!dynaForm.get("limitFundBasedSanctionedDate").toString().trim
			 * ().equals("")) &&
			 * (!dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim
			 * ().equals(""))) { //System.out.println("WC both are not blank");
			 * boolean flagAppWC=false; try {
			 * fundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitFundBasedSanctionedDate").toString());
			 * nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception
			 * e) { flagAppWC=true; }
			 * 
			 * if(flagAppWC==false) {
			 * if(fundBaseDateForITPan.compareTo(nonFundBaseDateForITPan)==1) {
			 ...
			 * System.out.println("date is greater than or equal");
			 * minAmount=500000; } } else
			 * if(fundBaseDateForITPan.compareTo(nonFundBaseDateForITPan)==0) {
			 * if(nonFundBaseDateForITPan.compareTo(fixDateForITPan)>=0) { //
			 * System.out.println("date is greater than or equal");
			 * minAmount=500000; } } }
			 * 
			 ...
			 * nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception
			 * e) { flagAppWC=true; } //System.out.
			 * println("WC limitFundBasedSanctionedDate is blank and flagAppWC value is "
			 * +flagAppWC); if(flagAppWC==false) {
			 * if(nonFundBaseDateForITPan.compareTo(fixDateForITPan)>=0) {
			 * //System.out.println("date is greater than or equal");
			 * minAmount=500000; } } } else
			 * if((!dynaForm.get("limitFundBasedSanctionedDate").toString().trim
			 ...
			 * boolean flagAppWC=false; try {
			 * fundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitFundBasedSanctionedDate").toString()); } catch(Exception e)
			 * { flagAppWC=true; }
			 * 
			 * if(flagAppWC==false) {
			 * if(fundBaseDateForITPan.compareTo(fixDateForITPan)>=0) { //
			 ...
			 * flagAppTC=true; }
			 * 
			 * if(flagAppTC==false) { boolean flagAppBothValid=false;
			 * if((!dynaForm.get("limitFundBasedSanctionedDate").toString().trim
			 * ().equals("")) &&
			 * (!dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim
			 * ().equals(""))) { try {
			 ...
			 * nonFundBaseDateForITPan=dateFormat.parse(dynaForm.get(
			 * "limitNonFundBasedSanctionedDate").toString()); } catch(Exception
			 * e) { flagAppBothValid=true; }
			 * 
			 * if(flagAppBothValid==false) { dates.add(appSactionDate);
			 * dates.add(fundBaseDateForITPan);
			 * dates.add(nonFundBaseDateForITPan);
			 * 
			 * Date earliest = dates.last(); String BothTypeMaxDtae=
			 ...
			 * e) { flagAppBothValid=true; }
			 * 
			 * if(flagAppBothValid==false) { dates.add(nonFundBaseDateForITPan);
			 * dates.add(appSactionDate); Date earliest = dates.last(); String
			 * BothTypeMaxDtae= dateFormat.format(earliest);
			 * maxDateForBothLoanType=dateFormat.parse(BothTypeMaxDtae);
			 * 
			 * if(maxDateForBothLoanType.compareTo(fixDateForITPan)>=0) { //
			 * System.out.println("date is greater than or equal");
			 ...
			 * { flagAppBothValid=true; }
			 * 
			 * if(flagAppBothValid==false) { dates.add(fundBaseDateForITPan);
			 * dates.add(appSactionDate); Date earliest = dates.last(); String
			 * BothTypeMaxDtae= dateFormat.format(earliest);
			 * maxDateForBothLoanType=dateFormat.parse(BothTypeMaxDtae);
			 * 
			 ...
			 * ).equals("")) &&
			 * (dynaForm.get("limitNonFundBasedSanctionedDate").toString().trim(
			 * ).equals(""))) { if(appSactionDate.compareTo(fixDateForITPan)>=0)
			 * { //System.out.println("date is greater than or equal");
			 * minAmount=500000; }
			 * 
			 * 
			 ...
			 * //System.out.println("amountSanctionedDate"+dynaForm.get(
			 * "amountSanctionedDate"));
			 * //System.out.println("limitFundBasedSanctionedDate"+dynaForm.get(
			 * "limitFundBasedSanctionedDate"));
			 * //System.out.println("limitNonFundBasedSanctionedDate"+dynaForm.
			 * get("limitNonFundBasedSanctionedDate")); if
			 * (dynaForm.get("cpITPAN") == null ||
			 * dynaForm.get("cpITPAN").equals("")) if
			 * (dynaForm.get("loanType").equals("TC")) {
			 * 
			 * 
			 * 
			 ...
			 * 
			 * //System.out.println("Chief Promoter ITPAN"); Log.log(4,
			 * "Validator", "checkSubsidyName", "ITPAN is not entered");
			 * ActionError error = new ActionError("errors.required",
			 * "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 * else if (dynaForm.get("loanType").equals("CC") ||
			 * dynaForm.get("loanType").equals("BO")) { if (((Double)
			 * dynaForm.get("termCreditSanctioned")) .doubleValue() + ((Double)
			 * dynaForm.get("wcFundBasedSanctioned")) .doubleValue() + ((Double)
			 * dynaForm .get("wcNonFundBasedSanctioned")) .doubleValue() >=
			 * minAmount) { Log.log(4, "Validator", "checkSubsidyName",
			 * "ITPAN is not entered"); ActionError error = new
			 * ActionError("errors.required", "Chief Promoter ITPAN");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } }
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", error); } if
			 * (dynaForm.get("cpITPAN") != null &&
			 * !dynaForm.get("cpITPAN").equals("")) { String itpan = (String)
			 * dynaForm.get("cpITPAN"); boolean itpanCheck = false; char
			 * array1[] = itpan.toCharArray(); if (array1.length == 10 &&
			 ...
			 * itpanCheck = true; } else { Log.log(4, "Validator",
			 * "checkSubsidyName", "ITPAN is not entered"); itpanCheck = false;
	...
	public static boolean checkEnhanceEntry(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		if (enhancedRenewFBValue == 0.0D && enhancedRenewNFBValue == 0.0D) {
			...
			if (enhancedRenewFBValue != 0.0D) {
				if (enhancedrenewFBInterestValue == 0.0D || enhancedrenewFBInterestValue == 0.0D) {
			...
			/*
			 * else if (enhancedRenewNFBValue == 0.0D &&
			 * enhancedrenewNFBComissionValue != 0.0D) {ctionError actionError =
			 * new
	...
	public static boolean checkDisburseOsEntry(Object bean, ValidatorAction validAction, Field field,
		...
		Double pplOS = new Double(ValidatorUtil.getValueAsString(bean, pplOSVal));
		...
		if (session.getAttribute("APPLICATION_TYPE_FLAG") == null
			...
			if ((session.getAttribute("APPLICATION_TYPE_FLAG").equals("3")
				...
				if (pplOsAsOnDateValue != null && !pplOsAsOnDateValue.equals("")) {
					pplOsdateValue = true;
					try {
						pplOsAsOnDate = sdf.parse(pplOsAsOnDateValue, new ParsePosition(0));
				...
				if (firstdateValue && pplOsdateValue && !GenericValidator.isBlankOrNull(pplOsAsOnDateValue)
				...
				if (pplOSValue == 0.0D) {
					...
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				} else if (pplOSValue != 0.0D && GenericValidator.isBlankOrNull(pplOsAsOnDateValue)) {
	...
	*/}
	...
	public static boolean checkInstallmentEntry(Object bean, ValidatorAction validAction, Field field,
		...
		if (session.getAttribute("APPLICATION_TYPE_FLAG") != null
				&& (session.getAttribute("APPLICATION_TYPE_FLAG").equals("8")
						...
						|| (session.getAttribute("APPLICATION_TYPE_FLAG").equals("14")
								|| session.getAttribute("APPLICATION_TYPE_FLAG").equals("19")) && (session
										.getAttribute("APPLICATION_LOAN_TYPE").equals("TC")
										|| session.getAttribute("APPLICATION_LOAN_TYPE").equals("CC")
										|| session.getAttribute("APPLICATION_LOAN_TYPE").equals("BO")))
				&& installmentValue == 0) {
	...
	public static boolean checkLegalForumName(Object bean, ValidatorAction validAction, Field field,
		...
		if (headedByOfficer != null) {
			...
			/*
			 * if(stringDate.compareTo(legaldate) > 0) { ActionError actionError
			 * = new ActionError("npaDateNotAfterTodaysDat");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			 * }
			 */
			...
			/*
			 * if((stringDate.compareTo(legaldate)) > 0) { ActionError
			 * actionError = new ActionError("npaDateNotAfterTodaysDat");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			 * }
			 * 
			 * if((legaldate.compareTo(stringDate)) > 0) { ActionError
			 * actionError = new ActionError("npaDateNotAfterTodaysDat");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			 * }
			 */
			...
			/*
			 * String forumName1 = claimForm.getForumthrulegalinitiated();
			 * String assetDt1 = claimForm.getAssetPossessionDate(); String
			 * assetDtStr1 = ValidatorUtil.getValueAsString(bean,
			 * "assetPossessionDate"); SimpleDateFormat sdf1 = new
			 * SimpleDateFormat("dd/MM/yyyy"); Date dt = sdf1.parse(assetDt1);
			 * HashMap npaDetails1 = claimForm.getNpaDetails(); String npaDtStr1
			 * = (String)npaDetails.get("NPAClassifiedDate"); Date npaDt1 =
			 * null; Date legalDt1 = null; try {
			 * if("Securitisation Act, 2002".equals(forumName1)) {
			 * if(!GenericValidator.isBlankOrNull(npaDtStr1)) npaDt1 =
			 * sdf1.parse(npaDtStr);
			 ...
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			 * } if(!GenericValidator.isBlankOrNull(assetDtStr1) &&
			 * npaDt1.compareTo(dt) > 0) { ActionError actionError = new
			 * ActionError("assetPossessionDate");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			 * } } } catch(NumberFormatException numberFormatException) {
			 * ActionError actionError = new ActionError("errors.date");
			 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
	...
	public static boolean validateFromCurrentDates(Object bean, ValidatorAction validAction, Field field,
		...
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		String stringDate = dateFormat.format(currentDate);
		if (!GenericValidator.isBlankOrNull(fromValue) && DateHelper.compareDates(fromValue, stringDate) != 0
				&& DateHelper.compareDates(fromValue, stringDate) != 1) {
			ActionError actionError = new ActionError(
					(new StringBuilder()).append("currentDate").append(fromString).toString());
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
	...
	public static boolean validateFromNPACurrentDatesNew(Object bean, ValidatorAction validAction, Field field,
		...
		try {
			...
			/*
			 * if (tenureAppprvedDate!=null &&
			 * (npaDate.compareTo(tenureAppprvedDate) <= 0)) { //NpaTenDate
			 * ActionError actionError = new
			 * ActionError("NpaTenDate",dateFormat.format(tenureAppprvedDate));
			 * 
			...
			if (!(GenericValidator.isBlankOrNull(fromValue))) {
				...
				//Anand
				//System.out.println("newNpaDate==="+newNpaDate);
				User user = (User) session.getAttribute(userId);
				java.util.Date npaDate1 = (java.util.Date) gmPeriodicInfoForm.get("npaDt");
				String bankId = user.getBankId();
				System.out.println("bankId=="+bankId);
				System.out.println("npaDate1=="+npaDate1);
				System.out.println("fromdate=="+(npaDate1.compareTo(new Date("01/04/2020")) > 0));
				System.out.println("Todate=="+(npaDate1.compareTo(new Date("30/06/2020"))< 0));
				
				//java util date compaire'
				//&& (npaDate1.compareTo(new Date("01/04/2020")) > 0)&& (npaDate1.compareTo(new Date("30/06/2020")) < 0)
				if((bankId.equals("0001") || bankId.equals("0029"))&& (npaDate1.compareTo(new Date("01/04/2020")) > 0 && npaDate1.compareTo(new Date("30/06/2020")) < 0)){
					
					//01/03/2020
					System.out.println("Bank is  0001 and 0029");
				}else if(npaDate1.compareTo(new Date("01/04/2020")) < 0 || npaDate1.compareTo(new Date("30/06/2020")) > 0){
			...
			if (!tennureRemark.equals("Reschedulement_Rephasement") && tennureStatus.equals("AP")
					&& tennureDAte.compareTo(npaDate) > 0) {
				ActionError actionError = new ActionError("NpaTennureDate");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}
			if (!tennureRemark.equals("Reschedulement_Rephasement") && tennureStatus.equals("EX")
					&& tennureDAte.compareTo(npaDate) > 0) {
				ActionError actionError = new ActionError("NpaTennureDate");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}
			...
			// System.out.println("validateFromNPACurrentDatesNew called
			// actionError "+actionError.getKey());
			// System.out.println("validateFromNPACurrentDatesNew called
			// actionError "+actionError.getValues());
			// System.out.println(fromString+"validateFromNPACurrentDatesNew
			// called actionError "+actionError);
			errors.add(ActionErrors.GLOBAL_ERROR, actionError);
	...
	public static boolean validateRequiredFields(Object bean, ValidatorAction validAction, Field field,
		...
		String gstNo = (String) newNpaForm.get("gstNo");
		if (gstNo == "") {
	...
	public static boolean validateDates(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		try {
			...
			// System.out.println("validateDates called actionError
			// "+actionError.getKey());
			// System.out.println("validateDates called actionError
	...
	public static boolean checkInterestRateForWCEnhancement(Object bean, ValidatorAction validAction, Field field,
		  ...
		  DynaValidatorActionForm dynaForm = (DynaValidatorActionForm)bean;
	        ...
	        if("enhancedFBInterest".equals(interestRateFiled))
	        {
	            ...
	            if(!"".equals(dynaForm.get("cgbid")))
	                baseRate = objAdminDAO.fetchOldOLDBaseRate((String)dynaForm.get("cgbid"));
	            message = "Enhancement Date ";
	        }
	        try
	        {
	            if(loanType.equalsIgnoreCase("wc") && !"".equals(renewalEnhancementDate) && !validatedateSanctionDate(renewalEnhancementDate) && interestRate > baseRate + 4D)
	            {
	                ActionError error = new ActionError("baseRateAndInterestRate", Double.valueOf(baseRate), Double.valueOf(interestRate));
	                errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	            }
	        }
	        catch(Exception e)
	        {
	            LogClass.StepWritterConnIssue((new StringBuilder("Exception in checkInterestRateForWCEnhancement ")).append(e.getMessage()).toString());
	            LogClass.writeExceptionOnFile(e);
	        }
	        return errors.isEmpty();
		/*DynaValidatorActionForm dynaForm = (DynaValidatorActionForm) bean;
		...
		if ("renewalFBInterest".equals(interestRateFiled)) {
			...
			interestRate = ((Double) dynaForm.get("enhancedFBInterest")).doubleValue();
			renewalEnhancementDate = (Date) dynaForm.get("enhancementDate");
			// System.out.println(loanType+"checkInterestRateForWCEnhancement
			// before wcPlr");
			if (!"".equals(dynaForm.get("cgpan"))) {
				baseRate = objAdminDAO.fetchOldOLDBaseRate((String) dynaForm.get("cgpan"));
		...
		try {
			if (loanType.equalsIgnoreCase("wc") && !"".equals(renewalEnhancementDate)) {
				...
				if (validatedateSanctionDate(renewalEnhancementDate)) {
					...
					if (interestRate > 14D) { // inserted due to cir dtd
												// 06-01-2017
						// System.out.println("if checkInterestRate
						// "+interestRate);
					...
					if (interestRate > (baseRate + 4D)) {
						ActionError error = new ActionError("baseRateAndInterestRate", baseRate, interestRate); // removed
																												// due
																												// to
																												// cir
																												// dtd
	...
	public static boolean checkInterestRate(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		try {
			 ...
			 * ActionError("baseRateAndInterestRate"); // removed due to cir dtd
			 * 06-01-2017 errors.add("org.apache.struts.action.GLOBAL_ERROR",
			 * error); }
			...
			if (loanType.equalsIgnoreCase("tc") && !("").equals(dynaForm.get("amountSanctionedDate"))) {
				...
				if (validatedateSanctionDate(funcBasedSanctionedDate)
					...
					if (interestRate > 14D) { // inserted due to cir dtd
						...
						// System.out.println("if checkInterestRate
						// "+interestRate);
						ActionError error = new ActionError("baseRateAndInterestRateNewCirfundAndNonFundbased",
				...
				if (!dynaForm.get("amountSanctionedDate").equals("")) {
					...
					if (validatedateSanctionDate(sanctionedDate)) {
						...
						if (interestRate > (baseRate + 4D)) {
							...
							// System.out.println("interestRate > baseRate + 4D
							// else =");
						}
					}
				}
	...
	*/
        ...
        try
        {
            ...
            if("limitFundBasedInterest".equals(interestRateFiled))
            {
                interestRate = ((Double)dynaForm.get("limitFundBasedInterest")).doubleValue();
                baseRate = ((Double)dynaForm.get("wcPlr")).doubleValue();
            }
            ...
            if(loanType.equalsIgnoreCase("wc") && !dynaForm.get("limitFundBasedSanctionedDate").equals("") && !dynaForm.get("limitNonFundBasedSanctionedDate").equals(""))
            {
                funcBasedSanctionedDate = (Date)dynaForm.get("limitFundBasedSanctionedDate");
                nonFuncBasedSanctionedDate = (Date)dynaForm.get("limitNonFundBasedSanctionedDate");
                if(!validatedateSanctionDate(funcBasedSanctionedDate) && !validatedateSanctionDate(nonFuncBasedSanctionedDate) && interestRate > baseRate + 4D)
                {
                    ActionError error = new ActionError("baseRateAndInterestRate", Double.valueOf(baseRate), Double.valueOf(interestRate));
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
                }
        ...
        {
            LogClass.StepWritterConnIssue((new StringBuilder("Exception in checkInterestRate ")).append(e.getMessage()).toString());
            LogClass.writeExceptionOnFile(e);
        }
        return errors.isEmpty();	
	...
	/*
	 * public static boolean recordSelectionBorrowerApprovalDecision(Object
	 * bean, ValidatorAction validAction, Field field, ActionErrors errors,
	 * HttpServletRequest request) throws Exception {
	 * 
	 ...
	 * 
	 * int i=0; // String
	 * remarksArray[]=gmActionForm.getBorrowerApprovalRemarks();
	 * //System.out.println("approveBorrowerDetails remarksArray "+remarksArray.
	 * length); boolean flag= true; while (approveFlagIterator.hasNext()) {
	 * String memBorrowerId= (String)approveFlagIterator.next(); String key =
				...
				if (loanType.equalsIgnoreCase("tc") && dynaForm.get("creditGuaranteed") != null) {
					...
					if (creditGuaranteed != null && creditGuaranteed.length() > 0) {
						...
						if (creditGuaranteed_new >= 5000000 && internalRating.equalsIgnoreCase("N")) {
							...
							// System.out.println("creditGuaranteed_new>=500000
							// else loop");
						}
					}
	...
	public static boolean checkCreditAmtAndSanctionDateForTC(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) {
		 System.out.println("checkCreditAmtAndSanctionDate1111RAJUKKKKKKKKKKKKKKKKKKK====");
		try {
			...
			if (dynaForm.get("creditGuaranteed") != null && dynaForm.get("amountSanctionedDate") != null) {
				...
				if ((Double) dynaForm.get("creditGuaranteed") > 0) {
					...
					if (dynaForm.get("creditGuaranteed") instanceof Double) {
						if (!industryNatureRetail.equals("RETAIL TRADE") && ((existingAmountCC + (Double) dynaForm.get("creditGuaranteed")) > maxApprovedAmt)) {
							//System.out.println("2crLimit..........................11 valid====RRRRRRR===");
						...
						if (flag == true && verifyBankTypeAndApproveLoanAmount("tc",
								...
								basedOnCondition, classificationofMLI,classificationofMLISFC) == false) {
						...
						if (flag == true
								&& verifyBankTypeAndApproveLoanAmount("tc", (String) dynaForm.get("creditGuaranteed"),
										"", "", bankId, basedOnCondition, classificationofMLI,classificationofMLISFC) == false) {
							ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
						}
					}
				...
				// if((Double)dynaForm.get("creditFundBased") > 0 )
				{
					...
					if (dynaForm.get("creditFundBased") instanceof Double) {
						...
						if (flag = true && verifyBankTypeAndApproveLoanAmount("wc", "",
								...
								classificationofMLI,classificationofMLISFC) == false) {
							ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
						}
	...
	public static boolean checkCreditAmtAndSanctionDateForAdditionalTC(Object bean, ValidatorAction validAction,
		...
		try {
			if (dynaForm.get("creditGuaranteed") != null && dynaForm.get("amountSanctionedDate") != null) {
				...
				if ((Double) dynaForm.get("creditGuaranteed") > 0) {
					...
					if (sanctionDateAmountValidationAll("tc", dateAndAmountDtl, basedOnCondition) == false) {
						ActionError error = new ActionError(
								(new StringBuilder()).append("creditAmountAndSanctionDateVali").toString(),
								dynaForm.get("amountSanctionedDate"), dynaForm.get("creditGuaranteed"));
						errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					...
					if (dynaForm.get("creditGuaranteed") instanceof Double) {
						...
						if ((existingAmountCC + (Double) dynaForm.get("creditGuaranteed")) > maxApprovedAmt) {
							//System.out.println("2crLimit..........................8 valid");
							ActionError error = new ActionError("2crLimit", existingAmountCC,
									(Double) dynaForm.get("creditGuaranteed"));
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
							flag = false;
						}
						...
						if ((existingAmountCC
								+ Integer.parseInt((String) dynaForm.get("creditGuaranteed"))) > maxApprovedAmt) {
							//System.out.println("2crLimit..........................1 valid");
							ActionError error = new ActionError("2crLimit", existingAmountCC,
									Integer.parseInt((String) dynaForm.get("creditGuaranteed")));
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
							flag = false;
						}
			...
			LogClass.StepWritterConnIssue(
					"Exception in checkCreditAmtAndSanctionDateForAdditionalTC " + e.getMessage());
			LogClass.writeExceptionOnFile(e);
			e.printStackTrace();
		}
		return errors.isEmpty();
	...
	public static boolean checkCreditAmtAndSanctionDateForEnhancementWC(Object bean, ValidatorAction validAction,
			Field field, ActionErrors errors, HttpServletRequest request) {
		try {
			//System.out.println("checkCreditAmtAndSanctionDate1111");
			DynaValidatorActionForm dynaForm = (DynaValidatorActionForm) bean;
				...
				// if((Double)dynaForm.get("creditFundBased") > 0 )
				{
					...
					if (dynaForm.get("wcFundBasedSanctioned") instanceof Double) {
						...
						if (flag = true && verifyBankTypeAndApproveLoanAmountForWcEnhancement("wc", "",
								...
								Double.toString((Double) dynaForm.get("wcNonFundBasedSanctioned")), bankId,
								basedOnCondition, classificationofMLI,classificationofMLISFC) == false) {
							ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
							errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
						}
	...
	public static boolean checkCreditAmtAndSanctionDateForRenewalWC(Object bean, ValidatorAction validAction,
			Field field, ActionErrors errors, HttpServletRequest request) {
		try {
			// System.out.println("checkCreditAmtAndSanctionDate1111" );
			DynaValidatorActionForm dynaForm = (DynaValidatorActionForm) bean;
			...
			// System.out.println("checkCreditAmtAndSanctionDate1111 WC
			// memberId"+memberId );
			// System.out.println("Renewal WC creditGuaranteed
			// getPreviouslyCovered "+dynaForm.get("previouslyCovered"));
			// System.out.println("Renewal WC amountSanctionedDate
			// getNone"+dynaForm.get("none"));
			//
			// System.out.println("Renewal WC creditFundBased
			// wcFBsanctioned"+dynaForm.get("wcFundBasedSanctioned"));
			// System.out.println("Renewal WC creditFundBased
			// wcNFBsanctioned"+dynaForm.get("wcNonFundBasedSanctioned"));
			//
			// System.out.println("Renewal WC creditFundBased
			// getUnitValue"+dynaForm.get("unitValue"));
			// System.out.println("Renewal WC creditFundBased
			...
			if (dynaForm.get("wcFundBasedSanctioned") instanceof Double) {
				...
				sumofFundbasedNonFundBased = (Double) dynaForm.get("wcFundBasedSanctioned")
						+ (Double) dynaForm.get("wcNonFundBasedSanctioned");
			} else if (dynaForm.get("wcFundBasedSanctioned") instanceof String) {
				// System.out.println("wc instanceof String " );
				sumofFundbasedNonFundBased = Double.parseDouble((String) dynaForm.get("wcFundBasedSanctioned")
						+ Double.parseDouble((String) dynaForm.get("wcNonFundBasedSanctioned")));
			}

			// System.out.println("checkCreditAmtAndSanctionDateForRenewalWC"+sumofFundbasedNonFundBased);
			// System.out.println("checkCreditAmtAndSanctionDateForRenewalWC
			// validatedateForTC"+validatedateSanctionDate(d));
			if (sumofFundbasedNonFundBased > 10000000 && validatedateSanctionDate(d) == false) {
				ActionError error = new ActionError(
						(new StringBuilder()).append("creditAmountAndSanctionDateValiWCRenewal").toString(),
						dynaForm.get("renewalDate"), dynaForm.get("wcFundBasedSanctioned"),
						dynaForm.get("wcNonFundBasedSanctioned"));
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
			HashMap basedOnCondition = new HashMap();
			...
			if (dynaForm.get("wcFundBasedSanctioned") instanceof Double) {
				if ((existingAmountCC + (Double) dynaForm.get("wcFundBasedSanctioned")
						+ (Double) dynaForm.get("wcNonFundBasedSanctioned")) > maxApprovedAmt) {
					//System.out.println("2crLimit..........................4 valid");
					ActionError error = new ActionError("2crLimit", existingAmountCC,
							((Double) dynaForm.get("wcFundBasedSanctioned")
									+ (Double) dynaForm.get("wcNonFundBasedSanctioned")));
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				...
				if (flag = true && verifyBankTypeAndApproveLoanAmount("wc", "",
						Double.toString((Double) dynaForm.get("wcFundBasedSanctioned")),
						Double.toString((Double) dynaForm.get("wcNonFundBasedSanctioned")), bankId, basedOnCondition,
						classificationofMLI,classificationofMLISFC) == false) {
					ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				}
			} else if (dynaForm.get("wcFundBasedSanctioned") instanceof String) {
				if ((existingAmountCC + (Integer.parseInt((String) dynaForm.get("wcFundBasedSanctioned")
						+ Integer.parseInt((String) dynaForm.get("wcNonFundBasedSanctioned")))) > maxApprovedAmt)) {
					//System.out.println("2crLimit..........................5 valid");
					ActionError error = new ActionError("2crLimit", existingAmountCC,
							((Integer.parseInt((String) dynaForm.get("wcFundBasedSanctioned")
									+ Integer.parseInt((String) dynaForm.get("wcNonFundBasedSanctioned"))))));
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
				...
				if (flag = true
						&& verifyBankTypeAndApproveLoanAmount("wc", "", (String) dynaForm.get("wcFundBasedSanctioned"),
								(String) dynaForm.get("wcNonFundBasedSanctioned"), bankId, basedOnCondition,
								classificationofMLI,classificationofMLISFC) == false) {
					ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
	...
	public static boolean checkCreditAmtAndSanctionDate(Object bean, ValidatorAction validAction, Field field,
			ActionErrors errors, HttpServletRequest request) {
		try {

			DynaValidatorActionForm dynaForm = (DynaValidatorActionForm) bean;
			String memberId = (String) dynaForm.get("selectMember");
			// System.out.println("checkCreditAmtAndSanctionDate1111 CC
			// memberId="+memberId );
			// GauranteeAmountIncrementForm
			// objGauranteeAmountIncrementForm=application.getGaurenteeIncrementForm();

			// System.out.println("creditGuaranteed getPreviouslyCovered
			// "+dynaForm.get("previouslyCovered"));
			// System.out.println("amountSanctionedDate
			// getNone"+dynaForm.get("previouslyCovered"));
			// System.out.println("creditFundBased
			// getUnitValue"+dynaForm.get("unitValue"));
			// System.out.println("creditFundBased
			// cgbid"+dynaForm.get("cgbid"));

			// HttpSession session= request.getSession();
			// System.out.println("checkCreditAmtAndSanctionDate
			 ...
			 * System.out.println("limitFundBasedSanctionedDate"+
			 * limitFundBasedSanctionedDate);
			 * System.out.println("limitNonFundBasedCommission"+
			 * limitNonFundBasedCommission);
			 * 
			...
			/*
			 * String strPreviouslyCovered=""; String strNone=""; String
			 * strCgbid="";
			 * 
			 * if(previouslyCovered!=null &&
			 * previouslyCovered.equalsIgnoreCase("Y")) {
			 * session.setAttribute("previouslyCovered", previouslyCovered);
			 * session.setAttribute("none", none); session.setAttribute("cgbid",
			 * cgbid); session.setAttribute("unitValue", unitValue);
			 * 
			 * 
			 * }
			 * 
			 ...
			 * previouslyCovered=(String)session.getAttribute(
			 * "previouslyCovered"); none=(String)session.getAttribute("none");
			 ...
			 * 
			 * // HashMap HashMap dateAndAmountDtl =new HashMap();
			 * 
			 * dateAndAmountDtl.put("amountSanctionedDate",
			 * amountSanctionedDate);
			 * dateAndAmountDtl.put("limitFundBasedSanctionedDate",
			 * limitFundBasedSanctionedDate);
			 * dateAndAmountDtl.put("limitNonFundBasedSanctionedDate",
			 * limitNonFundBasedCommission);
			 ...
			 * basedOnCondition.put("none", none); basedOnCondition.put("cgbid",
			 * cgbid); basedOnCondition.put("unitValue", unitValue);
			 */

			if (sanctionDateAmountValidationAll(loanType, dateAndAmountDtl, basedOnCondition) == false) {
				ActionError error = new ActionError(
						(new StringBuilder()).append("guarenteeAmountIncrementvalidationForAll").toString(),
						amountSanctionedDate, limitFundBasedSanctionedDate, limitNonFundBasedSanctionedDate);
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			...
			if (dateAndAmountDtl.get("creditGuaranteed") instanceof Double) {
				// System.out.println("checkCreditAmtAndSanctionDate1111 CC
				// instanceof
				// Double="+((Double)dateAndAmountDtl.get("creditGuaranteed")+(Double)dateAndAmountDtl.get("creditFundBased")+(Double)dateAndAmountDtl.get("creditFundBased"))
				// );
				if (((Double) dateAndAmountDtl.get("creditGuaranteed")
						+ (Double) dateAndAmountDtl.get("creditFundBased")
						+ (Double) dateAndAmountDtl.get("creditNonFundBased") + existingAmountCC) > maxApprovedAmt) {
				...
				// System.out.println("checkCreditAmtAndSanctionDate1111 CC
				// instanceof
				// String="+((Integer.parseInt((String)dateAndAmountDtl.get("creditGuaranteed"))+Integer.parseInt((String)dateAndAmountDtl.get("creditFundBased"))+Integer.parseInt((String)dateAndAmountDtl.get("creditFundBased"))))
				// );
				if (((Integer.parseInt((String) dateAndAmountDtl.get("creditGuaranteed"))
						+ Integer.parseInt((String) dateAndAmountDtl.get("creditFundBased"))
						+ Integer.parseInt((String) dateAndAmountDtl.get("creditNonFundBased")
								+ existingAmountCC))) > maxApprovedAmt) {
					System.out.println("2crLimit..........................7 valid");
					ActionError error = new ActionError("2crLimit", existingAmountCC,
							(((Integer.parseInt((String) dateAndAmountDtl.get("creditGuaranteed"))
									+ Integer.parseInt((String) dateAndAmountDtl.get("creditFundBased"))
									+ Integer.parseInt(
											(String) dateAndAmountDtl.get("creditNonFundBased") + existingAmountCC)))));
					errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
					flag = false;
				}
			}
			if (flag = true && verifyBankTypeAndApproveLoanAmount(loanType, creditGuaranteed, creditFundBased,
					creditNonFundBased, bankId, basedOnCondition, classificationofMLI,classificationofMLISFC) == false) {
				ActionError error = new ActionError((new StringBuilder()).append(validatorStr).toString());
				errors.add("org.apache.struts.action.GLOBAL_ERROR", error);
			}
			dateAndAmountDtl.clear();
	...
	public static boolean sanctionDateAmountValidationForWCEnhancement(String loanType, HashMap dateAndAmountDtl,
		...
		try {
				...
				if (loanType.equalsIgnoreCase("wc")) {
					...
					// if(previouslyCovered!=null)
					{
						...
						if (dateAndAmountDtl.get("wcFundBasedSanctioned") instanceof Double) {
							// System.out.println("wc instanceof Double " );
							sumofFundbasedNonFundBased = (Double) dateAndAmountDtl.get("wcFundBasedSanctioned")
									+ (Double) dateAndAmountDtl.get("wcNonFundBasedSanctioned");
						} else if (dateAndAmountDtl.get("wcFundBasedSanctioned") instanceof String) {
							// System.out.println("wc instanceof String " );
							sumofFundbasedNonFundBased = Double
									.parseDouble((String) dateAndAmountDtl.get("wcFundBasedSanctioned") + Double
											.parseDouble((String) dateAndAmountDtl.get("wcNonFundBasedSanctioned")));
						}
						...
						// System.out.println("WC sumofFundbasedNonFundBased
						// "+sumofFundbasedNonFundBased );

						if ((sumofFundbasedNonFundBased) > 10000000
								&& validatedateSanctionDate(wcEnhancementDate) == false)
						// if((sumofFundbasedNonFundBased) > 10000000 )
						{
			...
			LogClass.StepWritterConnIssue(
					"Exception in sanctionDateAmountValidationForWCEnhancement " + e.getMessage());
			LogClass.writeExceptionOnFile(e);
	...
	public static boolean verifyBankTypeAndApproveLoanAmount(String loanType, String creditGuaranteed,
		...
		try {
			...
			if (validationFlag == true) {
				...
				if (((classificationofMLISFC.equals("SFC")) || (classificationofMLI == "SFC"))
							&& (totalAmount > rrbValue)) {
						// System.out.println("classificationofMLI RRB
						// totalAmount"+totalAmount );
						resultFlag = false;
	...
	public static boolean validateCreditGuaranteedForBothMli(Object bean, ValidatorAction validAction, Field field,
		...
		double currentcreditGuaranteednonFundBased = (Double) dynaForm.get("creditNonFundBased");
		...
		BigDecimal CreditNonfund = new BigDecimal(currentcreditGuaranteednonFundBased);
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MMMM/yyyy");
	...
	// * ........... Added By DKR for validating Udyog * Adhar

	/*
	 * public static boolean validateUdyogAdharNo(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest
	 * request) throws Exception { Log.log(4, "validation", "validDateFormat",
	 * "validateUdyogAdharNo()"); DynaActionForm dynaForm = (DynaActionForm)
	 * bean; String udhyogAdharNo = (String) dynaForm.get(field.getProperty());
	 * if (!udhyogAdharNo.trim().equals("")) { Pattern pattern = Pattern
	 * .compile("[a-zA-Z]{2}[a-zA-Z0-9]{2}[abdeABDE](?!0{7})[a-zA-Z0-9]{7}"); //
	 * Pattern pattern = //
	 * Pattern.compile("[a-zA-Z]{2}[a-zA-Z0-9]{2}[l](?!0{7})[a-zA-Z0-9]{7}");
	 * Matcher matcher = pattern.matcher(udhyogAdharNo); if (matcher.matches())
	 * {
	 * 
	 * } else { ActionError actionError = new
	 * ActionError("udyogAdharNoInvalid");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); //
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", new //
	 * ActionError("udyogAdharNoInvalid")); } } return errors.isEmpty();
	 * 
	 * }
	 */
	/*
	 * public static boolean validateAdharNo(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest
	 * request) throws Exception {
	 * 
	 * DynaActionForm dynaForm = (DynaActionForm) bean;
	 * 
	 * String AdharNo = (String) dynaForm.get(field.getProperty()); String
	 * udhyogAdharNo = (String) dynaForm.get("udyogAdharNo");
	 * System.out.println("AdharNo=="+AdharNo);
	 * System.out.println("udhyogAdharNo=="+udhyogAdharNo); boolean
	 * resultFlag=true;
	 * 
	 * 
	 * 
	 * if(!AdharNo.trim().equals("")||!udhyogAdharNo.trim().equals("")) {
	 * if(!AdharNo.equals("")){ Pattern pattern =
	 * Pattern.compile("^(\\d)(?!\\1+$)\\d{11}$"); Matcher matcher =
	 * pattern.matcher(AdharNo.toUpperCase());
	 * 
	 * if (matcher.matches()) {
	 * System.out.println("validate AadharNo is valid"+AdharNo); } else {
	 * System.out.println("validatePanCardNo is invalid"+AdharNo); ActionError
	 * actionError = new ActionError("adharNotValid");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); } }
	 * }else{ ActionError actionError = new ActionError("enterAadhar");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * return errors.isEmpty();
	 * 
	 * 
	...
	/*
	 * public static boolean validateStateCode(Object bean, ValidatorAction
	 * validAction, Field field, ActionErrors errors, HttpServletRequest
	 * request) { DynaActionForm dynaForm = (DynaActionForm) bean; String
	 * stateCode = (String) dynaForm.get("stateCode"); if (stateCode == null &&
	 * stateCode.equals("")) { ActionError actionError = new
	 * ActionError("stateCodeRequired");
	 * errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError); }
	 * return errors.isEmpty(); }
	 */

	/*
	 * private static boolean validDateFormat(String inDate) {
	 * 
	 * Log.log(4, "validation", "validDateFormat",
	 * "validDateFormat().......dob"); boolean dateVal = false; try { Date date
	 * = new SimpleDateFormat("dd/MM/yyyy").parse(inDate); dateVal = new
	 * Date().after(date); } catch (ParseException pe) { Log.log(2,
	 * "validation", "validDateFormat", pe.getMessage()); dateVal = false; }
	 * return dateVal;
	 * 
	 * }
	 */
    ...
    public static boolean validateExistGreenUnit(Object bean, ValidatorAction validAction, Field field, ActionErrors errors, HttpServletRequest request)
    {
        ...
        if((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && dynaForm.get("creditGuaranteed") != null)
            creditGuaranteedVal = ((Double)dynaForm.get("creditGuaranteed")).doubleValue();
        if((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && (dynaForm.get("creditFundBased") != null || dynaForm.get("creditNonFundBased") != null))
        {
        ...
        try
        {
            ...
            if((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && dynaForm.get("amountSanctionedDate") != null)
                if(dynaForm.get("amountSanctionedDate").toString().length() != 0)
                {
                    ...
                    {
                        datFlag4UI1 = true;
                       // System.out.println((new StringBuilder("datFlag4UI1 ::::::::::::::::::")).append(datFlag4UI1).toString());
                    } else
                    {
                        datFlag4UI1 = false;
            ...
            if((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && (dynaForm.get("limitFundBasedSanctionedDate") != null || dynaForm.get("limitNonFundBasedSanctionedDate") != null))
            {
                ...
                if(dynaForm.get("limitFundBasedSanctionedDate").toString().length() != 0)
                {
                    ...
                    {
                        datFlag4UI2 = true;
                        System.out.println((new StringBuilder("datFlag4UI2::::::::::::::::::")).append(datFlag4UI2).toString());
                    } else
                    {
                        datFlag4UI2 = false;
                        session.setAttribute("gFinancialUIflag", "DFALSEUI");
                ...
                if(dynaForm.get("limitNonFundBasedSanctionedDate").toString().length() != 0)
                {
                    ...
                    {
                        datFlag4UI3 = true;
                       // System.out.println((new StringBuilder("datFlag4UI3::::::::::::::::::")).append(datFlag4UI3).toString());
                    } else
                    {
                        datFlag4UI3 = false;
                        session.setAttribute("gFinancialUIflag", "DFALSEUI");
        ...
        if(dynaForm.get("existGreenFldUnitType") != null)
            existGreenFldUnitType = (String)dynaForm.get("existGreenFldUnitType");
        ...
        if(dynaForm.get("networth") != null)
        {
            ...
            System.out.println((new StringBuilder("networth >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(networth).toString());
        }
        if(dynaForm.get("debitEqtRatioUnt") != null)
        {
            debitEqtRatioUnt = ((Float)dynaForm.get("debitEqtRatioUnt")).floatValue();
            System.out.println((new StringBuilder("debitEqtRatioUnt >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(debitEqtRatioUnt).toString());
        }
        if(dynaForm.get("debitSrvCoverageRatioTl") != null)
        {
            ...
            System.out.println((new StringBuilder("debitSrvCoverageRatioTl >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(debitSrvCoverageRatioTl).toString());
        }
        if(dynaForm.get("currentRatioWc") != null)
        {
            currentRatioWc = ((Float)dynaForm.get("currentRatioWc")).floatValue();
            System.out.println((new StringBuilder("currentRatioWc >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(currentRatioWc).toString());
        }
        if(dynaForm.get("debitEqtRatio") != null)
        {
            debitEqtRatio = ((Float)dynaForm.get("debitEqtRatio")).floatValue();
            System.out.println((new StringBuilder("debitEqtRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(debitEqtRatio).toString());
        }
        if(dynaForm.get("debitSrvCoverageRatio") != null)
        {
            debitSrvCoverageRatio = ((Float)dynaForm.get("debitSrvCoverageRatio")).floatValue();
            System.out.println((new StringBuilder("debitSrvCoverageRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> ")).append(debitSrvCoverageRatio).toString());
        }
        ...
        if(sessionLoanType.equals("TC") && amountSanctionedDateVal != null && creditGuaranteedVal != 0.0D && datFlag4UI1)
        {
            ...
            {
                System.out.println("validateExistGreenUnit entered TC 2 ======== creditGuaranteed > 1000000 && creditGuaranteed <= 5000000");
            ...
            if(creditGuaranteedVal > 5000000D && creditGuaranteedVal < 10000000D && datFlag4UI1)
            {
                ...
                session.removeAttribute("gFinancialUIflag");
                System.out.println("validateExistGreenUnit entered TC 3==== creditGuaranteed > 5000000 && creditGuaranteed <= 10000000");
                if(existGreenFldUnitType == "" || existGreenFldUnitType.equals(""))
                {
                    ActionError actionError = new ActionError("existGreenFieldUnitsError");
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
              ...
              /*  if(creditBureauChiefPromScor == 0)
                {
                    ActionError actionError = new ActionError("crdBureauChiefPromScorError");
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
                }*/
                if (creditBureauChiefPromScor < -1) {                                            //  28-SEP-2020
					ActionError actionError = new ActionError("crdBureauChiefPromScorError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
					System.out.println("Deepak G2");
				}
                if(totalAssets == 0.0F)
                {
            ...
            {
            	//Modify by Parmanand 17-08-2020
            	String consitutionName=(String)dynaForm.get("constitution");
                session.removeAttribute("dblockUI");
                validatePromDirDefaltDetails(session, errors, flag, credBureKeyPromScor, credBurePromScor2, credBurePromScor3, credBurePromScor4, credBurePromScor5, credBureName1, credBureName2, credBureName3, credBureName4, credBureName5, cibilFirmMsmeRank, expCommerScor, promBorrNetWorth, promContribution, promGAssoNPA1YrFlg, promBussExpYr, salesRevenue, taxPBIT, interestPayment, taxCurrentProvisionAmt, totCurrentAssets, totCurrentLiability, totTermLiability, exuityCapital, preferenceCapital, reservesSurplus, repaymentDueNyrAmt,consitutionName);
            }
        }
        if(sessionLoanType.equals("WC") && (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D) && (limitFundbasedSanctionedDateVal != null || limitNonFundBasedSanctionedDateVal != null) && (datFlag4UI2 || datFlag4UI3))
        {
            ...
            if(totalFundNonBaseGurAmtVal.doubleValue() != 0.0D && totalFundNonBaseGurAmtVal.doubleValue() >= 100000D && totalFundNonBaseGurAmtVal.doubleValue() <= 1000000D && (datFlag4UI2 || datFlag4UI3))
            {
                session.setAttribute("dblockUI", "UI_1");
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.removeAttribute("gFinancialUIflag");
            }
            if(totalFundNonBaseGurAmtVal.doubleValue() > 1000000D && totalFundNonBaseGurAmtVal.doubleValue() <= 5000000D && (datFlag4UI2 || datFlag4UI3))
            {
                session.setAttribute("dblockUI", "UI_2");
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.removeAttribute("gFinancialUIflag");
               ...
               // System.out.println("validateExistGreenUnit entered WC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 ");
                if(opratIncome == 0.0F)
                {
                    ActionError actionError = new ActionError("oprtIncError");
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
            ...
            if(totalFundNonBaseGurAmtVal.doubleValue() > 5000000D && totalFundNonBaseGurAmtVal.doubleValue() < 10000000D && (datFlag4UI2 || datFlag4UI3))
            {
                System.out.println("validateExistGreenUnit entered WC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <= 100000000 ");
                session.setAttribute("dblockUI", "UI_3");
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.removeAttribute("gFinancialUIflag");
                if(existGreenFldUnitType == "" || existGreenFldUnitType.equals(""))
            ...
            if(sessionLoanType.equals("WC") && !sessionLoanType.equals("TC") && (!sessionLoanType.equals("BO") || !sessionLoanType.equals("CC")) && (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D) && (limitNonFundBasedSanctionedDateVal != null || limitFundbasedSanctionedDateVal != null) && creditFundBasedVal + creditNonFundBasedVal >= 10000000D && creditFundBasedVal + creditNonFundBasedVal <= 20000000D && (datFlag4UI2 || datFlag4UI3))
            {
            	//Modify by Parmanand 17-08-2020
            	String consitutionName=(String)dynaForm.get("constitution");
        ...
        if((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && amountSanctionedDateVal != null && (limitNonFundBasedSanctionedDateVal != null || limitFundbasedSanctionedDateVal != null) && creditGuaranteedVal != 0.0D && (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D) && datFlag4UI1 && (datFlag4UI2 || datFlag4UI3))
        {
           ...
           // System.out.println("validateExistGreenUnit entered CC ====  ");
            ...
            if(totalFundNonBaseGurAmtVal.doubleValue() != 0.0D && totalFundNonBaseGurAmtVal.doubleValue() >= 100000D && totalFundNonBaseGurAmtVal.doubleValue() <= 1000000D && datFlag4UI1 && (datFlag4UI2 || datFlag4UI3))
            {
                session.setAttribute("dblockUI", "UI_1");
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.removeAttribute("gFinancialUIflag");
            }
            if(totalFundNonBaseGurAmtVal.doubleValue() > 1000000D && totalFundNonBaseGurAmtVal.doubleValue() <= 5000000D && datFlag4UI1 && (datFlag4UI2 || datFlag4UI3))
            {
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.setAttribute("dblockUI", "UI_2");
                session.removeAttribute("gFinancialUIflag");
              ...
              //  System.out.println("validateExistGreenUnit entered CC 2==== totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 ");
                if(opratIncome == 0.0F)
                {
                    ActionError actionError = new ActionError("oprtIncError");
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
            ...
            if(totalFundNonBaseGurAmtVal.doubleValue() > 5000000D && totalFundNonBaseGurAmtVal.doubleValue() < 10000000D && datFlag4UI1 && (datFlag4UI2 || datFlag4UI3))
            {
                session.setAttribute("gFinancialUIflag", "DFALSEUI");
                session.setAttribute("dblockUI", "UI_3");
                if(existGreenFldUnitType == "" || existGreenFldUnitType.equals(""))
                ...
                //System.out.println("validateExistGreenUnit entered CC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal < 10000000");
                if(opratIncome == 0.0F)
                {
                    ActionError actionError = new ActionError("oprtIncError");
                    errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
            ...
            if((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && !sessionLoanType.equals("TC") && !sessionLoanType.equals("WC") && creditGuaranteedVal != 0.0D && (creditFundBasedVal != 0.0D || creditNonFundBasedVal != 0.0D) && creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal >= 10000000D && creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal <= 20000000D && amountSanctionedDateVal != null && (limitNonFundBasedSanctionedDateVal != null || limitFundbasedSanctionedDateVal != null) && datFlag4UI1 && (datFlag4UI2 || datFlag4UI3))
            {
            	//Modify by Parmanand 17-08-2020
            	String consitutionName=(String)dynaForm.get("constitution");
                session.setAttribute("dblockUI", " ");
	...
	/*public static boolean validateExistGreenUnit(Object bean, ValidatorAction validAction, Field field,
		...
		DynaActionForm dynaForm = (DynaActionForm) bean;
		HttpSession session = request.getSession(false);
		Date seltdate1=null,seltdate2=null,seltdate3=null;                   
		
		String enableUIFlag = "";
		String myDate = "01/12/2018";		
		
		java.util.Date amountSanctionedDateVal = null;
		java.util.Date limitFundbasedSanctionedDateVal = null;
		java.util.Date limitNonFundBasedSanctionedDateVal= null;
		Date enterdDateVal = null;
		double creditGuaranteedVal=0.0d;
		double creditFundBasedVal =0.0d;
		double creditNonFundBasedVal = 0.0d;
		boolean datFlag4UI1 = false, datFlag4UI2=false, datFlag4UI3=false;
		float opratIncome=0.0f;               			
	     float profAftTax=0.0f;                           
	     float networth=0.0f;      
	     float debitEqtRatioUnt=0.0f;
	  ...
	  // added by DKR ExistGreen Validation start
	     ...
	     String sessionLoanType = (String)session.getAttribute("APPLICATION_LOAN_TYPE");
	     if((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && null!=dynaForm.get("creditGuaranteed")){
		       creditGuaranteedVal = (Double) dynaForm.get("creditGuaranteed");		
		       System.out.println("creditGuaranteedVal.....................validator......................................"+creditGuaranteedVal);
		 }	
	     if((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && (null!=dynaForm.get("creditFundBased") || null!=dynaForm.get("creditNonFundBased"))) {
				creditFundBasedVal = (Double) dynaForm.get("creditFundBased");
				creditNonFundBasedVal = (Double) dynaForm.get("creditNonFundBased");
				  System.out.println("creditFundBasedVal.....................validator...................creditNonFundBasedVal..................."+creditFundBasedVal+"<<<<...>>>>"+creditNonFundBasedVal);
		}	    
	 try {		 
		 SimpleDateFormat df = new SimpleDateFormat("dd/MM/yyyy");
	     enterdDateVal = df.parse(myDate);	    	
		 if((sessionLoanType.equals("TC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && null!= dynaForm.get("amountSanctionedDate") ) {
			
			 //System.out.println("dynaForm.get(\"amountSanctionedDate\") :"+dynaForm.get("amountSanctionedDate"));
			 //System.out.println("dynaForm.get(\"amountSanctionedDate\") length:"+dynaForm.get("amountSanctionedDate").toString().length());
			if(dynaForm.get("amountSanctionedDate").toString().length()!=0) { 
			 
							amountSanctionedDateVal = (java.util.Date) dynaForm.get("amountSanctionedDate");
							if(amountSanctionedDateVal.compareTo(enterdDateVal)>=0) {
								datFlag4UI1 = true;
								System.out.println("datFlag4UI1 ::::::::::::::::::"+datFlag4UI1);
							}else {
								datFlag4UI1 = false;
								session.setAttribute("gFinancialUIflag","DFALSEUI");
								session.setAttribute("dblockUI","");
		 ...
		 if((sessionLoanType.equals("WC") || sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && (null!=dynaForm.get("limitFundBasedSanctionedDate") || null!=dynaForm.get("limitNonFundBasedSanctionedDate"))) {
			limitFundbasedSanctionedDateVal = (java.util.Date) dynaForm.get("limitFundBasedSanctionedDate");
			limitNonFundBasedSanctionedDateVal = (java.util.Date)dynaForm.get("limitNonFundBasedSanctionedDate");
				if(dynaForm.get("limitFundBasedSanctionedDate").toString().length()!=0) { 
					if(limitFundbasedSanctionedDateVal.compareTo(enterdDateVal)>=0) {
						datFlag4UI2 = true;
						System.out.println("datFlag4UI2::::::::::::::::::"+datFlag4UI2);
					}else {
						datFlag4UI2 = false;
						session.setAttribute("gFinancialUIflag","DFALSEUI");
						session.setAttribute("dblockUI","");
		    ...
		    if(dynaForm.get("limitNonFundBasedSanctionedDate").toString().length()!=0) { 	
					if(limitNonFundBasedSanctionedDateVal.compareTo(enterdDateVal)>=0) {
						datFlag4UI3 = true;
						System.out.println("datFlag4UI3::::::::::::::::::"+datFlag4UI3);
					}else {
						datFlag4UI3 = false;
						session.setAttribute("gFinancialUIflag","DFALSEUI");
						session.setAttribute("dblockUI","");
	   	...
	   	if(null!= dynaForm.get("existGreenFldUnitType")) {
	   		existGreenFldUnitType = (String) dynaForm.get("existGreenFldUnitType");
	    }
	   	if(null!=dynaForm.get("opratIncome")) {
	   		opratIncome = (Float) dynaForm.get("opratIncome");
	    }
		if(null!=dynaForm.get("profAftTax")) {
			profAftTax = (Float) dynaForm.get("profAftTax");
	    }               			
		if(null!=dynaForm.get("networth")) {
			networth = (Float) dynaForm.get("networth");
			System.out.println("networth >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+networth);
	    }                           
		if(null!=dynaForm.get("debitEqtRatioUnt")) {
			debitEqtRatioUnt = (Float) dynaForm.get("debitEqtRatioUnt");
			System.out.println("debitEqtRatioUnt >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+debitEqtRatioUnt);
	    } 
		if(null!=dynaForm.get("debitSrvCoverageRatioTl")) {
			debitSrvCoverageRatioTl = (Float) dynaForm.get("debitSrvCoverageRatioTl");
			System.out.println("debitSrvCoverageRatioTl >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+debitSrvCoverageRatioTl);
	    } 
		if(null!=dynaForm.get("currentRatioWc")) {
			currentRatioWc = (Float) dynaForm.get("currentRatioWc");
			System.out.println("currentRatioWc >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+currentRatioWc);
	    }
		if(null!=dynaForm.get("debitEqtRatio")) {
			debitEqtRatio = (Float) dynaForm.get("debitEqtRatio");
			System.out.println("debitEqtRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+debitEqtRatio);
	    }
		if(null!=dynaForm.get("debitSrvCoverageRatio")) {
			debitSrvCoverageRatio = (Float) dynaForm.get("debitSrvCoverageRatio");
			System.out.println("debitSrvCoverageRatio >>>>>>>>>>>>>>>>>Validator>>>>>>>>>>>>>>>>>> "+debitSrvCoverageRatio);
	    }
		if(null!=dynaForm.get("currentRatios")) {
			currentRatios = (Float) dynaForm.get("currentRatios");
	    }	
		if(null!=dynaForm.get("creditBureauChiefPromScor")) {
			creditBureauChiefPromScor = (Integer) dynaForm.get("creditBureauChiefPromScor");
	    }					
		if(null!=dynaForm.get("totalAssets")) {
			totalAssets = (Float) dynaForm.get("totalAssets");
	    }	
		
	     if(null!= dynaForm.get("promDirDefaltFlg")) {
	    	 flag = (String) dynaForm.get("promDirDefaltFlg");
		 }
	     if(null!= dynaForm.get("credBureKeyPromScor")) {
	    	 credBureKeyPromScor=(Integer)dynaForm.get("credBureKeyPromScor"); 
		 }
	     if(null!= dynaForm.get("credBurePromScor2")) {
	    	 credBurePromScor2=(Integer)dynaForm.get("credBurePromScor2"); 
		 }
	     if(null!= dynaForm.get("credBurePromScor3")) {
	    	 credBurePromScor3=(Integer)dynaForm.get("credBurePromScor3"); 
		 }
	     if(null!= dynaForm.get("credBurePromScor4")) {
	    	 credBurePromScor4=(Integer)dynaForm.get("credBurePromScor4"); 
		 }
	     if(null!= dynaForm.get("credBurePromScor5")) {
	    	 credBurePromScor5=(Integer)dynaForm.get("credBurePromScor5"); 
		 } 
	     if(null!= dynaForm.get("credBureName1")) {
	    	 credBureName1=(String)dynaForm.get("credBureName1"); 
		 } 
	     if(null!= dynaForm.get("credBureName2")) {
	    	 credBureName2=(String)dynaForm.get("credBureName2"); 
		 }
	     if(null!= dynaForm.get("credBureName3")) {
	    	 credBureName3=(String)dynaForm.get("credBureName3"); 
		 } 
	     if(null!= dynaForm.get("credBureName4")) {
	    	 credBureName4=(String)dynaForm.get("credBureName4"); 
		 }  
	     if(null!= dynaForm.get("credBureName5")) {
	    	 credBureName5=(String)dynaForm.get("credBureName5"); 
		 }    
	     if(null!= dynaForm.get("cibilFirmMsmeRank")) {
	    	 cibilFirmMsmeRank=(Integer)dynaForm.get("cibilFirmMsmeRank"); 
		 }	     
	     if(null!= dynaForm.get("expCommerScor")) {
	    	 expCommerScor=(Integer)dynaForm.get("expCommerScor"); 
		 }	
	     if(null!= dynaForm.get("promBorrNetWorth")) {
	    	 promBorrNetWorth=(Float)dynaForm.get("promBorrNetWorth"); 
		 }	   
	     if(null!= dynaForm.get("promContribution")) {
	    	 promContribution=(Integer)dynaForm.get("promContribution"); 
		 } 
	     if(null!= dynaForm.get("promGAssoNPA1YrFlg")) {
	    	 promGAssoNPA1YrFlg=(String)dynaForm.get("promGAssoNPA1YrFlg"); 
		 } 
	     if(null!= dynaForm.get("promBussExpYr")) {
	    	 promBussExpYr=(Integer)dynaForm.get("promBussExpYr"); 
		 } 
	     if(null!= dynaForm.get("salesRevenue")) {
	    	 salesRevenue=(Float)dynaForm.get("salesRevenue"); 
		 }	
	     if(null!= dynaForm.get("taxPBIT")) {
	    	 taxPBIT=(Float)dynaForm.get("taxPBIT"); 
		 }	 	  
	     if(null!= dynaForm.get("interestPayment")) {
	    	 interestPayment=(Float)dynaForm.get("interestPayment"); 
		 }		  
	     if(null!= dynaForm.get("taxCurrentProvisionAmt")) {
	    	 taxCurrentProvisionAmt=(Float)dynaForm.get("taxCurrentProvisionAmt"); 
		 }	  
	     if(null!= dynaForm.get("totCurrentAssets")) {
	    	 totCurrentAssets=(Float)dynaForm.get("totCurrentAssets"); 
		 }	 
	     if(null!= dynaForm.get("totCurrentLiability")) {
	    	 totCurrentLiability=(Float)dynaForm.get("totCurrentLiability"); 
		 }	  
	     if(null!= dynaForm.get("totTermLiability")) {
	    	 totTermLiability=(Float)dynaForm.get("totTermLiability"); 
		 }	 
	     if(null!= dynaForm.get("exuityCapital")) {
	    	 exuityCapital=(Float)dynaForm.get("exuityCapital"); 
		 }	  
	     if(null!= dynaForm.get("preferenceCapital")) {
	    	 preferenceCapital=(Float)dynaForm.get("preferenceCapital"); 
		 }	  
	     if(null!= dynaForm.get("reservesSurplus")) {
	    	 reservesSurplus=(Float)dynaForm.get("reservesSurplus"); 
		 }	  
	     if(null!= dynaForm.get("repaymentDueNyrAmt")) {
	    	 repaymentDueNyrAmt=(Float)dynaForm.get("repaymentDueNyrAmt"); 
		 }		  
	   
		
		//***************
		
	   if(sessionLoanType.equals("TC") && null!=amountSanctionedDateVal && creditGuaranteedVal!= 0.0d  && datFlag4UI1==true){		
		   
		   Log.log(4, "Validator.java", "validateExistGreenUnit()", "TC");
								
			   if(creditGuaranteedVal >= 100000 && creditGuaranteedVal  <= 1000000 &&  datFlag4UI1==true){		 
		//	 session.setAttribute("gExgGreenUIFlag","RTRUEUI");
			 session.setAttribute("dblockUI","UI_1");
			 session.setAttribute("gFinancialUIflag", "DFALSEUI"); 
			 session.removeAttribute("gFinancialUIflag"); 
				   
					System.out.println("validateExistGreenUnit entered TC 1==============creditGuaranteed >= 100000 && creditGuaranteed <= 1000000");	
			   ...
			   if(creditGuaranteedVal > 1000000 && creditGuaranteedVal <=5000000 &&  datFlag4UI1==true){		  
				   System.out.println("validateExistGreenUnit entered TC 2 ======== creditGuaranteed > 1000000 && creditGuaranteed <= 5000000");
				  ...
				  // session.setAttribute("gExgGreenUIFlag","RTRUEUI");
			       ...
			       if(existGreenFldUnitType=="" || existGreenFldUnitType.equals("")){
					 ...
					 if(debitEqtRatioUnt==0){
						 ActionError actionError = new ActionError("dvtEqtRatioUntError");
							errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);	
				 		}               			
				 		if(debitSrvCoverageRatioTl==0) {
				 			ActionError actionError = new ActionError("dvtSrvCoverageRatioTlError");
							errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				 		}
				 		if(currentRatioWc==0) {
			   ...
			   if(creditGuaranteedVal > 5000000 && creditGuaranteedVal < 10000000 &&  datFlag4UI1==true){
				...
				//   session.setAttribute("gExgGreenUIFlag","RTRUEUI");
			       ...
			       session.removeAttribute("gFinancialUIflag"); 
			        ...
			        if (creditGuaranteedVal >= 10000000 && creditGuaranteedVal <= 20000000 &&  datFlag4UI1==true){
			         session.setAttribute("dblockUI","RFALSEUI");
					  session.removeAttribute("dblockUI"); 	
			        
			  		validatePromDirDefaltDetails(session, errors,flag, credBureKeyPromScor,credBurePromScor2,credBurePromScor3,credBurePromScor4,credBurePromScor5,credBureName1,credBureName2,credBureName3,
							credBureName4,credBureName5,cibilFirmMsmeRank,expCommerScor,promBorrNetWorth,promContribution,promGAssoNPA1YrFlg,promBussExpYr,salesRevenue,taxPBIT,interestPayment,
							taxCurrentProvisionAmt,totCurrentAssets,totCurrentLiability,totTermLiability,exuityCapital,preferenceCapital,reservesSurplus,repaymentDueNyrAmt);	
					}
			   
			   
			}
	   if(sessionLoanType.equals("WC") && (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d)  &&  (null!=limitFundbasedSanctionedDateVal || null!=limitNonFundBasedSanctionedDateVal)  && (datFlag4UI2==true || datFlag4UI3==true)){		
		  // if(sessionLoanType.equals("WC") && creditFundBasedVal!=0.0d && creditNonFundBasedVal!= 0.0d  &&  null!=limitNonFundBasedSanctionedDateVal  && null!=limitFundbasedSanctionedDateVal  && (datFlag4UI2==true && datFlag4UI3==true)){		
			   Log.log(4, "Validator.java", "validateExistGreenUnit()", "WC");
			   Double totalFundNonBaseGurAmtVal = creditFundBasedVal + creditNonFundBasedVal;
				 System.out.println("Insert into WC...............");
				 if(totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000 && (datFlag4UI2==true || datFlag4UI3==true)){
					  session.setAttribute("dblockUI","UI_1");
					   //session.setAttribute("gExgGreenUIFlag","RTRUEUI");
				       session.setAttribute("gFinancialUIflag", "DFALSEUI"); 
				       session.removeAttribute("gFinancialUIflag"); 
					 	
					 System.out.println("validateExistGreenUnit entered WC 1==totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000");			 
					 if (existGreenFldUnitType == "" && existGreenFldUnitType == null) {
							ActionError actionError = new ActionError("existGreenFieldUnitsError");
							errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
					   }
				 		if(opratIncome==0.0f){
				 ...
				 if(totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000 && (datFlag4UI2==true || datFlag4UI3==true)){
					 session.setAttribute("dblockUI","UI_2");
					 //  session.setAttribute("gExgGreenUIFlag","RTRUEUI");
				       session.setAttribute("gFinancialUIflag", "DFALSEUI"); 
				       session.removeAttribute("gFinancialUIflag"); 
				 ...
				 if(totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal < 10000000 && (datFlag4UI2==true || datFlag4UI3==true)){
					    System.out.println("validateExistGreenUnit entered WC 3==== totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal <= 100000000 ");
					       session.setAttribute("dblockUI","UI_3");
						 //  session.setAttribute("gExgGreenUIFlag","RTRUEUI");
					       session.setAttribute("gFinancialUIflag", "DFALSEUI"); 
				 ...
				 if(( sessionLoanType.equals("WC")  && (!sessionLoanType.equals("TC") && (!sessionLoanType.equals("BO") || !sessionLoanType.equals("CC")))) && (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d) &&  
						 (null!=limitNonFundBasedSanctionedDateVal || null!=limitFundbasedSanctionedDateVal) && ((creditFundBasedVal + creditNonFundBasedVal) >= 10000000) && ((creditFundBasedVal+creditNonFundBasedVal) <= 20000000) && (datFlag4UI2==true || datFlag4UI3==true)){							
					 session.setAttribute("dblockUI","RFALSEUI");
					  session.removeAttribute("dblockUI"); 	
		      ...
		      if((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && null!=amountSanctionedDateVal && (null!=limitNonFundBasedSanctionedDateVal || null!=limitFundbasedSanctionedDateVal) && creditGuaranteedVal!= 0.0d && (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d)  && datFlag4UI1==true  && (datFlag4UI2==true || datFlag4UI3==true)){		
		    	  Log.log(4, "Validator.java", "validateExistGreenUnit()", "BOTH D");
		    	  System.out.println("validateExistGreenUnit entered CC ====  ");
					
					 Double totalFundNonBaseGurAmtVal = creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal;
					 if(totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000 && datFlag4UI1==true  && (datFlag4UI2==true || datFlag4UI3==true)){	
						 ...
						 System.out.println("validateExistGreenUnit entered CC 1==totalFundNonBaseGurAmtVal !=0.0 && totalFundNonBaseGurAmtVal >= 100000 && totalFundNonBaseGurAmtVal <= 1000000");			 
						 if (existGreenFldUnitType == "" && existGreenFldUnitType == null) {
								ActionError actionError = new ActionError("existGreenFieldUnitsError");
								errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
						   }
					 ...
					 if(totalFundNonBaseGurAmtVal > 1000000 && totalFundNonBaseGurAmtVal <= 5000000  && datFlag4UI1==true  && (datFlag4UI2==true || datFlag4UI3==true)){	
					 ...
					 if(totalFundNonBaseGurAmtVal > 5000000 && totalFundNonBaseGurAmtVal < 10000000  && datFlag4UI1==true  && (datFlag4UI2==true || datFlag4UI3==true)){	
					 ...
					 if (((sessionLoanType.equals("BO") || sessionLoanType.equals("CC")) && ( !sessionLoanType.equals("TC") && !sessionLoanType.equals("WC"))) && 
								creditGuaranteedVal!= 0.0d &&  (creditFundBasedVal!=0.0d || creditNonFundBasedVal!= 0.0d) && ((creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal) >= 10000000) && ((creditGuaranteedVal + creditFundBasedVal+creditNonFundBasedVal) <= 20000000) &&
								null!=amountSanctionedDateVal && (null!=limitNonFundBasedSanctionedDateVal || null!=limitFundbasedSanctionedDateVal)  && datFlag4UI1==true  && (datFlag4UI2==true || datFlag4UI3==true)){		
						 session.setAttribute("dblockUI"," ");
						  session.removeAttribute("dblockUI"); 
					   	 validatePromDirDefaltDetails(session, errors,flag, credBureKeyPromScor,credBurePromScor2,credBurePromScor3,credBurePromScor4,credBurePromScor5,credBureName1,credBureName2,credBureName3,
									credBureName4,credBureName5,cibilFirmMsmeRank,expCommerScor,promBorrNetWorth,promContribution,promGAssoNPA1YrFlg,promBussExpYr,salesRevenue,taxPBIT,interestPayment,
	...
	*/
    ...
    public static boolean hybridSecurityCheck(Object bean, ValidatorAction validAction, Field field,
		...
		Double unseqLoanportionVal = 0.0D;
		if(null!=session){
			 sessionAppLoanType = (String)session.getAttribute("APPLICATION_LOAN_TYPE");
			 System.out.println("sessionAppLoanType...........validator......hybridSecurityCheck()....."+sessionAppLoanType);
	    }		
		...
		if (hybridSecurityFlg.equals("Y")) {			    		
				...
				if ((creditGuaranteedVal != 0.0 && creditFundBasedVal == 0.0 && creditNonFundBasedVal == 0.0) && ((existExpoCgtVal + creditGuaranteedVal) > 20000000D)) {					
						ActionError actionError = new ActionError("existExpoCgtValExdError");
						errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);					
				} else if ((creditFundBasedVal != 0.0 && creditNonFundBasedVal != 0.0 && creditGuaranteedVal == 0.0) && ((existExpoCgtVal + creditFundBasedVal + creditNonFundBasedVal) > 20000000D)) {	 //=========================================    //			
					   ActionError actionError = new ActionError("existExpoCgtValExdError");
					   errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}else  if ((creditGuaranteedVal != 0.0 && creditFundBasedVal != 0.0 && creditNonFundBasedVal != 0.0) && ((existExpoCgtVal + creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal) > 20000000D)) {	 //======================================   //			
					   ActionError actionError = new ActionError("existExpoCgtValExdError");
					   errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
				
				// DKR 19Mar2019
				if ((creditGuaranteedVal != 0.0 && creditFundBasedVal == 0.0 && creditNonFundBasedVal == 0.0) && (creditGuaranteedVal > unseqLoanportionVal)) {					
					ActionError actionError = new ActionError("guaExdUnsecurAmtError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);					
			    } else if ((creditFundBasedVal != 0.0 && creditNonFundBasedVal != 0.0 && creditGuaranteedVal == 0.0) && ((creditFundBasedVal + creditNonFundBasedVal) > unseqLoanportionVal)) {	 //=========================================    //			
				   ActionError actionError = new ActionError("guaExdUnsecurAmtError");
				   errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			   }else  if ((creditGuaranteedVal != 0.0 && creditFundBasedVal != 0.0 && creditNonFundBasedVal != 0.0) && ((creditGuaranteedVal + creditFundBasedVal + creditNonFundBasedVal) > unseqLoanportionVal)) {	 //======================================   //			
				   ActionError actionError = new ActionError("guaExdUnsecurAmtError");
				   errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			  }
		}
		...
		/*
		DynaActionForm dynaForm = (DynaActionForm) bean;
		String flag = (String) dynaForm.get("hybridSecurity");
		...
		//System.out.println(	flag + "flag###############################immovColSecurityAmt####################movColSecurityAmt"
						//+ movColSecurityAmt);
		// String flag = (String)dynaForm.get("hybridSecurity");
		if (flag.equals("Y")) {
			if (movColSecurityAmt == 0.0 || movColSecurityAmt == null) {
				ActionError actionError = new ActionError("movCollateratlSecError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			} else if (immovColSecurityAmt == 0.0 || immovColSecurityAmt == null) {
	...
	*/}
	...
	public static boolean validateRetailIN(Object bean, ValidatorAction validAction, Field field, ActionErrors errors,
		...
		try {
			//System.out.println("ENTERED IN validateRetailIN");			
			String sessionAppLoanType = "";						
		//	Double resultGuaranteedRetailVal = 0.0d;
			...
			if (creditGuaranteedRetail != 0.0 && (creditFundBasedVal == 0.0 && creditNonFundBasedVal == 0.0)){
				...
				/*if (industryNatureRetail.equals("RETAIL TRADE") && (creditGuaranteedRetail < 1000000D || creditGuaranteedRetail > 10000000D)) {*/
				...
				/*if (industryNatureRetail.equals("RETAIL TRADE")	&& (resultGuaranteedRetailVal < 1000000D || resultGuaranteedRetailVal > 10000000D))*/ 
				 if(industryNatureRetail.equals("RETAIL TRADE") && resultGuaranteedRetailVal.doubleValue() > 10000000D)
				 {
				...
				/*if (industryNatureRetail.equals("RETAIL TRADE")	&& (guaranteedRetailVald < 1000000D || guaranteedRetailVald > 10000000D)) {
					//System.out.println("7 Amt between 10L to 100L DKR");
				...
				if(guaranteedRetailVald != 0.0D && guaranteedRetailVald > 20000000D) {
					//System.out.println("Collateral : 8 MI Amt > 2Cr ");
					ActionError actionError = new ActionError("Collatera200LCheckError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}*/
			...
			//===================================//
		/*	if(!sessionAppLoanType.equals("WCE") || !sessionAppLoanType.equals("WCR")){        	
			 //System.out.println("sessionAppLoanType......test......>>>>after>>>>>>>>>>"+sessionAppLoanType);
			//if (null != sentDate && hybridSecurityFlg.equals("Y") && sentDate.before(new Date(collateralSenDate))) {
				if (null != sentDate && sentDate.before(new Date(collateralSenDate))) {
					//System.out.println("collateralSenDate Sunction Date Check 1" + collateralSenDate);
					ActionError actionError = new ActionError("CollateraSancDtCheckError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			if (null != limitFundBasedSanctionedDated && limitFundBasedSanctionedDated.before(new Date(collateralSenDate))) {//&& industryNatureRetail.equals("RETAIL TRADE")
				//System.out.println(" Sanction Date FUnDBASE NONFUNDBASE 1 === " + limitFundBasedSanctionedDated);
				ActionError actionError = new ActionError("fundBaseRetailTradeSancDtCheckError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}
			if (null != limitNonFundBasedSanctionedDated && limitNonFundBasedSanctionedDated.before(new Date(collateralSenDate))) {//&& industryNatureRetail.equals("RETAIL TRADE")
			   //System.out.println(" Sanction Date FUBDBASE NONFUNDBASE 2 === " + limitNonFundBasedSanctionedDated);
				ActionError actionError = new ActionError("nonFundBaseRetailTradeSancDtCheckError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}
			if (null != sentDate && industryNatureRetail.equals("RETAIL TRADE") && sentDate.before(new Date(collateralSenDate))) {
				System.out.println("collateralSenDate Sanction Date Check3333 " + collateralSenDate);
				ActionError actionError = new ActionError("RetailTradeSancDtCheckError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}			
         }*/
			if (hybridSecurityFlg.equals("Y") && termCreditSanctionedd != 0.0D && totalMIcollatSecAmtd != 0.0D	&& termCreditSanctionedd - totalMIcollatSecAmtd > 20000000D) {
	...
	public static void validatePromDirDefaltDetails(HttpSession session, ActionErrors errors,String promDirDefaltFlg,int credBureKeyPromScor, int credBurePromScor2,int credBurePromScor3,int credBurePromScor4,int credBurePromScor5, String credBureName1,          
			   String credBureName2, String credBureName3, String credBureName4, String credBureName5,int cibilFirmMsmeRank, int expCommerScor,float promBorrNetWorth,int promContribution,          
			   String promGAssoNPA1YrFlg,int promBussExpYr,float salesRevenue,  float taxPBIT,    float interestPayment,  float taxCurrentProvisionAmt,  float totCurrentAssets,         
			   float totCurrentLiability,  float totTermLiability,float exuityCapital,  float preferenceCapital, float reservesSurplus, float repaymentDueNyrAmt,String consitutionName) {
		
		Log.log(4, "Validator.java", "validateExistGreenUnit()-->validatePromDirDefaltDetails()", "validatePromDirDefaltDetails()");
		...
		//if (credBureKeyPromScor < 300 || credBureKeyPromScor > 900) 
		 if(credBureKeyPromScor != -1 && (credBureKeyPromScor < 300 || credBureKeyPromScor > 900))
		{
			ActionError actionError = new ActionError("credBureKeyPromScorError");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);  
		}
	   /* if (credBurePromScor2 == 0) {
			//System.out.println("  credBurePromScor2...... "+credBurePromScor2);
			ActionError actionError = new ActionError("credBurePromScor2Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		} if (credBurePromScor3 == 0) {
			ActionError actionError = new ActionError("credBurePromScor3Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		}  if (credBurePromScor4 == 0) {
			//System.out.println("  credBurePromScor4...... "+credBurePromScor4);
			ActionError actionError = new ActionError("credBurePromScor4Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		} if (credBurePromScor5 == 0) {
			...
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		} /*if (credBureName2 == "" || credBureName2 == null) {
			ActionError actionError = new ActionError("credBureName2Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		}  if (credBureName3 == "" || credBureName3 == null) {
			//System.out.println("  credBureName3..... "+credBureName3);
			ActionError actionError = new ActionError("credBureName3Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		} if (credBureName4 == "" || credBureName4 == null) {
			ActionError actionError = new ActionError("credBureName4Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		}  if (credBureName5 == "" || credBureName5 == null) {
			//System.out.println("  credBureName3..... "+credBureName3);
			ActionError actionError = new ActionError("credBureName5Error");
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
		}*/  
		...
		if (promContribution < 0 || promContribution > 100) {
			...
			errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				...
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			} if (taxCurrentProvisionAmt == 0.0f) {
				//
				ActionError actionError = new ActionError("taxCurrentProvisionAmtError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				...
				//System.out.println("  exuityCapital...... "+exuityCapital);
				ActionError actionError = new ActionError("exuityCapitalError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			} 
			
			if (preferenceCapital == 0.0f  && (!consitutionName.equals("Partnership") && !consitutionName.equals("Proprietary/Individual"))) {				
				ActionError actionError = new ActionError("preferenceCapitalError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
			}
			...
			if ( totTermLiability  == 0.0f ||  totTermLiability <0)  {
				//System.out.println("  totTermLiability temurali 1...... "+totTermLiability);
				if(!consitutionName.equals("Limited liability Partnership"))
				{
				ActionError actionError = new ActionError("totTermLiabilityError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			...
			if (preferenceCapital == 0.0f  && !consitutionName.equals("Partnership") && !consitutionName.equals("Proprietary/Individual") ) {
				//System.out.println("  preferenceCapitalError temurali 2...... "+preferenceCapital);
				if (!consitutionName.equals("Limited liability Partnership")){
					//System.out.println("  Limited liability Partnership");
					ActionError actionError = new ActionError("preferenceCapitalError");
					errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				} 
			}
			if ( reservesSurplus == 0.0f ||  reservesSurplus <0) {			
				//System.out.println("  reservesSurplusError temurali 3...... "+reservesSurplus);
				if(!consitutionName.equals("Limited liability Partnership")){
				ActionError actionError = new ActionError("reservesSurplusError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
			}
			if (repaymentDueNyrAmt == 0.0f ||  repaymentDueNyrAmt <0){			
				//System.out.println("  repaymentDueNyrAmt temurali 4...... "+repaymentDueNyrAmt);
				if(!consitutionName.equals("Limited liability Partnership")){
				ActionError actionError = new ActionError("repaymentDueNyrAmtError");
				errors.add("org.apache.struts.action.GLOBAL_ERROR", actionError);
				}
