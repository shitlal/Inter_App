...
/**
 * DbConnectionBroker
 * A servlet-based broker for database connections.<BR>
 * Creates and manages a pool of database connections.<BR>
 */
public class DbConnectionBroker implements Runnable {
    ...
    private void createConn(int i)
	    ...
	    //DriverManager.setLogWriter(new PrintWriter(new FileWriter("c:\\sprinta.log")));
	    DriverManager.setLoginTimeout(60);
	    /***************** Change ends 8/7/2000 *****************/
