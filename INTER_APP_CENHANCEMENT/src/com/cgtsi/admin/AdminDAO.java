  ...
  throws DatabaseException
{
    ...
    */
    ...
    public ArrayList getAllStates() throws DatabaseException
    {
                 ...
                 try{
                                         ...
                                         while(result.next())
                                                  {
                                                         ...
                                                         {
                                                       	  LogClass.StepWritter("Null stateslist in getAllStates method in 'AdminDAO LINE number==2872=='");
                                                         }
                                                  }
                                         result.close();
                                         result=null;
                  ...
                  if(statesList.size()==0)
                  {
                	  LogClass.StepWritter("Null stateslist in getAllStates method in 'AdminDAO LINE number==2903=='");
                  }
         return statesList;
    }
   ...
   public ArrayList getAllDistricts(String state) throws DatabaseException
      {
               ...
               //System.out.println("district:"+district);
                	 ...
                	 LogClass.StepWritter("Exception in getAllDistricts"+e.getMessage());
 ...
 public ArrayList getAllCitiesNew(String cityName) throws DatabaseException
    ...
    public ParameterMaster getParameter() throws DatabaseException
    {
                 ...
                 try
                 {
                         ...
                         //System.out.println("firstInstallPerc"+firstInstallPerc);
                        ...
                        // System.out.println("lockInPeriod"+lockInPeriod);
 ...
 //                      Added guarantee fee parameter on 08-06-2004.
       ...
       String maxRsfApprovedAmt=(String)paramHash.get(Parameters.MAXIMUM_RSF_APPROVED_AMOUNT);
                 ...
                 {
                	 LogClass.StepWritter("Exception in getParameter "+e.getMessage());
                	 LogClass.writeExceptionOnFile(e);
                         try {
                           connection.rollback();
                         }
    ...
    public ArrayList getAllAdminMails (String userId) throws DatabaseException
    {
                 ...
                 Log.log(Log.INFO,"AdminDAO","getAllAdminMails","Entered==5458");
                 ...
                 try
                 {
                         ...
                         Log.log(Log.DEBUG,"AdminDAO","getAllAdminMails==5479==","error code and errors "+errorCode+" "+error);
                 ...
                 {
                	 LogClass.StepWritter("Exception in getAllAdminMails"+e.getMessage());
                	 LogClass.writeExceptionOnFile(e);
                         try {
                           connection.rollback();
                         }
         ...
         public Message getMailForId(String mailId) throws DatabaseException,NoDataException
         {
				...
				Connection connection=null;			
                 ...
                 {
                	 LogClass.StepWritter("Exception in getMailForId"+e.getMessage());
                	 LogClass.writeExceptionOnFile(e);
         ...
         */
         ...
         public ArrayList getAllIndustryNature() throws DatabaseException
         {
                 ...
                 try
                 {
                    ...
                    //     System.out.println("Exception  in getAllIndustryNature before while IndustryNature");
                         while(natures.next())
                         {
                                 String nature=natures.getString(1);
                                 //System.out.println("nature="+nature);
                                 Log.log(Log.DEBUG,"AdminDAO","getAllIndustryNature",nature);
                             //    System.out.println("Exception  in getAllIndustryNature method before toUpperCase"+nature);
                             //    MANUFACTURING SSI   SSSBE RETAIL TRADE
                                 if(!nature.equals("MANUFACTURING SSI") || !nature.equals("SSSBE") || !nature.equals("RETAIL TRADE")){
                                  industryNatures.add(nature.toUpperCase());  // use as type of activity in jsp display
                                 }/*else if(nature.equalsIgnoreCase("MANUFACTURING SSI") || nature.equalsIgnoreCase("SSSBE") || nature.equalsIgnoreCase("RETAIL TRADE")){
                                	 TypeOfActivities.add(nature.toUpperCase());    //  DKR 21
                                 }*/
                              
                             //    System.out.println("Exception  in getAllIndustryNature method after toUpperCase"+nature);
                         }
              //           System.out.println("Exception  in getAllIndustryNature after while IndustryNature");
                 ...
                 {
System.out.println("Exception  in getAllIndustryNature method"+e.getMessage());
                         try {
                           connection.rollback();
                         }
                         catch (SQLException ignore) {
         ...
         public ArrayList getIndustrySectors(String industryNature) throws DatabaseException
         {
        	 ...
        	 LogClass.StepWritter("getIndustrySectors "+industryNature);
                 ...
                 if(connection!=null)
                 {
                 LogClass.StepWritter("A connection[connection] in getIndustrySectors"+connection);
                 }
                 try
                 {
                         CallableStatement callable=
                         ...
                         int errorCode=callable.getInt(1);
                         String error=callable.getString(4);
                         System.out.println(error+" error in getIndustrySectors"+errorCode);
                         LogClass.StepWritter("error in getIndustrySectors"+errorCode);
                         if(errorCode==Constants.FUNCTION_FAILURE)
                         {
                                 connection.rollback();
                         ...
                         if(sectors!=null)
                         {
                        	 LogClass.StepWritter("sectors[ResultSet] in getIndustrySectors"+sectors);
                         }
                         while(sectors.next())
                         {
                         ...
                         LogClass.StepWritter("A sectors[ResultSet] in getIndustrySectors"+sectors);
                         sectors.close();
                         sectors=null;
                         LogClass.StepWritter("A callable[CallableStatement] in getIndustrySectors"+callable);
                         callable.close();
                         callable=null;
                         LogClass.StepWritter("B connection[connection] in getIndustrySectors"+connection);
                         connection.commit();
                         System.out.println("Sector Value all stmt executed");
                 }
                 catch (SQLException e)
                 {
                	 LogClass.StepWritter("Exception in getIndustrySectors "+e.getMessage());
                	 LogClass.writeExceptionOnFile(e);

                         try {
                        	 LogClass.StepWritter("C connection[connection] in getIndustrySectors"+connection);
                           connection.rollback();
                         }
                         catch (SQLException ignore) {
 ...
 //                        "jdbc:oracle:thin:@cpr-pcs686:1521:ARCHIVAL", "CGTSIARCHIVAL", "CGTSIARCHIVAL");
       ...
       public void  sendMailtoMli(String department,ArrayList emaiIds,String complaintid)
       throws DatabaseException
   {
      	 ...
      	 try
      		{
      		  ...
      		  query = 
      		          "select dep_email_id  from CGTMSE_DEPARTMENTS where DEPARTMENT='"+department+"'";
      		...
      		// System.out.println(query);
      		 ...
      		 emaiIds.add(departEmailId);
      		      ...
      		      for(int i=0;i<=emaiIds.size();i++)
      		      {
      		    	  ...
      		    	  String toMail=(String) emaiIds.get(i);
      		  
      		    	  if(i==0)
      		    	  {
      		    	   subject = "Your query with CGTMSE, ID:"+complaintid;
      		    	   
      		    	 mailBody ="Your query with CGTMSE has been registered and id for the same is: "+complaintid+". We will revert you soon over phone/mail. \n Regards, \n Team CGTMSE,Mumbai ";
      		    	  // mailBody = "Dear User This is Your  Query/Complaint to CGTMSE.Your complaint id is "+complaintid+".We will revert you by Telecall/Mail soon. \n Regards, \n CGTMSE, \n Mumbai. " ;
      		    	  }
      		    	  else
      		    	  {
      		    		   subject = "Query ID:"+complaintid+"received." ;
          		    	   mailBody = "A query with ID:"+complaintid+". has been received for you to attend/ respond. Please attend the same";
          		      
      		    	  }
      		    	  String filePath = "";
      		    	  
      		     // String host = "192.168.10.117";
      		    	//String host = "202.138.96.11";
      	      ...
      	      javax.mail.internet.InternetAddress[] Toaddress = {new javax.mail.internet.InternetAddress(toMail)};     
      	 ...
      	 System.out.println("after send  mail  to"+toMail);
      	    //);
       ...
       public String insertQryDetails(MLIInfo mliInfo)
       throws DatabaseException
   {
      	 String compId="";
      	  Connection connection=DBConnection.getConnection(false);
            ...
            try{
                            CallableStatement callable=connection.prepareCall
                            ("{?=call PACKQUERYTRANSACTIONS.funcInsertQueryDetails(?,?,?,?,?,?,?,?,?,?)}");
                            
                           
                            

                            callable.setString(2,mliInfo.getBankId());                         

                            callable.setString(3,mliInfo.getZoneId());
                            
                            callable.setString(4,mliInfo.getBranchId());    
                            
                            callable.setString(5,mliInfo.getPhone());      

                            callable.setString(6,mliInfo.getEmailId());
                            
                            callable.setString(7,mliInfo.getDepartment());
                            
                            callable.setString(8,mliInfo.getQueryDesc());

                            callable.setString(9,mliInfo.getContPerson());
            ...
            connection.commit();
                            ...
                            try {
                              connection.rollback();
                                    ...
                                    Log.log(Log.ERROR,"AdminDAO","insertQryDetails",ignore.getMessage());
                            }

                            Log.log(Log.ERROR,"AdminDAO","insertQryDetails",e.getMessage());
...
//Diksha 29/05/2017
       public double fetchOldGauranteeAmount(String serachType , String searchOn)
       throws DatabaseException
   {
    	 //  System.out.println("fetchOldGauranteeAmount called");
    	   double amount=0;
    	   String query="";
    	   ResultSet rs=null;
    	   Statement st=null;
		...
		if(connection==null) {
      	  ...
      	  if(serachType.equals("cgbid")) // cgpan
     // 	  if(searchOn.startsWith("CG")) // cgpan
      	  {
      		
      		query="select sum(APP_APPROVED_AMOUNT) from application_detail where  app_status not in ('RE') and   SSI_REFERENCE_NUMBER in (select SSI_REFERENCE_NUMBER from ssi_detail where bid='"+searchOn+"')";
      	  }
     	  if(serachType.equalsIgnoreCase("cgpan")) // 
      	 // else 
      	  {
     		 query="select sum(APP_APPROVED_AMOUNT) from application_detail where app_status not in ('RE') and   SSI_REFERENCE_NUMBER in (select SSI_REFERENCE_NUMBER from application_detail where cgpan='"+searchOn+"' )";
     		 
      	  }
      	  st=connection.createStatement();
      	System.out.println("fetchOldGauranteeAmount query11"+query);
      	  rs=st.executeQuery(query);
	      	  if(rs.next())
	      	  {
	      		amount=rs.getDouble(1);
	      		System.out.println("fetchOldGauranteeAmount amount"+amount);
	      	  }
      	 }
      	 catch(Exception e)
      	 {
      		 //System.out.println("exception in fetchOldGauranteeAmount"+e.getMessage());
      	 }
      	 finally 
      	 {
      		 try {
				...
				//e.printStackTrace();
				// System.out.println("exception while colsing connection"+e.getMessage());
			}
       ...
       public double fetchOldGauranteeAmountForEnahncementCases(String serachType , String searchOn)
       throws DatabaseException
   {
    	   System.out.println("fetchOldGauranteeAmount called");
    	   double amount=0;
     ...
     // 	  if(searchOn.startsWith("CG")) // cgpan
      	  {
      		...
      		query="select sum(APP_APPROVED_AMOUNT) from application_detail where SSI_REFERENCE_NUMBER in (select SSI_REFERENCE_NUMBER from ssi_detail where bid='"+searchOn+"')";
      	  }
     	  if(serachType.equalsIgnoreCase("cgpan")) // 
      	 // else 
      	  {
     		  String splitedCgpan=searchOn.substring(0,searchOn.length()-2);
     		 query=" select (select sum(APP_APPROVED_AMOUNT) from application_detail where SSI_REFERENCE_NUMBER in (select SSI_REFERENCE_NUMBER from application_detail where cgpan='"+searchOn+"'))-(select sum(APP_APPROVED_AMOUNT) from application_detail where cgpan like '%"+splitedCgpan+"%' and cgpan !='"+splitedCgpan+"'||'TC' ) amount from dual  ";
     		 
     		query=" SELECT   (SELECT SUM (APP_APPROVED_AMOUNT) "+
          "  FROM application_detail "+
        "   WHERE app_status not in ('RE') and SSI_REFERENCE_NUMBER IN (SELECT SSI_REFERENCE_NUMBER "+
                                    "        FROM application_detail "+
                                    "       WHERE cgpan = '"+searchOn+"')) "+
    "   - (SELECT SUM (APP_APPROVED_AMOUNT) "+
          "  FROM application_detail "+
         "  WHERE  app_status not in ('RE') and    cgpan LIKE '%"+splitedCgpan+"%'  "+
           "      AND cgpan !='"+splitedCgpan+"'||'TC' ) "+
       "   amount "+
 " FROM DUAL ";
     		 
      	  }
      	  st=connection.createStatement();
      	System.out.println("fetchOldGauranteeAmountForEnahncementCases query"+query);
      	  rs=st.executeQuery(query);
	      	  if(rs.next())
	      	  {
	      		amount=rs.getDouble(1);
       ...
       public double fetchOldOLDBaseRate(String searchOn)
       throws DatabaseException
   {
    	//   System.out.println("fetchOldGauranteeAmount called");
    	   double amount=0;
     ...
     // 	  if(searchOn.startsWith("CG")) // cgpan
      	  {
      		query="select WCP_PLR from working_capital_detail where cgpan='"+searchOn+"'";
      		
      	  }
     	 
      	  else 
      	  {
     		 query="select WCP_PLR from working_capital_detail where cgpan = (select distinct a.cgpan from application_detail a , ssi_detail s where s.SSI_REFERENCE_NUMBER=a.SSI_REFERENCE_NUMBER and s.bid='"+searchOn+"')";
     		 
      	  }
      	  st=connection.createStatement();
      //	System.out.println("fetchOldGauranteeAmount query22"+query);
      	  rs=st.executeQuery(query);
	      	  if(rs.next())
	      	  {
	      		amount=rs.getDouble(1);
...
//29/05/2017 end..     
	...
	public String getState(String mliBranchCode) {

		Log.log(Log.INFO, "AdminDao", "getState", "Entered");
		...
		Connection connection = DBConnection.getConnection(false);
		try {
			String query = "SELECT MEM_STATE_NAME FROM MLI_GST_TEMP1 where MEM_BRN_CODE=?";
			pStmt = connection.prepareStatement(query);
			pStmt.setString(1, mliBranchCode);
			rsSet = pStmt.executeQuery();
			while (rsSet.next()) {				
	  ...
	  public int accountDetAdd(String mliName,String memberId,String mobileNo,String phoneNo,String emailId,
 			  String beneficiary,String accountType,String branchId,String micrCode,String accNo,String rtgsNO,String neftNO,String memstatus,String modifiedby,Date sysdate,String zoneid,String beneficiarybankname) throws DuplicateException,DatabaseException
 	   {
    	  Connection connection=DBConnection.getConnection(false);
    		...
    		try
			{			
			String qry = "insert into cgtsiintranetuser.MEMBER_ACCOUNT_INFO@db_intra" +
						"(MLI_NAME,MLI_ID,MEM_CONT_NO,MEM_MOB_NO,MEM_EMAIL_ID,MEM_BENEFICIARY,MEM_ACC_TYPE,MEM_BRN_CODE,MEM_MICR_CODE,MEM_ACC_NO,MEM_RTGS_NO,MEM_NEFT_NO,MEM_STATUS,MLI_MK_USER_ID,MLI_MK_MODIFIED_DATE,ZONE_NAME,BENEFICIARY_BANK_NAME)"+
						"values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
				...
				ps.setString(13, memstatus);
				ps.setString(14, modifiedby);
				ps.setDate(15, (java.sql.Date)sysdate);
				ps.setString(16, zoneid);
				ps.setString(17, beneficiarybankname);
				 no = ps.executeUpdate();
	...
	public int updateAcc1(String mliName,String memberId,String mobileNo,String phoneNo,String emailId,
	   ...
	   Connection connection=DBConnection.getConnection(false);
		  ...
		  int no=0;
			...
			try
			{			
				String qry = "UPDATE  cgtsiintranetuser.MEMBER_ACCOUNT_INFO@db_intra SET " +
				" MLI_NAME =?, MEM_CONT_NO =?, MEM_MOB_NO =?, MEM_EMAIL_ID =?,MEM_BENEFICIARY =?,"+
				"MEM_ACC_TYPE =?, MEM_BRN_CODE =?, MEM_MICR_CODE =?, MEM_ACC_NO =?,MEM_RTGS_NO =?, MEM_NEFT_NO =? ,MEM_STATUS=?,MLI_MK_USER_ID=?,MLI_MK_MODIFIED_DATE=?,ZONE_NAME=?,BENEFICIARY_BANK_NAME=?"+
				"WHERE MLI_ID =?";
				    ps = connection.prepareStatement(qry);
				    ps.setString(1, mliName);
					...
					ps.setString(12, memstatus);
					ps.setString(13, modifiedby);
					ps.setDate (14, (java.sql.Date)sysdate);
					ps.setString (15, zoneid);
					ps.setString (16, beneficiarybankname);
					ps.setString(17, memberId);
					no = ps.executeUpdate();
