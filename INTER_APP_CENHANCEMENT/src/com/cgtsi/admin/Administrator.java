 ...
 public ArrayList getIndustrySectors() throws DatabaseException
    ...
    */
	...
	private ArrayList sortPLRDetails(ArrayList plrDetails)
	{
     ...
     throws DatabaseException
 {
     String compId = adminDAO.insertQryDetails(mliInfo);
     return compId;
 }
     ...
     throws DatabaseException
 {
     adminDAO.sendMailtoMli(department, emaiIds, complaintid);
 }
     /* Created by kailash for GST*/

	/*public String getState(String mliBranchCode) {
		String stateName=null;
		if(mliBranchCode!=null){
			stateName=adminDAO.getState(mliBranchCode);
		}
		return stateName;  
	 ...
	 public int updateAccountDetails(String mliName,String memberId,String mobileNo,String phoneNo,String emailId,
	   ...
	   {
	  int no=adminDAO.updateAcc1(mliName,memberId,mobileNo,phoneNo,emailId,beneficiary,accountType,branchId,micrCode,accNo,rtgsNO,neftNO,memstatus,modifiedby,sysdate,zoneid,beneficiarybankname);
	 return no;
	 ...
	 public int addAccountDetails(String mliName,String memberId,String mobileNo,String phoneNo,String emailId,
			  String beneficiary,String accountType,String branchId,String micrCode,String accNo,String rtgsNO,String neftNO,String memstatus,String modifiedby,Date sysdate,String zoneid,String beneficiarybankname) throws DuplicateException,DatabaseException
	   {
		  int no=adminDAO.accountDetAdd(mliName,memberId,mobileNo,phoneNo,emailId,
					beneficiary,accountType,branchId,micrCode,accNo,rtgsNO,neftNO,memstatus,modifiedby,sysdate,zoneid,beneficiarybankname);
		 return no;  
	   }
