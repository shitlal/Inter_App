...
private String flaggingofWCTL;



public String getDisbursmentAmt() {
	return disbursmentAmt;
}
public void setDisbursmentAmt(String disbursmentAmt) {
	this.disbursmentAmt = disbursmentAmt;
}
public String getPrinciplerepaymentAmt() {
	return principlerepaymentAmt;
}
public void setPrinciplerepaymentAmt(String principlerepaymentAmt) {
	this.principlerepaymentAmt = principlerepaymentAmt;
}
public String getPrinciplerepaymentInterest() {
	return principlerepaymentInterest;
}
public void setPrinciplerepaymentInterest(String principlerepaymentInterest) {
	this.principlerepaymentInterest = principlerepaymentInterest;
}




private String   principlerepaymentInterest;
private String  principlerepaymentAmt;
private String  disbursmentAmt;
private String  principleoutstandingInterest;
public String getPrincipleoutstandingInterest() {
	return principleoutstandingInterest;
}
public void setPrincipleoutstandingInterest(String principleoutstandingInterest) {
	this.principleoutstandingInterest = principleoutstandingInterest;
}
public String getPrincipleoutstandingAmt() {
	return principleoutstandingAmt;
}
public void setPrincipleoutstandingAmt(String principleoutstandingAmt) {
	this.principleoutstandingAmt = principleoutstandingAmt;
}




private String  principleoutstandingAmt;
...
public String getFlaggingofWCTL() {
	return flaggingofWCTL;
}
public void setFlaggingofWCTL(String flaggingofWCTL) {
	this.flaggingofWCTL = flaggingofWCTL;
}
    ...
    private String hybridSecurityFlag;
    
       public String getHybridSecurityFlag() {
		return hybridSecurityFlag;
	}
	public void setHybridSecurityFlag(String hybridSecurityFlag) {
		this.hybridSecurityFlag = hybridSecurityFlag;
	}
