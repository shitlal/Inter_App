...
public class ProgressReport
{
  ...
  private String LoanAcntNumber;
  public Date getAmountSanctionedDate() {
	return amountSanctionedDate;
}

public void setAmountSanctionedDate(Date amountSanctionedDate) {
	this.amountSanctionedDate = amountSanctionedDate;
}
...
private Date amountSanctionedDate;
	...
	public String getLoanAcntNumber() {
	return LoanAcntNumber;
}

public void setLoanAcntNumber(String loanAcntNumber) {
	LoanAcntNumber = loanAcntNumber;
}
